...
{
	public class AmulSeketsiBossRegion : LandscapeRegion
	{
		public AmulSeketsiBossRegion( XmlElement xml, Map map, Region parent ) : base( xml, map, parent )
		{
		}
		...
		public override void OnDeath( Mobile m )
		{
		              ...
		              PlayerMobile player = m as PlayerMobile;
	                      ...
	                      if ( m.Region.Name == "Amul Seketsi Boss Room" )
	                      {
                                        ////////// Amul Seketsi Second Floor //////////
                                        m.Location = new Point3D( 1242, 336, -5 );
				        m.Map = Map.Tokuno;
				        ...
				        Item corpse = m.Corpse;
                      	  	        ...
                      	  	        if ( corpse != null )
				        {
			 		         m.Corpse.Location = new Point3D( 1242, 336, -5 );
