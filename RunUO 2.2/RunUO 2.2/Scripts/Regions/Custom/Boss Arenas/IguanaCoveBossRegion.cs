...
{
	public class IguanaCoveBossRegion : LandscapeRegion
	{
		public IguanaCoveBossRegion( XmlElement xml, Map map, Region parent ) : base( xml, map, parent )
		{
		}
		...
		public override void OnDeath( Mobile m )
		{
		              ...
		              PlayerMobile player = m as PlayerMobile;
	                      ...
	                      if ( m.Region.Name == "Iguana Cove Boss Room" )
	                      {
                                        ////////// Iguana Cove First Floor //////////
                                        m.Location = new Point3D( 1392, 264, -11 );
				        m.Map = Map.Tokuno;
                                        World.Broadcast( 0x35, true, string.Format( "{0} has been slaughtered by Khalahandra.", m.Name ) );

				        Item corpse = m.Corpse;

                      	  	        if ( corpse != null )
				        {
			 		         m.Corpse.Location = new Point3D( 1392, 264, -11 );
