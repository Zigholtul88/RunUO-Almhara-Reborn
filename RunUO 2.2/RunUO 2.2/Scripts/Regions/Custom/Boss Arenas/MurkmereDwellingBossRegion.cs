...
{
	public class MurkmereDwellingBossRegion : LandscapeRegion
	{
		public MurkmereDwellingBossRegion( XmlElement xml, Map map, Region parent ) : base( xml, map, parent )
		{
		}
		...
		public override void OnDeath( Mobile m )
		{
		              ...
		              PlayerMobile player = m as PlayerMobile;
	                      ...
	                      if ( m.Region.Name == "Murkmere Dwelling Boss Room" )
	                      {
                                        ////////// Murkmere Dwelling First Floor //////////
                                        m.Location = new Point3D( 707, 1032, 2 );
				        m.Map = Map.Tokuno;
                                        World.Broadcast( 0x35, true, string.Format( "{0} has been slaughtered by Treikanha.", m.Name ) );

				        Item corpse = m.Corpse;

                      	  	        if ( corpse != null )
				        {
			 		         m.Corpse.Location = new Point3D( 707, 1032, 2 );
