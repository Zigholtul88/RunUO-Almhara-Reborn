...
{
	public class MongbatHideoutBossRegion : LandscapeRegion
	{
		public MongbatHideoutBossRegion( XmlElement xml, Map map, Region parent ) : base( xml, map, parent )
		{
		}
		...
		public override void OnDeath( Mobile m )
		{
		              ...
		              PlayerMobile player = m as PlayerMobile;
	                      ...
	                      {
                                        ////////// Mongbat Hideout First Floor //////////
                                        m.Location = new Point3D( 593, 50, -9 );
				        m.Map = Map.Tokuno;
				        ...
				        Item corpse = m.Corpse;
                      	  	        ...
                      	  	        if ( corpse != null )
				        {
			 		         m.Corpse.Location = new Point3D( 593, 50, -9 );
