...
{
	public class AzuriteCavernsBossRegion : LandscapeRegion
	{
		public AzuriteCavernsBossRegion( XmlElement xml, Map map, Region parent ) : base( xml, map, parent )
		{
		}
			...
			global = LightCycle.JailLevel;
                ...
                public override void OnEnter( Mobile m )
                {
		              ...
		              PlayerMobile player = m as PlayerMobile;
                              ...
                              {
                                       ////////// Boss Theme 4 //////////
                                       m.Send(PlayMusic.GetInstance( MusicName.Holycity ) );
                              }
                              else
	                      {
                                       ////////// Boss Theme 4 //////////
		...
		public override void OnDeath( Mobile m )
		{
		              ...
		              PlayerMobile player = m as PlayerMobile;
	                      ...
	                      if ( m.Region.Name == "Azurite Caverns Boss Room" )
	                      {
                                        ////////// Azurite Caverns First Floor //////////
                                        m.Location = new Point3D( 1228, 527, -45 );
				        m.Map = Map.Tokuno;
                                        World.Broadcast( 0x35, true, string.Format( "{0} has been slaughtered by Nyeenakuu.", m.Name ) );

				        Item corpse = m.Corpse;

                      	  	        if ( corpse != null )
				        {
			 		         m.Corpse.Location = new Point3D( 1228, 527, -45 );
