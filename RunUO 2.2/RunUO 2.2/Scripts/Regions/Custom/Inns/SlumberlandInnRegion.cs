...
{
       public class SlumberlandInnRegion : DamagingRegion
       {
                public SlumberlandInnRegion( XmlElement xml, Map map, Region parent ) : base( xml, map, parent )
	        {
	        }

                public override void OnEnter( Mobile m )
                {
        	       m.SendMessage("You have entered Slumberland Inn.");
                }

                public override void OnExit( Mobile m )
                {
        	       m.SendMessage("You have left Slumberland Inn.");
                }
