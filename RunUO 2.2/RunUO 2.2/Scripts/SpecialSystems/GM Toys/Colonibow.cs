...
namespace Server.Items
{
	...
	public class Colonibow : BaseRanged
	{
		...
		public override int DefHitSound{ get{ return 792; } }
		public override int DefMissSound{ get{ return 1057; } }
		...
		public Colonibow( Serial serial ) : base( serial )
		{
		}
                ...
                { 
                   ...
                   { 
                      case 0: 
                         defender.FixedParticles( 0x36B0, 20, 10, 0x26BB, 0x3F, 0x7, EffectLayer.Head ); 
                         break; 
                      case 1: 
                         defender.FixedParticles( 0x36B0, 20, 10, 0x26BB, 0x3F, 0x7, EffectLayer.RightHand ); 
                         break; 
                      case 2: 
                         defender.FixedParticles( 0x36B0, 20, 10, 0x26BB, 0x3F, 0x7, EffectLayer.LeftHand ); 
                         break; 
                      case 3: 
                         defender.FixedParticles( 0x36B0, 20, 10, 0x26BB, 0x3F, 0x7, EffectLayer.Waist ); 
                         break; 
                      case 4: 
                         defender.FixedParticles( 0x36B0, 20, 10, 0x26BB, 0x3F, 0x7, EffectLayer.LeftFoot ); 
                         break; 
                      case 5: 
                         defender.FixedParticles( 0x36B0, 20, 10, 0x26BB, 0x3F, 0x7, EffectLayer.RightFoot ); 
                         break; 
                      case 6: 
                         defender.FixedParticles( 0x36B0, 20, 10, 0x26BB, 0x3F, 0x7, EffectLayer.CenterFeet ); 
                         break; 
                   }       
                      ...
                      { 
                         ...
                         { 
                            ...
                            { 
                               ...
                               Effects.PlaySound( g, g.Map, 1064 ); 
                               break; 
                            } 
                            default: 
                               break; 
