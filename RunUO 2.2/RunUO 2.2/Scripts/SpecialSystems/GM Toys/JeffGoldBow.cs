...
namespace Server.Items
{
	...
	public class JeffGoldBow : BaseRanged
	{
		...
		public override int DefHitSound{ get{ return 811; } }
		public override int DefMissSound{ get{ return 812; } }
		...
		{
			m.SendMessage( "Uh, chaos theory!" );
               	        m.PlaySound( 778 );
		}

		public JeffGoldBow( Serial serial ) : base( serial )
		{
		}
