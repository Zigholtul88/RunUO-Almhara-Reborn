...
{
	public abstract class BaseUltimaPotion : BasePotion
	{
		...
		public BaseUltimaPotion( PotionEffect effect ) : base( 0xF0D, effect )
		{
		}

		public BaseUltimaPotion( Serial serial ) : base( serial )
		{
		}
		...
		{
			private BaseUltimaPotion m_Potion;

			public BaseUltimaPotion Potion
			{
				get{ return m_Potion; }
			}
