...
{
	public class MountAnimalTrainer : BaseVendor
	{
		...
		[Constructable]
		public MountAnimalTrainer() : base( "the animal trainer" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBMountAnimalTrainer() );
		}
		...
		{
			private MountAnimalTrainer m_Trainer;
			private Mobile m_From;

			public StableEntry( MountAnimalTrainer trainer, Mobile from ) : base( 6126, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class ClaimListGump : Gump
		{
			...
			public ClaimListGump( MountAnimalTrainer trainer, Mobile from, List<BaseCreature> list ) : base( 50, 50 )
			{
				m_Trainer = trainer;
				m_From = from;
				m_List = list;
		...
		private class ClaimAllEntry : ContextMenuEntry
		{
			...
			public ClaimAllEntry( MountAnimalTrainer trainer, Mobile from ) : base( 6127, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class StableTarget : Target
		{
			...
			public StableTarget( MountAnimalTrainer trainer ) : base( 12, false, TargetFlags.None )
			{
				m_Trainer = trainer;
			}
		...
		public MountAnimalTrainer( Serial serial ) : base( serial )
		{
		}
	...
	public class SBMountAnimalTrainer : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBMountAnimalTrainer()
		{
		}
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			...
			{
				Add( new AnimalBuyInfo( 1, typeof( Beetle ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( GiantTurtle ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( GreatHart ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( Gryphon ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( HammerheadShark ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( Hiryu ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( Horse ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( Kirin ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( Lion ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( MonitorLizard ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( Nephropirok ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( Nightmare ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( RidableLlama ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( RidablePolarbear ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( Ridgeback ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( SavageRidgeback ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( SeaPony ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( SilverSteed ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( Unicorn ), 1000, 10, 288, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( Zebra ), 1000, 10, 288, 0 ) );
			}
		}
