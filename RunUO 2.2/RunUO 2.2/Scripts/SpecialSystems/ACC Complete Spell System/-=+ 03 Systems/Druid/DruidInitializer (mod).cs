...
namespace Server.ACC.CSS.Systems.Druid
{
    public class DruidInitializer : BaseInitializer
    {
		public static void Configure()
		{
            ...
            Register( typeof( DruidSwarmOfInsectsSpell ),   "Swarm of Insects",  "Summons a swarm of insects that bite and sting the Druid's enemies.",                                                  "Garlic; Nightshade; DestroyingAngel",            "Mana: 70; Skill: 85", 2272,  5120, School.Druid );
