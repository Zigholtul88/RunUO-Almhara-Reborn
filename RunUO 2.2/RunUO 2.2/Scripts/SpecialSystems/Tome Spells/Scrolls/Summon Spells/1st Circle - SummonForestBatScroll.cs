...
{
	public class SummonForestBatScroll : Item
	{
		[Constructable]
		public SummonForestBatScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonForestBatScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Forest Bat - 1st Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonForestBatSpell ( from, this ).Cast();
		}

		public SummonForestBatScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonForestBatSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Forest Bat", "summon forest bat",
				-1,
				9002
			); 
		...
		public SummonForestBatSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
		...
		public override bool CheckCast()
		{
			...
			{
				Caster.SendMessage( "You have too many followers to summon this bat." );
				return false;
			}
