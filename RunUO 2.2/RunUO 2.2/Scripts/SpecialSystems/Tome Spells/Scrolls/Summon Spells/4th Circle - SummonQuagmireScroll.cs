...
{
	public class SummonQuagmireScroll : Item
	{
		[Constructable]
		public SummonQuagmireScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonQuagmireScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Quagmire - 4th Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonQuagmireSpell ( from, this ).Cast();
		}

		public SummonQuagmireScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonQuagmireSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Quagmire", "summon quagmire",
				-1,
				9002
			); 
		...
		public SummonQuagmireSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
