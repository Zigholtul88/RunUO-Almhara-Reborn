...
{
	public class SummonDreadSpiderScroll : Item
	{
		[Constructable]
		public SummonDreadSpiderScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonDreadSpiderScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Dread Spider - 0 Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonDreadSpiderSpell ( from, this ).Cast();
		}

		public SummonDreadSpiderScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonDreadSpiderSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Dread Spider", "summon dread spider",
				-1,
				9002
			); 
		...
		public SummonDreadSpiderSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
