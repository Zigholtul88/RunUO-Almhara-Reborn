...
{
	public class SummonBlackWidowSpiderScroll : Item
	{
		[Constructable]
		public SummonBlackWidowSpiderScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonBlackWidowSpiderScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Black Widow Spider - 0 Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonBlackWidowSpiderSpell ( from, this ).Cast();
		}

		public SummonBlackWidowSpiderScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonBlackWidowSpiderSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Black Widow Spider", "summon black widow spider",
				-1,
				9002
			); 
		...
		public SummonBlackWidowSpiderSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
