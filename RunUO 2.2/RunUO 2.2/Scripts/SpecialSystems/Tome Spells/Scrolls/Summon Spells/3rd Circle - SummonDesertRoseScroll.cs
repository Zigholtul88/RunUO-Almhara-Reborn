...
{
	public class SummonDesertRoseScroll : Item
	{
		[Constructable]
		public SummonDesertRoseScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonDesertRoseScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Desert Rose - 3rd Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonDesertRoseSpell ( from, this ).Cast();
		}

		public SummonDesertRoseScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonDesertRoseSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Desert Rose", "summon desert rose",
				-1,
				9002
			); 
		...
		public SummonDesertRoseSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
