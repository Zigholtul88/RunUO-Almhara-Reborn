...
{
	public class SummonBeachBeetleScroll : Item
	{
		[Constructable]
		public SummonBeachBeetleScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonBeachBeetleScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Beach Beetle - 3rd Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonBeachBeetleSpell ( from, this ).Cast();
		}

		public SummonBeachBeetleScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonBeachBeetleSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Beach Beetle", "summon beach beetle",
				-1,
				9002
			); 
		...
		public SummonBeachBeetleSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
