...
{
	public class SummonGreySquirrelScroll : Item
	{
		[Constructable]
		public SummonGreySquirrelScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonGreySquirrelScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Grey Squirrel - 1st Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonGreySquirrelSpell ( from, this ).Cast();
		}

		public SummonGreySquirrelScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonGreySquirrelSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Grey Squirrel", "summon grey squirrel",
				-1,
				9002
			); 
		...
		public SummonGreySquirrelSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
		...
		public override bool CheckCast()
		{
			...
			{
				Caster.SendMessage( "You have too many followers to summon this squirrel." );
				return false;
			}
