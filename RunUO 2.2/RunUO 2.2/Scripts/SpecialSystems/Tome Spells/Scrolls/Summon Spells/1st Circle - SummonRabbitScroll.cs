...
{
	public class SummonRabbitScroll : Item
	{
		[Constructable]
		public SummonRabbitScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonRabbitScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Rabbit - 1st Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonRabbitSpell ( from, this ).Cast();
		}

		public SummonRabbitScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonRabbitSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Rabbit", "summon rabbit",
				-1,
				9002
			); 
		...
		public SummonRabbitSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
