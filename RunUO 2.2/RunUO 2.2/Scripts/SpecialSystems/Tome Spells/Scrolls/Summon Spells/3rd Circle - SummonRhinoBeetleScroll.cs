...
{
	public class SummonRhinoBeetleScroll : Item
	{
		[Constructable]
		public SummonRhinoBeetleScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonRhinoBeetleScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Rhino Beetle - 3rd Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonRhinoBeetleSpell ( from, this ).Cast();
		}

		public SummonRhinoBeetleScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonRhinoBeetleSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Rhino Beetle", "summon rhino beetle",
				-1,
				9002
			); 
                ...
                public override double RequiredSkill { get { return 24.2; } }
                public override int RequiredMana { get { return 120; } }

		public SummonRhinoBeetleSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
