...
{
	public class SummonYoungSpiderScroll : Item
	{
		[Constructable]
		public SummonYoungSpiderScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonYoungSpiderScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Young Spider - 1st Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonYoungSpiderSpell ( from, this ).Cast();
		}

		public SummonYoungSpiderScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonYoungSpiderSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Young Spider", "summon young spider",
				-1,
				9002
			); 
		...
		public SummonYoungSpiderSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
