...
{
	public class SummonUmdhlebiScroll : Item
	{
		[Constructable]
		public SummonUmdhlebiScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonUmdhlebiScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Umdhlebi - 5th Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonUmdhlebiSpell ( from, this ).Cast();
		}

		public SummonUmdhlebiScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonUmdhlebiSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Umdhlebi", "summon umdhlebi",
				-1,
				9002
			); 
                ...
                public override int RequiredMana { get { return 200; } }

		public SummonUmdhlebiSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
