...
{
	public class SummonRunningPantsScroll : Item
	{
		[Constructable]
		public SummonRunningPantsScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonRunningPantsScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Running Pants - 1st Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonRunningPantsSpell ( from, this ).Cast();
		}

		public SummonRunningPantsScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonRunningPantsSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Running Pants", "summon running pants",
				-1,
				9002
			); 
		...
		public SummonRunningPantsSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
		...
		public override bool CheckCast()
		{
			...
			{
				Caster.SendMessage( "You have too many followers to summon those pants." );
				return false;
			}
