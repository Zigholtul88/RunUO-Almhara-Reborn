...
{
	public class SummonDarkRoseScroll : Item
	{
		[Constructable]
		public SummonDarkRoseScroll() : this( 1 )
		{
		}

		[Constructable]
		public SummonDarkRoseScroll( int amount ) : base( 0x2261 )
		{
			Name = "Summon Dark Rose - 3rd Circle";
			Stackable = true;
			Amount = amount;
		...
		{
                        new SummonDarkRoseSpell ( from, this ).Cast();
		}

		public SummonDarkRoseScroll( Serial serial ) : base( serial )
		{
		}
...
{
	public class SummonDarkRoseSpell : TomeSpell 
	{ 
		private static SpellInfo m_Info = new SpellInfo( 
				"Summon Dark Rose", "summon dark rose",
				-1,
				9002
			); 
		...
		public SummonDarkRoseSpell( Mobile caster, Item scroll ): base( caster, scroll, m_Info )
		{ 
		} 
