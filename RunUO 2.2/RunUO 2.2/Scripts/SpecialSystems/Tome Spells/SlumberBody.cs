...
{
    public class SlumberBody : Container
    {
        private Mobile m_Owner;
        private string m_SlumberBodyName;	// Value of the SleepingNameAttribute attached to the owner when he died -or- null if the owner had no                                  SlumberBodyNameAttribute; use "the remains of ~name~"
        ...
        [Constructable]
        public SlumberBody(Mobile owner, bool blessed): this(owner, blessed, true)
        {
        }

        [Constructable]
        public SlumberBody(Mobile owner, bool blessed, bool isSpell): base(0x2006)
        {
            ...
            m_Owner = owner;
            Name = m_Owner.Name;
            m_SlumberBodyName = GetBodyName(owner);
            Hue = m_Owner.Hue;
        ...
        public SlumberBody(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void SendInfoTo(NetState state, bool sendOplPacket)
        {
            ...
            if (ItemID == 0x2006)
            {
                state.Send(new SlumberBodyContent(state.Mobile, this));
                state.Send(new SlumberBodyEquip(state.Mobile, this));
            }
        }

        public override void AddNameProperty(ObjectPropertyList list)
        {
            if (m_SlumberBodyName != null)
                list.Add(m_SlumberBodyName);
            else
        ...
        {
            LabelTo(from, m_SlumberBodyName == null ? String.Format("Sleeping {0}", Name) : m_SlumberBodyName);
        }
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.Write(m_SlumberBodyName);
                ...
                case 0:
                    {
                        ...
                        m_SlumberBodyName = reader.ReadString();
    ...
    public sealed class SlumberBodyEquip : Packet
    {
        public SlumberBodyEquip(Mobile beholder, SlumberBody beheld)
            : base(0x89)
        {
    ...
    public sealed class SlumberBodyContent : Packet
    {
        public SlumberBodyContent(Mobile beholder, SlumberBody beheld)
            : base(0x3C)
        {
