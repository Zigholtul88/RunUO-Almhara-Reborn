...
namespace Server.Misc
{
	public class DataPath
	{
		 ...
		 */
                private static string CustomPath = @"C:\Users\Brandon Hoppel\Desktop\RunUO 2.2\RunUO 2.2\Data Files";
		...
		public static void Configure()
		{
			...
			string pathSA = GetPath( @"C:\Users\Brandon Hoppel\Documents\Ultima Online (Almhara Reborn)", "InstallDir" );
			string pathHS = GetPath( @"C:\Users\Brandon Hoppel\Documents\Ultima Online (Almhara Reborn)", "InstallDir" );
                        string pathClassic = GetPath( @"C:\Users\Brandon Hoppel\Documents\Ultima Online (Almhara Reborn)", "InstallDir" ); // Scriptiz : Classic client registry key (7.0.1x.x)
