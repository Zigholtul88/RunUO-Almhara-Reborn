		...
		public static readonly LootPackItem[] Gold = new LootPackItem[]
			{
                ...
                public static readonly LootPackItem[] RandomFoodRecipeItems = new LootPackItem[]
		        {
                                new LootPackItem( typeof( RandomBakingRecipe ), 1 ), 
                                new LootPackItem( typeof( RandomPreparationsRecipe ), 1 ),
                                new LootPackItem( typeof( RandomBoilingRecipe ), 1 ), 
                                new LootPackItem( typeof( RandomRawMeatPrepRecipe ), 1 ),
                                new LootPackItem( typeof( RandomIngredientsRecipe ), 1 ), 
                                new LootPackItem( typeof( RandomSaucesRecipe ), 1 ),
		...
		public static readonly LootPackItem[] PotionItems = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( LesserManaPotion ), 1 ),
				new LootPackItem( typeof( MindPotion ), 1 ),
				new LootPackItem( typeof( NovicePotionOfArchery ), 1 ),
				new LootPackItem( typeof( NovicePotionOfFencing ), 1 ),
				new LootPackItem( typeof( NovicePotionOfMaceFighting ), 1 ),
				new LootPackItem( typeof( NovicePotionOfMagery ), 1 ),
				new LootPackItem( typeof( NovicePotionOfParry ), 1 ),
				new LootPackItem( typeof( NovicePotionOfSwordsmanship ), 1 ),
				new LootPackItem( typeof( NovicePotionOfWrestling ), 1 ),
				new LootPackItem( typeof( NovicePotionOfAlchemy ), 1 ),
				new LootPackItem( typeof( NovicePotionOfBlacksmithy ), 1 ),
				new LootPackItem( typeof( NovicePotionOfCarpentry ), 1 ),
				new LootPackItem( typeof( NovicePotionOfCooking ), 1 ),
				new LootPackItem( typeof( NovicePotionOfFletching ), 1 ),
				new LootPackItem( typeof( NovicePotionOfInscription ), 1 ),
				new LootPackItem( typeof( NovicePotionOfTailoring ), 1 ),
				new LootPackItem( typeof( NovicePotionOfTinkering ), 1 ),
				new LootPackItem( typeof( NovicePotionOfAnimalTaming ), 1 ),
				new LootPackItem( typeof( NovicePotionOfDiscordance ), 1 ),
				new LootPackItem( typeof( NovicePotionOfFishing ), 1 ),
				new LootPackItem( typeof( NovicePotionOfHerding ), 1 ),
				new LootPackItem( typeof( NovicePotionOfHiding ), 1 ),
				new LootPackItem( typeof( NovicePotionOfLumberjacking ), 1 ),
				new LootPackItem( typeof( NovicePotionOfMagicResist ), 1 ),
				new LootPackItem( typeof( NovicePotionOfMining ), 1 ),
				new LootPackItem( typeof( NovicePotionOfPeacemaking ), 1 ),
				new LootPackItem( typeof( NovicePotionOfPoisoning ), 1 ),
				new LootPackItem( typeof( NovicePotionOfProvocation ), 1 ),
				new LootPackItem( typeof( NovicePotionOfSnooping ), 1 ),
				new LootPackItem( typeof( NovicePotionOfStealing ), 1 ),
				new LootPackItem( typeof( NovicePotionOfVeterinary ), 1 )
			};
		...
		public static readonly LootPackItem[] AosMagicItemsPoor = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( BaseRanged ), 1 ),
				new LootPackItem( typeof( BaseArmor ), 4 ),
	                        new LootPackItem( typeof( BaseClothing ), 4 ),
				new LootPackItem( typeof( BaseShield ), 1 ),
		...
		public static readonly LootPackItem[] AosMagicItemsMeagerType1 = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( BaseArmor ), 81 ),
	                        new LootPackItem( typeof( BaseClothing ), 81 ),
		...
		public static readonly LootPackItem[] AosMagicItemsMeagerType2 = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( BaseArmor ), 40 ),
	                        new LootPackItem( typeof( BaseClothing ), 40 ),
		...
		public static readonly LootPackItem[] AosMagicItemsAverageType1 = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( BaseArmor ), 130 ),
	                        new LootPackItem( typeof( BaseClothing ), 130 ),
		...
		public static readonly LootPackItem[] AosMagicItemsAverageType2 = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( BaseArmor ), 77 ),
	                        new LootPackItem( typeof( BaseClothing ), 77 ),
		...
		public static readonly LootPackItem[] AosMagicItemsRichType1 = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( BaseArmor ), 303 ),
	                        new LootPackItem( typeof( BaseClothing ), 303 ),
		...
		public static readonly LootPackItem[] AosMagicItemsRichType2 = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( BaseArmor ), 245 ),
	                        new LootPackItem( typeof( BaseClothing ), 245 ),
		...
		public static readonly LootPackItem[] AosMagicItemsFilthyRichType1 = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( BaseArmor ), 315 ),
	                        new LootPackItem( typeof( BaseClothing ), 315 ),
		...
		public static readonly LootPackItem[] AosMagicItemsFilthyRichType2 = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( BaseArmor ), 343 ),
	                        new LootPackItem( typeof( BaseClothing ), 343 ),
		...
		public static readonly LootPackItem[] AosMagicItemsUltraRich = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( BaseArmor ), 397 ),
	                        new LootPackItem( typeof( BaseClothing ), 397 ),
	...
	public class LootPackEntry
	{
		...
		public Item Mutate( Mobile from, int luckChance, Item item )
		{
			if ( item != null )
			{
				...
				if ( item is BaseWeapon || item is BaseArmor || item is BaseJewel || item is BaseHat || item is BaseClothing )
				{
					if ( Core.AOS )
					{
