...
namespace Server
{
	public class Loot
	{
		...
		private static Type[] m_WeaponTypes = new Type[]
			{
				...
				typeof( ExecutionersAxe ),	      typeof( Hatchet ),		typeof( LargeBattleAxe ),
                                ...
                                typeof( ButcherKnife ),		      typeof( Cleaver ),            typeof( Dagger ),				
                                typeof( SkinningKnife ),            typeof( Club ),                typeof( HammerPick ),
				typeof( Mace ),			    typeof( Maul ),		   typeof( WarHammer ),
				typeof( WarMace ),		    typeof( Bardiche ),		   typeof( Halberd ),
                                typeof( Pitchfork ),                typeof( ShortSpear ),          typeof( Spear ),				
				typeof( WarFork ),		    typeof( BlackStaff ),	   typeof( GnarledStaff ),
				typeof( QuarterStaff ),		    typeof( ShepherdsCrook ),      typeof( Cutlass ),                  
                                typeof( Katana ),		    typeof( Kryss ),	           typeof( Longsword ),                
                                typeof( Scimitar ),		    typeof( VikingSword ),
				typeof( BladedStaff ),              typeof( BoneHarvester ),       typeof( CrescentBlade ),
                                typeof( DoubleBladedStaff ),        typeof( Lance ),		   typeof( Pike ),	
                                typeof( Scepter ),                  typeof( Scythe ), 		   typeof( Bokuto ),				
                                typeof( Daisho ),		    typeof( Kama ),                typeof( Lajatang ),			
                                typeof( NoDachi ),		    typeof( Nunchaku ),            typeof( Sai ),			
                		typeof( Tekagi ),		    typeof( Tessen ),              typeof( Tetsubo ),	
        			typeof( Wakizashi ),                typeof( AssassinSpike ),       typeof( DiamondMace ),	
        			typeof( ElvenMachete ),             typeof( ElvenSpellblade ),     typeof( Leafblade ),
        			typeof( OrnateAxe ),                typeof( RadiantScimitar ),     typeof( RuneBlade ),
        			typeof( WarCleaver ),               typeof( WildStaff ),
        			typeof( CrystalStaff ),             typeof( EbonyBattleAxe ),      typeof( EbonyBattleSpear ),	
        			typeof( EbonyCrossbow ),            typeof( EbonyDagger ),         typeof( EbonyDualDaggers ),
        			typeof( EbonyDualKatanas ),         typeof( EbonyGlassAxe ),       typeof( EbonyGlassBardiche ),
        			typeof( EbonyGreatBow ),            typeof( EbonyMoonblade ),      typeof( EbonyMorningstar ),	
        			typeof( EbonyPristineStaff ),       typeof( EbonyRapier ),         typeof( EbonyScimitar ),
        			typeof( EbonyWarBow ),              typeof( EbonyWarMace ),        typeof( PristineStaff ),
        			typeof( SkeletalWarBow ),           typeof( TribalStaff )	
			};
		...
		private static Type[] m_RangedWeaponTypes = new Type[]
			{
				...
				typeof( CompositeBow ),				typeof( RepeatingCrossbow ),			typeof( Yumi ),
		...
		private static Type[] m_ArmorTypes = new Type[]
			{
				...
				typeof( DemonscaleArms ),		typeof( DemonscaleChest ),		typeof( DemonscaleGloves ),
				typeof( DemonscaleGorget ),		typeof( DemonscaleHelmet ),	        typeof( DemonscaleLegs ),
				typeof( EbonsilkArms ),	                typeof( EbonsilkChest ),		typeof( EbonsilkGloves ),
				typeof( EbonsilkGorget ),	        typeof( EbonsilkLegs ),			typeof( EbonsilkTiara ),
				typeof( ElvenPlateArms ),	        typeof( ElvenPlateChest ),		typeof( ElvenPlateHelm ),
				typeof( ElvenPlateLegs )
			};
		...
		private static Type[] m_ShieldTypes = new Type[]
			{
				...
				typeof( WoodenShield ),
				typeof( AmmoniteShield ),	      typeof( BlackHeaterShield ),		typeof( BoneShield ),
				typeof( CentaurShield ),	      typeof( ElvenShield ),			typeof( GrassShield ),
				typeof( InfantryShield ),	      typeof( JewelShield ),			typeof( MercenaryShield ),
				typeof( NymphShield ),	            typeof( ScarabShield ),			typeof( SpiderShield ),
				typeof( UnicornShield ),	      typeof( WoodenDragonShield )
			};
		...
		private static Type[] m_GemTypes = new Type[]
			{
				...
				typeof( Agate ),				typeof( Beryl ),				typeof( ChromeDiopside ),
				typeof( FireOpal ),				typeof( MoonstoneCustom ),			typeof( Onyx ),
				typeof( Opal ),				        typeof( Pearl ),			        typeof( TurquoiseCustom ),
				typeof( Bloodstone ),				typeof( Demantoid ),				typeof( Jasper ),
				typeof( Lolite ),				typeof( Lupis ),			        typeof( Peridot ),
				typeof( Tsavorite ),				typeof( Zircon ),	
				typeof( Andalusite ),				typeof( Chrysoberyl ),				typeof( Garnet ),
				typeof( Jade ),				        typeof( Mandarin ),			        typeof( Morganite ),
				typeof( Paraiba ),				typeof( TigerEye ),
				typeof( Alexandrite ),				typeof( Ametrine ),				typeof( Kunzite ),
				typeof( Tanzanite ),				typeof( Topaz ),			        typeof( Zultanite ),
				typeof( PinkQuartz )
			};
		...
		private static Type[] m_JewelryTypes = new Type[]
			{
				...
				typeof( RingOfCure ),		        typeof( RingOfInvisibility ),
				typeof( RingOfTeleportation )
			};
		...
		private static Type[] m_PotionTypes = new Type[]
			{
				...
				typeof( LesserCurePotion ),		      typeof( LesserHealPotion ),        typeof( LesserPoisonPotion ),
                                typeof( LesserExplosionPotion ),              typeof( NightSightPotion ),        typeof( LesserManaPotion ),
                                typeof( MindPotion ),                         typeof( LesserLightningPotion ),        typeof( LesserShatterPotion ),                         
                                typeof( NovicePotionOfArchery ),              typeof( NovicePotionOfFencing ),
                                typeof( NovicePotionOfMaceFighting ),         typeof( NovicePotionOfMagery ),    typeof( NovicePotionOfParry ),
                                typeof( NovicePotionOfSwordsmanship ),          typeof( NovicePotionOfWrestling ),          typeof( NovicePotionOfAlchemy ),
                                typeof( NovicePotionOfBlacksmithy ),          typeof( NovicePotionOfCarpentry ),          typeof( NovicePotionOfCooking ),
                                typeof( NovicePotionOfFletching ),          typeof( NovicePotionOfInscription ),          typeof( NovicePotionOfTailoring ),
                                typeof( NovicePotionOfTinkering ),          typeof( NovicePotionOfAnimalTaming ),          typeof( NovicePotionOfDiscordance ),
                                typeof( NovicePotionOfFishing ),          typeof( NovicePotionOfHerding ),          typeof( NovicePotionOfHiding ),
                                typeof( NovicePotionOfMagicResist ),          typeof( NovicePotionOfMining ),          typeof( NovicePotionOfPeacemaking ),
                                typeof( NovicePotionOfPoisoning ),          typeof( NovicePotionOfProvocation ),          typeof( NovicePotionOfSnooping ),
                                typeof( NovicePotionOfStealing ),          typeof( NovicePotionOfVeterinary ),          typeof( NovicePotionOfLumberjacking )
			};
		...
		private static Type[] m_WandTypes = new Type[]
			{
				...
				typeof( LightningWand ),            typeof( MagicArrowWand ),
		...
		private static Type[] m_ClothingTypes = new Type[]
			{
				...
				typeof( HalfApron ),		typeof( ClothNinjaJacket ),	  typeof( FemaleKimono ),			
                                typeof( Hakama ),               typeof( HakamaShita ),	          typeof( JinBaori ),				
                                typeof( Kamishimo ),            typeof( MaleKimono ),		  typeof( NinjaTabi ),
   			        typeof( Obi ),                  typeof( SamuraiTabi ),	          typeof( TattsukeHakama ),		
                                typeof( Waraji ),
   			        typeof( FancyTunic ),           typeof( ReinassanceShirt ),	  typeof( Trenchcoat ),	
	   			typeof( FancyPants ),           typeof( ReinassancePants ),	  typeof( HeavyBoots ),
	   			typeof( HighBoots ),            typeof( LightBoots ),	          typeof( ShortBoots ),
   			        typeof( FormalShirt ),          typeof( FurBoots ),	          typeof( FurCape ),	
	   			typeof( FurSarong ),            typeof( GildedDress ),	    
	   			typeof( ElvenDarkShirt ),       typeof( ElvenShirt ),	          typeof( MoonElfShirt ),
	   			typeof( RogueGarb ),            typeof( BaroqueMask ),	          typeof( ElvenPants ),
	   			typeof( MoonElfSkirt ),         typeof( ElvenRobe ),	          typeof( FemaleElvenRobe ),
	   			typeof( MoonElfFancyRobe ),     typeof( SunElfFancyRobe ),
	   			typeof( LeatherShirt ),         typeof( LeatherPants )
			};
		...
		private static Type[] m_AosHatTypes = new Type[]
			{
				typeof( BearMask ),		typeof( DeerMask )	//Are Bear& Deer mask inside the Pre-AoS loottables too?
			};
		...
		private static Type[] m_HatTypes = new Type[]
			{
				...
				typeof( BearMask ),		        typeof( DeerMask ),             typeof( ClothNinjaHood ),
                                typeof( Kasa )
			};
