...
namespace Server.Misc
{
	public class Weather
	{
		...
		public static void Initialize()
		{
		  ...
		  // Vigilant Valley
			AddWeather( +15, 95, 25, new Rectangle2D( 4105, 2233, 97, 57 ), new Rectangle2D( 4124, 2182, 73, 69 ) );
			...
			m_Facets = new Map[]{ Map.Ilshenar };

                  // swamp
			AddWeather( +16,  95, 5, new Rectangle2D( 260, 1018, 540, 1412 ) ); 

			for ( int i = 0; i < 15; ++i )
			AddDynamicWeather( +15, 55, 5, 8, 400, 400, new Rectangle2D( 1048, 934, 1726, 1380 ) ); //Lakeshire's Valley

			m_Facets = new Map[]{ Map.Malas };

                  // Glimmerwood
			AddWeather( +15, 100, 25, new Rectangle2D( 120, 569, 255, 238 ) );

                  // Island of Giants
			AddWeather( +15, 95, 5, new Rectangle2D( 1315, 1616, 257, 107 ), new Rectangle2D( 1373, 1693, 95, 66 ), new Rectangle2D( 1341, 1556, 204, 74 ) );

                  // Wintergrove
			AddWeather( -15, 100, 5, new Rectangle2D( 918, 303, 1000, 272 ), new Rectangle2D( 1050, 151, 776, 200 ), new Rectangle2D( 1334, 499, 528, 264 ) );

			m_Facets = new Map[]{ Map.Tokuno };

                  // Bleak Wind Tunnels
			AddWeather( +15, 100, 25, new Rectangle2D( 564, 288, 252, 155 ) );

                  // Shatter Glass Caverns Mountain Top
			AddWeather( +15, 95, 5, new Rectangle2D( 862, 455, 51, 62 ) );
		}
