...
namespace Server
{
	public class PoisonImpl : Poison
	{
		...
		public static void Configure()
		{
			if ( Core.AOS )
			{
				Register( new PoisonImpl( "Lesser",		0,  1, 5, 2.500, 5.5, 5.0, 10, 2 ) );
				Register( new PoisonImpl( "Regular",	        1,  5, 10, 3.125, 4.5, 4.0, 10, 2 ) );
				Register( new PoisonImpl( "Greater",	        2, 15, 35, 6.250, 3.5, 3.0, 10, 2 ) );
				Register( new PoisonImpl( "Deadly",		3, 25, 40, 12.500, 2.5, 2.0, 10, 2 ) );
				Register( new PoisonImpl( "Lethal",		4, 35, 50, 25.000, 1.5, 1.0, 10, 2 ) );
			}
			else
			{
				...
				Register( new PoisonImpl( "Lethal",		4, 20, 26, 25.000, 3.5, 5.0, 10, 2 ) );
			}
		}
