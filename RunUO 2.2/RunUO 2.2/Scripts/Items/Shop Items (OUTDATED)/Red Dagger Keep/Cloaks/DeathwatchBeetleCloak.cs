...
{
        public class DeathwatchBeetleCloak : Cloak
        {
                ...
                [Constructable]
                public DeathwatchBeetleCloak()
                {
			Name = "Deathwatch Beetle Cloak";
                        LootType = LootType.Blessed;
                }

                public DeathwatchBeetleCloak( Serial serial ) : base( serial )
                {
                }
