...
namespace Server.Items
{
	...
	/// </summary>
	public class CalcifinaFortressMetalDoor : MetalDoor, ILockpickable
	{
		...
		[Constructable]
		public CalcifinaFortressMetalDoor( DoorFacing facing ) : base( facing )
		{
			m_LockLevel = 25;
			m_MaxLockLevel = 30; 
			m_RequiredSkill = 25;
...
// determines how long the door remains unlocked
		...
		public override void Use( Mobile from )
		{
			...
			{
				Locked = true;
				from.SendMessage( "The door requires a skill of 25 you skin of a rabid weasel." );
				return;
			}
		...
		public CalcifinaFortressMetalDoor( Serial serial ) : base( serial )
		{
