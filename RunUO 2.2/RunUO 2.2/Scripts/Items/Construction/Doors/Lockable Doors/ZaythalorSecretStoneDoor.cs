...
namespace Server.Items
{
	...
	/// </summary>
	public class ZaythalorSecretStoneDoor : SecretStoneDoor3, ILockpickable
	{
		...
		[Constructable]
		public ZaythalorSecretStoneDoor( DoorFacing facing ) : base( facing )
		{
			m_LockLevel = 30;
			m_MaxLockLevel = 35; 
			m_RequiredSkill = 30;
...
// determines how long the door remains unlocked
		...
		public override void Use( Mobile from )
		{
			...
			{
				Locked = true;
				from.SendMessage( "The door requires a skill of 30 you benign slapper of men's bare bottoms." );
				return;
			}
		...
		public ZaythalorSecretStoneDoor( Serial serial ) : base( serial )
		{
