...
namespace Server.Items
{
	...
	/// </summary>
	public class StoneBurrowMineLockedDoor : StrongWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public StoneBurrowMineLockedDoor( DoorFacing facing ) : base( facing )
		{
			m_LockLevel = 25;
			m_MaxLockLevel = 30; 
			m_RequiredSkill = 25;
...
// determines how long the door remains unlocked
		...
		public override void Use( Mobile from )
		{
			...
			{
				Locked = true;
				from.SendMessage( "The door requires a skill of 25 you innocous snatcher of women's blouses." );
				return;
			}
		...
		public StoneBurrowMineLockedDoor( Serial serial ) : base( serial )
		{
