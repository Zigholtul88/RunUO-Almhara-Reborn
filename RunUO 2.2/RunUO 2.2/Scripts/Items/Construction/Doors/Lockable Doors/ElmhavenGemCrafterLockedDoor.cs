...
namespace Server.Items
{
	...
	/// </summary>
	public class ElmhavenGemCrafterLockedDoor : StrongWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public ElmhavenGemCrafterLockedDoor( DoorFacing facing ) : base( facing )
		{
			m_LockLevel = 10;
			m_MaxLockLevel = 15; 
			m_RequiredSkill = 10;
...
// determines how long the door remains unlocked
		...
		public override void Use( Mobile from )
		{
			...
			{
				Locked = true;
				from.SendMessage( "The door requires a skill of 10 you yeast infected petunia." );
				return;
			}
		...
		public ElmhavenGemCrafterLockedDoor( Serial serial ) : base( serial )
		{
