...
namespace Server.Items
{
	...
	/// </summary>
	public class ZaythalorTavernLockedDoor : StrongWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public ZaythalorTavernLockedDoor( DoorFacing facing ) : base( facing )
		{
			m_LockLevel = 15;
			m_MaxLockLevel = 20; 
			m_RequiredSkill = 15;
...
// determines how long the door remains unlocked
		...
		public override void Use( Mobile from )
		{
			...
			{
				Locked = true;
				from.SendMessage( "The door requires a skill of 15 you callous carpet cruncher." );
				return;
			}
		...
		public ZaythalorTavernLockedDoor( Serial serial ) : base( serial )
		{
