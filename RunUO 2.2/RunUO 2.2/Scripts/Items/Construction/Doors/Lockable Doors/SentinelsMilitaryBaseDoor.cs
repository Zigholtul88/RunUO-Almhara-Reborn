...
namespace Server.Items
{
	...
	/// </summary>
	public class SentinelsMilitaryBaseDoor : MetalDoor, ILockpickable
	{
		...
		[Constructable]
		public SentinelsMilitaryBaseDoor( DoorFacing facing ) : base( facing )
		{
			m_LockLevel = 15;
			m_MaxLockLevel = 20; 
			m_RequiredSkill = 15;
...
// determines how long the door remains unlocked
		...
		public override void Use( Mobile from )
		{
			...
			{
				Locked = true;
				from.SendMessage( "The door requires a skill of 15 you smelly old fink." );
				return;
			}
		...
		public SentinelsMilitaryBaseDoor( Serial serial ) : base( serial )
		{
