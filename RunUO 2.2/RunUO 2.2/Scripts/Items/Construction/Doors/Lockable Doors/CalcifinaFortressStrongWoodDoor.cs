...
namespace Server.Items
{
	...
	/// Original script created b Carding. Modified by PitHelvit. Further Modified By Zigholtul.
	/// </summary>
	public class CalcifinaFortressStrongWoodDoor : StrongWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public CalcifinaFortressStrongWoodDoor( DoorFacing facing ) : base( facing )
		{
			m_LockLevel = 25;
			m_MaxLockLevel = 30; 
			m_RequiredSkill = 25;
...
// determines how long the door remains unlocked
		...
		public override void Use( Mobile from )
		{
			...
			{
				Locked = true;
				from.SendMessage( "The door requires a skill of 25 you smelly vial of gizzard farts." );
				return;
			}
		...
		public CalcifinaFortressStrongWoodDoor( Serial serial ) : base( serial )
		{
