...
{ 
    ...
    {
        [Constructable]
        public StatueGargoyleEast() : base(0x494E)
        {
            Weight = 1.0;
        }

        public StatueGargoyleEast(Serial serial) : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public StatueGargoyleSouth() : base(0x494D)
        {
            Weight = 1.0;
        }

        public StatueGargoyleSouth(Serial serial) : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public StatueGryphonEast() : base(0x493C)
        {
            Weight = 1.0;
        }

        public StatueGryphonEast(Serial serial) : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public StatueGryphonSouth() : base(0x493B)
        {
            Weight = 1.0;
        }

        public StatueGryphonSouth(Serial serial) : base(serial)
        {
        }
