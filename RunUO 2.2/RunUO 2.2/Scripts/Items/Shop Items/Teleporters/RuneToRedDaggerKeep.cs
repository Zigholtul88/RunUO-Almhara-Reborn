...
{
	public class RuneToRedDaggerKeep : Item
	{
		public override string DefaultName
		{
			get { return "Rune to Red Dagger Keep"; }
		}

		[Constructable]
		public RuneToRedDaggerKeep() : base( 0x1F14 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public RuneToRedDaggerKeep( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.CloseGump( typeof( RuneToRedDaggerKeepGump ) );
				from.SendGump( new RuneToRedDaggerKeepGump( from ) );
			}
			else
			{
	...
	public class RuneToRedDaggerKeepGump : Gump
	{
		public RuneToRedDaggerKeepGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279, "This rune will teleport you to Red Dagger Keep.<br><br><i>By using this rune, your entire mana and stamina pool will be depleted in the process.</i><br><br>Are you sure you want to commit?", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
			            Item a = from.Backpack.FindItemByType( typeof(RuneToRedDaggerKeep) );
			            if ( a != null )
					...
					from.CloseGump( typeof( RuneToRedDaggerKeepGump ) );
                                        from.Location = new Point3D(382, 1884, 29);
				        from.Map = Map.Malas;
