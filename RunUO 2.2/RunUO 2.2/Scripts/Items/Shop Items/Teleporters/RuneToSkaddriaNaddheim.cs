...
{
	public class RuneToSkaddriaNaddheim : Item
	{
		public override string DefaultName
		{
			get { return "Rune to Skaddria Naddheim"; }
		}

		[Constructable]
		public RuneToSkaddriaNaddheim() : base( 0x1F14 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public RuneToSkaddriaNaddheim( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.CloseGump( typeof( RuneToSkaddriaNaddheimGump ) );
				from.SendGump( new RuneToSkaddriaNaddheimGump( from ) );
			}
			else
			{
	...
	public class RuneToSkaddriaNaddheimGump : Gump
	{
		public RuneToSkaddriaNaddheimGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(282, 151, 1153, @"Rune to Covens Landing!");
			this.AddButton(226, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddButton(351, 469, 241, 242,  1, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "This rune will teleport you to Skaddria Naddheim.<br><br><i>By using this rune, your entire mana and stamina pool will be depleted in the process.</i><br><br>Are you sure you want to commit?", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
			            Item a = from.Backpack.FindItemByType( typeof(RuneToSkaddriaNaddheim) );
			            if ( a != null )
					...
					from.CloseGump( typeof( RuneToSkaddriaNaddheimGump ) );
                                        from.Location = new Point3D(1629, 1880, 5);
				        from.Map = Map.Malas;
				...
				case 1:
				{
					from.SendMessage( "You decide to not go to Skaddria Naddheim. What a pity." );
					from.CloseGump( typeof( RuneToSkaddriaNaddheimGump ) );
					break;
				}
			}
