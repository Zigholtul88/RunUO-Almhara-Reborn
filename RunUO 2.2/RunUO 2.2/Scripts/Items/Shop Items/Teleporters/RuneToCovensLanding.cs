...
{
	public class RuneToCovensLanding : Item
	{
		public override string DefaultName
		{
			get { return "Rune to Covens Landing"; }
		}

		[Constructable]
		public RuneToCovensLanding() : base( 0x1F14 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public RuneToCovensLanding( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.CloseGump( typeof( RuneToCovensLandingGump ) );
				from.SendGump( new RuneToCovensLandingGump( from ) );
			}
			else
			{
	...
	public class RuneToCovensLandingGump : Gump
	{
		public RuneToCovensLandingGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279, "This rune will teleport you to Covens Landing.<br><br><i>By using this rune, your entire mana and stamina pool will be depleted in the process.</i><br><br>Are you sure you want to commit?", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
			            Item a = from.Backpack.FindItemByType( typeof(RuneToCovensLanding) );
			            if ( a != null )
					...
					from.CloseGump( typeof( RuneToCovensLandingGump ) );
                                        from.Location = new Point3D(1760, 430, 35);
				        from.Map = Map.Malas;
