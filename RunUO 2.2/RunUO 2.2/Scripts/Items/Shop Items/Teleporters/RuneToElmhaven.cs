...
{
	public class RuneToElmhaven : Item
	{
		public override string DefaultName
		{
			get { return "Rune to Elmhaven"; }
		}

		[Constructable]
		public RuneToElmhaven() : base( 0x1F14 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public RuneToElmhaven( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.CloseGump( typeof( RuneToElmhavenGump ) );
				from.SendGump( new RuneToElmhavenGump( from ) );
			}
			else
			{
	...
	public class RuneToElmhavenGump : Gump
	{
		public RuneToElmhavenGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(282, 151, 1153, @"Rune to Elmhaven!");
			this.AddButton(226, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddButton(351, 469, 241, 242,  1, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "This rune will teleport you to Elmhaven.<br><br><i>By using this rune, your entire mana and stamina pool will be depleted in the process.</i><br><br>Are you sure you want to commit?", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
			            Item a = from.Backpack.FindItemByType( typeof(RuneToElmhaven) );
			            if ( a != null )
					...
					from.CloseGump( typeof( RuneToElmhavenGump ) );
                                        from.Location = new Point3D(709, 692, -9);
				        from.Map = Map.Malas;
				...
				case 1:
				{
					from.SendMessage( "You decide to not go to Elmhaven. What a pity." );
					from.CloseGump( typeof( RuneToElmhavenGump ) );
					break;
				}
			}
