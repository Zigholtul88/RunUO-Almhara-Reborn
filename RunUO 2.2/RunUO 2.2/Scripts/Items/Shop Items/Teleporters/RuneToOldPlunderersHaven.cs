...
{
	public class RuneToOldPlunderersHaven : Item
	{
		public override string DefaultName
		{
			get { return "Rune to Old Plunderer's Haven"; }
		}

		[Constructable]
		public RuneToOldPlunderersHaven() : base( 0x1F14 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public RuneToOldPlunderersHaven( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.CloseGump( typeof( RuneToOldPlunderersHavenGump ) );
				from.SendGump( new RuneToOldPlunderersHavenGump( from ) );
			}
			else
			{
	...
	public class RuneToOldPlunderersHavenGump : Gump
	{
		public RuneToOldPlunderersHavenGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(282, 151, 1153, @"Rune to Old Plunderer's Haven!");
			this.AddButton(226, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddButton(351, 469, 241, 242,  1, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "This rune will teleport you to Old Plunderer's Haven.<br><br><i>By using this rune, your entire mana and stamina pool will be depleted in the process.</i><br><br>Are you sure you want to commit?", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
			            Item a = from.Backpack.FindItemByType( typeof(RuneToOldPlunderersHaven) );
			            if ( a != null )
					...
					from.CloseGump( typeof( RuneToOldPlunderersHavenGump ) );
                                        from.Location = new Point3D(724, 1245, 20);
				        from.Map = Map.Malas;
				...
				case 1:
				{
					from.SendMessage( "You decide to not go to Old Plunderer's Haven. What a pity." );
					from.CloseGump( typeof( RuneToOldPlunderersHavenGump ) );
					break;
				}
			}
