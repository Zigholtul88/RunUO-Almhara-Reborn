...
namespace Server.Items
{
	public class BoulderTrap : Item
	{
		...
		public BoulderTrap( Serial serial ) : base( serial )
		{
		}
...
///////////////////////		
		...
		{
			private BoulderTrap m_BoulderTrap;
			
		
			public RecordLocationTimer ( BoulderTrap trap ) : base( TimeSpan.Zero )
			{
				m_BoulderTrap = trap;
			}
			...
			protected override void OnTick()
			{
				...
				m_BoulderTrap.m_XPlus = new XPlus (m_BoulderTrap);
				m_BoulderTrap.m_XPlus.Start();
			}
		}
	...
	///////////////////
		private class XPlus  : Timer
		{
			...
			public XPlus ( BoulderTrap trap ) : base( TimeSpan.FromSeconds( 0.1 ) )
			{
	...
	///////////////////////////////
		private class XMinus  : Timer
		{
			...
			public XMinus ( BoulderTrap trap ) : base( TimeSpan.FromSeconds( 0.1 ) )
			{
				Priority = TimerPriority.FiftyMS;
