...
namespace Server.Items
{
	public class BloodSlime : Item
	{
		...
		[Constructable]
		public BloodSlime() : this( TimeSpan.FromSeconds( 10.0 ), 5, 10 )
		{
		}

		public override string DefaultName { get { return "blood slime"; } }

		[Constructable]
		public BloodSlime( TimeSpan duration, int minDamage, int maxDamage ): base( 0x122A )
		{
			Hue = 0x648;
			Movable = false;
		...
		public void Damage ( Mobile m )
		{
			...
			if ( Core.AOS )
				AOS.Damage( m, damage, 100, 0, 0, 0, 0 );
			else
				m.Damage( damage );
		}
