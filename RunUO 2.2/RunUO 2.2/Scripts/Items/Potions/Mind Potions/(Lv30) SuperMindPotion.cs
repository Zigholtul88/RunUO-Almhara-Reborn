...
{
	public class SuperMindPotion  : BaseMindPotion
	{
		...
		[Constructable]
		public SuperMindPotion () : base( PotionEffect.AgilityGreater )
		{
                	Name = "Super Teal Potion";
                	ItemID = 0xF04;
                	Hue = 1173;
		}

		public SuperMindPotion ( Serial serial ) : base( serial )
		{
		}
