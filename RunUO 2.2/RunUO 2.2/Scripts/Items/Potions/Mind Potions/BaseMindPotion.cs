...
{
	public abstract class BaseMindPotion : BasePotion
	{
		...
		public BaseMindPotion( PotionEffect effect ) : base( 0xF09, effect )
		{
		}

		public BaseMindPotion( Serial serial ) : base( serial )
		{
		}
