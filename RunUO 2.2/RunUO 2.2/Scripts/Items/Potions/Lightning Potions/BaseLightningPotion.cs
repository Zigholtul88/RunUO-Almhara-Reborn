...
{
	public abstract class BaseLightningPotion : BasePotion
	{
		...
		public BaseLightningPotion( PotionEffect effect ) : base( 0xF0D, effect )
		{
		}

		public BaseLightningPotion( Serial serial ) : base( serial )
		{
		}
		...
		{
			private BaseLightningPotion m_Potion;

			public BaseLightningPotion Potion
			{
				get{ return m_Potion; }
			}

			public ThrowTarget( BaseLightningPotion potion ) : base( 12, true, TargetFlags.None )
			{
				m_Potion = potion;
			}
		...
		public void Explode( Mobile from, bool direct, Point3D loc, Map map )
		{
			...
			Effects.PlaySound(loc, map, 0x029);
			Effects.PlaySound(loc, map, 0x206);
			...
			for ( int i = 0; i < toExplode.Count; ++i )
			{
				...
				else if ( o is BaseLightningPotion )
				{
					BaseLightningPotion pot = (BaseLightningPotion)o;
