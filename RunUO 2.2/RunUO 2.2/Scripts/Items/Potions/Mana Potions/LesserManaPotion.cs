...
{
	public class LesserManaPotion : BasePotion
	{
		[Constructable]
		public LesserManaPotion() : base( 0xF03, PotionEffect.Heal )
		{
			Name = "Lesser Sky Blue Potion";
			Hue = 1266;
		}
		...
		public override void Drink( Mobile from )
		{
			if ( from.Mana < from.ManaMax )
			{
				...
				{
					from.Mana = Math.Min( from.Mana + 25, from.ManaMax);
