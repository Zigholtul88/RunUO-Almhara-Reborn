...
{
	public class MaximumManaPotion : BasePotion
	{
		[Constructable]
		public MaximumManaPotion() : base( 0xF03, PotionEffect.Heal )
		{
			Name = "Maximum Sky Blue Potion";
			Hue = 1266;
		}

		public MaximumManaPotion( Serial serial ) : base( serial )
		{
		}
		...
		public override void Drink( Mobile from )
		{
			if ( from.Mana < from.ManaMax )
			{
				...
				{
					from.Mana = Math.Min( from.Mana + 200, from.ManaMax);
