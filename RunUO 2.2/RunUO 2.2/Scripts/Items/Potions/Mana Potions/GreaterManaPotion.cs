...
{
	public class GreaterManaPotion : BasePotion
	{
		[Constructable]
		public GreaterManaPotion() : base( 0xF03, PotionEffect.Heal )
		{
			Name = "Greater Sky Blue Potion";
			Hue = 1266;
		}
		...
		public override void Drink( Mobile from )
		{
			if ( from.Mana < from.ManaMax )
			{
				...
				{
					from.Mana = Math.Min( from.Mana + 100, from.ManaMax);
