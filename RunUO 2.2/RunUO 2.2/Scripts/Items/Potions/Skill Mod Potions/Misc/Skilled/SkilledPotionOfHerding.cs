...
{
	public class SkilledPotionOfHerding : BasePotion
	{ 
		[Constructable]
		public SkilledPotionOfHerding() : base( 0xE29, PotionEffect.Heal )
		{
			Name = "Skilled Potion of Herding";
			Hue = 285;
		}

		public SkilledPotionOfHerding( Serial serial ) : base( serial )
		{
		}
