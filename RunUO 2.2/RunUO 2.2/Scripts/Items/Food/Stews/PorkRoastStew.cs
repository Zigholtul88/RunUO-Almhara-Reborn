...
{
	public class PorkRoastStew : BaseAddon
	{
		[Constructable]
                public PorkRoastStew()
                {
                        AddonComponent stew;
			...
			{
			        {
                                       ...
                                       PorkRoast porkroaststew = new PorkRoast();        //this decides your fillrate
                                       porkroaststew.Eat( from );
		...
		public PorkRoastStew( Serial serial ) : base( serial )
		{
		}
