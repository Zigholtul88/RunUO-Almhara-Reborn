...
{
	public class MuttonStew : BaseAddon
	{
		[Constructable]
                public MuttonStew()
                {
			...
			{
			        {
                                       ...
                                       MuttonSteak muttonstew = new MuttonSteak();        //this decides your fillrate
                                       muttonstew.Eat( from );
		...
		public MuttonStew( Serial serial ) : base( serial )
		{
		}
