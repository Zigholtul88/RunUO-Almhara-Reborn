...
namespace Server.Items
{
	...
	{
		public static readonly TimeSpan CheckDelay = TimeSpan.FromHours( 1.0 );
		...
		{
			get { if ( !m_AllowBottling ) m_AllowBottling = ( 0 >= TimeSpan.Compare( TimeSpan.FromHours( m_BottleDuration ), DateTime.UtcNow.Subtract( m_Start ))); return m_AllowBottling; }
