...
namespace Server.Items
{
	public class BrewDistilleryEastAddon : BaseAddon
	{
		...
		{
		        Name = "Brew Distillery";

			AddComponent( new LocalizedAddonComponent( 0x2DDB, 1150640  ), 0, 1, 0 );
			AddComponent( new LocalizedAddonComponent( 0x2DDC, 1150640 ), 0, 0, 0 );
			Hue = hue;
		}

                public BrewDistilleryEastAddon(Serial serial): base(serial)
		{
		}
	...
	public class BrewDistilleryEastDeed : BaseAddonDeed
	{
		...
		public BrewDistilleryEastDeed()
		{
                ...
                public BrewDistilleryEastDeed(Serial serial): base(serial)
		{
		}
	...
	public class BrewDistillerySouthAddon : BaseAddon
	{
		...
		public BrewDistillerySouthAddon( int hue )
		{
			...
			AddComponent( new LocalizedAddonComponent( 0x2DDC, 1150640 ), 1, 0, 0 );
			AddComponent( new LocalizedAddonComponent( 0x2DDB, 1150640 ), 0, 0, 0 );
			Hue = hue;
		}

                public BrewDistillerySouthAddon(Serial serial): base(serial)
		{
		}
	...
	public class BrewDistillerySouthDeed : BaseAddonDeed
	{
		...
		public BrewDistillerySouthDeed()
		{
                ...
                public BrewDistillerySouthDeed(Serial serial) : base(serial)
		{
		}
