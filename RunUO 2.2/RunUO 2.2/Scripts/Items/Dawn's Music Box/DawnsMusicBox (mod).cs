...
namespace Server.Items
{
	...
	public class DawnsMusicBox : Item, ISecurable
	{
		...
		public static void Initialize()
		{
			...
			m_Info.Add( MusicName.BankTheme, new DawnsMusicInfo( 1075145, DawnsMusicRarity.Common ) );
			m_Info.Add( MusicName.SkaddriaNaddheim, new DawnsMusicInfo( 1075144, DawnsMusicRarity.Common ) );
			m_Info.Add( MusicName.Hammerhill, new DawnsMusicInfo( 1075146, DawnsMusicRarity.Common ) );
			...
			m_Info.Add( MusicName.Elmhaven, new DawnsMusicInfo( 1075147, DawnsMusicRarity.Common ) );
			...
			m_Info.Add( MusicName.RedDaggerKeep, new DawnsMusicInfo( 1075150, DawnsMusicRarity.Common ) );
			m_Info.Add( MusicName.CovensLanding, new DawnsMusicInfo( 1075177, DawnsMusicRarity.Common ) );
			m_Info.Add( MusicName.GuardiansHorizon, new DawnsMusicInfo( 1075149, DawnsMusicRarity.Common ) );
			...
			m_Info.Add( MusicName.Elandrim, new DawnsMusicInfo( 1075182, DawnsMusicRarity.Uncommon ) );
		...
		{
			MusicName.Samlethe,	MusicName.Sailing,	MusicName.BankTheme,			MusicName.SkaddriaNaddheim,
			MusicName.Hammerhill,	MusicName.Forest_a,	MusicName.Cove,				MusicName.Death,
			MusicName.Dungeon9,	MusicName.Dungeon2,	MusicName.Cave01,			MusicName.Combat3,
			MusicName.Combat1,	MusicName.Combat2,	MusicName.Elmhaven,			MusicName.Linelle,
			MusicName.LBCastle,	MusicName.RedDaggerKeep,	MusicName.CovensLanding,			MusicName.GuardiansHorizon,
		...
		{
			MusicName.GwennoConversation,	MusicName.DreadHornArea,	MusicName.Elandrim,
