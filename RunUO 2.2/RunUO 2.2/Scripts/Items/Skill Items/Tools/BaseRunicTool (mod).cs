	...
	public abstract class BaseRunicTool : BaseTool
	{
		...
		public static void ApplyAttributesTo( BaseWeapon weapon, bool isRunicTool, int luckChance, int attributeCount, int min, int max )
		{
			...
			for ( int i = 0; i < attributeCount; ++i )
			{
				...
				switch ( random )
				{
					...
					case  4: ApplyAttribute( primary,	min, max, AosAttribute.DefendChance,				1, 50 ); break;
					case  5: ApplyAttribute( primary,	min, max, AosAttribute.CastSpeed,					1, 1 ); break;
					case  6: ApplyAttribute( primary,	min, max, AosAttribute.AttackChance,				1, 50 ); break;
					...
					case 17: ApplyAttribute( secondary,	min, max, AosWeaponAttribute.ResistPhysicalBonus,	1, 50 ); break;
					case 18: ApplyAttribute( secondary,	min, max, AosWeaponAttribute.ResistFireBonus,		1, 50 ); break;
					case 19: ApplyAttribute( secondary,	min, max, AosWeaponAttribute.ResistColdBonus,		1, 50 ); break;
					case 20: ApplyAttribute( secondary,	min, max, AosWeaponAttribute.ResistPoisonBonus,		1, 50 ); break;
					case 21: ApplyAttribute( secondary,	min, max, AosWeaponAttribute.ResistEnergyBonus,		1, 50 ); break;
					case 22: ApplyAttribute( secondary, min, max, AosWeaponAttribute.DurabilityBonus,		10, 50, 10 ); break;
		...
		public static void ApplyAttributesTo( BaseArmor armor, bool isRunicTool, int luckChance, int attributeCount, int min, int max )
		{
			...
			for ( int i = 0; i < attributeCount; ++i )
			{
				...
				switch ( random )
				{
					...
					case  1: ApplyAttribute( primary,	min, max, AosAttribute.DefendChance,			1, 50 ); break;
					case  2:
						if (Core.ML) {
							ApplyAttribute( primary,    min, max, AosAttribute.ReflectPhysical,                 1, 25 );
							} else {
							ApplyAttribute( primary,    min, max, AosAttribute.AttackChance,                    1, 50 );
							}
						break;
					...
					case  8: ApplyAttribute( primary,	min, max, AosAttribute.RegenHits,				1, 5 ); break;
					case  9: ApplyAttribute( primary,	min, max, AosAttribute.RegenStam,				1, 5 ); break;
					case 10: ApplyAttribute( primary,	min, max, AosAttribute.RegenMana,				1, 5 ); break;
					case 11: ApplyAttribute( primary,	min, max, AosAttribute.NightSight,				1, 1 ); break;
					case 12: ApplyAttribute( primary,	min, max, AosAttribute.BonusHits,				1, 50 ); break;
					case 13: ApplyAttribute( primary,	min, max, AosAttribute.BonusStam,				1, 50 ); break;
					case 14: ApplyAttribute( primary,	min, max, AosAttribute.BonusMana,				1, 50 ); break;
					...
					case 18: ApplyAttribute( primary,	min, max, AosAttribute.ReflectPhysical,			1, 25 ); break;
					case 19: ApplyResistance( armor,	min, max, ResistanceType.Physical,				1, 50 ); break;
					case 20: ApplyResistance( armor,	min, max, ResistanceType.Fire,					1, 50 ); break;
					case 21: ApplyResistance( armor,	min, max, ResistanceType.Cold,					1, 50 ); break;
					case 22: ApplyResistance( armor,	min, max, ResistanceType.Poison,				1, 50 ); break;
					case 23: ApplyResistance( armor,	min, max, ResistanceType.Energy,				1, 50 ); break;
					/* End Armor */
				}
			}
		}
		...
		public static void ApplyAttributesTo( BaseHat hat, bool isRunicTool, int luckChance, int attributeCount, int min, int max )
		{
			...
			for ( int i = 0; i < attributeCount; ++i )
			{
				...
				switch ( random )
				{
					...
					case  1: ApplyAttribute( primary,	min, max, AosAttribute.RegenHits,				1, 5 ); break;
					case  2: ApplyAttribute( primary,	min, max, AosAttribute.RegenStam,				1, 5 ); break;
					case  3: ApplyAttribute( primary,	min, max, AosAttribute.RegenMana,				1, 5 ); break;
					case  4: ApplyAttribute( primary,	min, max, AosAttribute.NightSight,				1, 1 ); break;
					case  5: ApplyAttribute( primary,	min, max, AosAttribute.BonusHits,				1, 50 ); break;
					case  6: ApplyAttribute( primary,	min, max, AosAttribute.BonusStam,				1, 50 ); break;
					case  7: ApplyAttribute( primary,	min, max, AosAttribute.BonusMana,				1, 50 ); break;
					...
					case 14: ApplyAttribute( resists,	min, max, AosElementAttribute.Physical,			1, 50 ); break;
					case 15: ApplyAttribute( resists,	min, max, AosElementAttribute.Fire,				1, 50 ); break;
					case 16: ApplyAttribute( resists,	min, max, AosElementAttribute.Cold,				1, 50 ); break;
					case 17: ApplyAttribute( resists,	min, max, AosElementAttribute.Poison,			1, 50 ); break;
					case 18: ApplyAttribute( resists,	min, max, AosElementAttribute.Energy,			1, 50 ); break;
				}
			}
		}
		...
		public static void ApplyAttributesTo( BaseJewel jewelry, bool isRunicTool, int luckChance, int attributeCount, int min, int max )
		{
			...
			for ( int i = 0; i < attributeCount; ++i )
			{
				...
				switch ( random )
				{
					case  0: ApplyAttribute( resists,	min, max, AosElementAttribute.Physical,			1, 50 ); break;
					case  1: ApplyAttribute( resists,	min, max, AosElementAttribute.Fire,				1, 50 ); break;
					case  2: ApplyAttribute( resists,	min, max, AosElementAttribute.Cold,				1, 50 ); break;
					case  3: ApplyAttribute( resists,	min, max, AosElementAttribute.Poison,			1, 50 ); break;
					case  4: ApplyAttribute( resists,	min, max, AosElementAttribute.Energy,			1, 50 ); break;
					case  5: ApplyAttribute( primary,	min, max, AosAttribute.WeaponDamage,			1, 50 ); break;
					case  6: ApplyAttribute( primary,	min, max, AosAttribute.DefendChance,			1, 50 ); break;
					case  7: ApplyAttribute( primary,	min, max, AosAttribute.AttackChance,			1, 50 ); break;
					case  8: ApplyAttribute( primary,	min, max, AosAttribute.BonusStr,				1, 10 ); break;
					case  9: ApplyAttribute( primary,	min, max, AosAttribute.BonusDex,				1, 10 ); break;
					case 10: ApplyAttribute( primary,	min, max, AosAttribute.BonusInt,				1, 10 ); break;
					...
					case 17: ApplyAttribute( primary,	min, max, AosAttribute.SpellDamage,				1, 100 ); break;
		...
		public void ApplyAttributesTo( BaseClothing clothing )
		{
			CraftResourceInfo resInfo = CraftResources.GetInfo( m_Resource );
			...
			ApplyAttributesTo( clothing, true, 0, attributeCount, min, max );
		}
		...
		public static void ApplyAttributesTo( BaseClothing clothing, bool isRunicTool, int luckChance, int attributeCount, int min, int max )
		{
			...
			for ( int i = 0; i < attributeCount; ++i )
			{
				...
				switch ( random )
				{
					case  0: ApplySkillBonus( skills,	min, max, 0,					1, 15 ); break;
					case  1: ApplySkillBonus( skills,	min, max, 1,					1, 15 ); break;
					case  2: ApplySkillBonus( skills,	min, max, 2,					1, 15 ); break;
					case  3: ApplySkillBonus( skills,	min, max, 3,					1, 15 ); break;
					case  4: ApplySkillBonus( skills,	min, max, 4,					1, 15 ); break;
					case  5: ApplyAttribute( primary,	min, max, AosAttribute.RegenHits,		1, 5 ); break;
					case  6: ApplyAttribute( primary,	min, max, AosAttribute.RegenStam,		1, 5 ); break;
					case  7: ApplyAttribute( primary,	min, max, AosAttribute.RegenMana,		1, 5 ); break;
					case  8: ApplyAttribute( primary,	min, max, AosAttribute.NightSight,		1, 1 ); break;
					case  9: ApplyAttribute( primary,	min, max, AosAttribute.BonusHits,		1, 50 ); break;
					case 10: ApplyAttribute( primary,	min, max, AosAttribute.BonusStam,		1, 50 ); break;
					case 11: ApplyAttribute( primary,	min, max, AosAttribute.BonusMana,		1, 50 ); break;
					case 12: ApplyAttribute( primary,	min, max, AosAttribute.LowerManaCost,		1, 8 ); break;
					case 13: ApplyAttribute( primary,	min, max, AosAttribute.LowerRegCost,		1, 20 ); break;
					case 14: ApplyAttribute( primary,	min, max, AosAttribute.Luck,			1, 100 ); break;
					case 15: ApplyAttribute( primary,	min, max, AosAttribute.ReflectPhysical,		1, 25 ); break;
					case 16: ApplyAttribute( resists,	min, max, AosElementAttribute.Physical,		1, 50 ); break;
					case 17: ApplyAttribute( resists,	min, max, AosElementAttribute.Fire,		1, 50 ); break;
					case 18: ApplyAttribute( resists,	min, max, AosElementAttribute.Cold,		1, 50 ); break;
					case 19: ApplyAttribute( resists,	min, max, AosElementAttribute.Poison,		1, 50 ); break;
					case 20: ApplyAttribute( resists,	min, max, AosElementAttribute.Energy,		1, 50 ); break;
				}
			}
		}
		...
		public static void ApplyAttributesTo( Spellbook spellbook, bool isRunicTool, int luckChance, int attributeCount, int min, int max )
		{
			...
			for ( int i = 0; i < attributeCount; ++i )
			{
				...
				switch ( random )
				{
					...
					case  4: ApplyAttribute( primary,	min, max, AosAttribute.BonusMana,				1, 100 ); break;
					case  5: ApplyAttribute( primary,	min, max, AosAttribute.CastSpeed,				1, 1 ); break;
					case  6: ApplyAttribute( primary,	min, max, AosAttribute.CastRecovery,			1, 3 ); break;
					case  7: ApplyAttribute( primary,	min, max, AosAttribute.SpellDamage,				1, 100 ); break;
					...
					case 14: ApplyAttribute( primary,	min, max, AosAttribute.RegenMana,				1, 5 ); break;
