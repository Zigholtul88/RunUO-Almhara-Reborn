...
namespace Server.Items
{
	public class GargoylesPickaxe : BaseAxe, IUsesRemaining
	{
		...
		public override int AosSpeed{ get{ return 10; } } // from 35
		...
		[Constructable]
		public GargoylesPickaxe() : this( Utility.RandomMinMax( 105, 125 ))
		{
		}
		...
		public GargoylesPickaxe( int uses ) : base( 0xE85 + Utility.Random( 2 ))
		{
			...
			SkillBonuses.SetValues( 0, SkillName.Mining, 5 );
			Attributes.WeaponDamage = 17;
