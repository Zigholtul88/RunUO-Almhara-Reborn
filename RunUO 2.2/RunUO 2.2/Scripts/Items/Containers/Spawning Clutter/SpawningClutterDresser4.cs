...
{
    public class SpawningClutterDresser4 : LockableContainer
    {
        ...
        [Constructable]
        public SpawningClutterDresser4() : base( 0xA53 )
        {
		Name = "a dresser";
		Movable = true;
		Weight = 1000.0;
...
/////////////////////////////////////// Clothes 1
 		...
 		if ( Utility.RandomDouble() < 0.10 )
			  ...
			  BaseClothing clothing1 = Loot.RandomClothing( true );
                          clothing1.Hue = Utility.RandomNeutralHue();
                          DropItem( clothing1 );
                }
 		if ( Utility.RandomDouble() < 0.10 )
                {
			  BaseClothing clothing2 = Loot.RandomClothing( true );
                          clothing2.Hue = Utility.RandomNeutralHue();
                          DropItem( clothing2 );
                }
 		if ( Utility.RandomDouble() < 0.10 )
                {
			  BaseClothing clothing3 = Loot.RandomClothing( true );
                          clothing3.Hue = Utility.RandomNeutralHue();
                          DropItem( clothing3 );
                }
 		if ( Utility.RandomDouble() < 0.10 )
                {
			  BaseClothing clothing4 = Loot.RandomClothing( true );
                          clothing4.Hue = Utility.RandomNeutralHue();
                          DropItem( clothing4 );
                }
 		if ( Utility.RandomDouble() < 0.10 )
                {
			  BaseClothing clothing5 = Loot.RandomClothing( true );
                          clothing5.Hue = Utility.RandomNeutralHue();
                          DropItem( clothing5 );
                }
 		...
 		if ( Utility.RandomDouble() < 0.01 )
			  ...
			  BaseClothing magiccloth1 = Loot.RandomClothing( true );
		          BaseRunicTool.ApplyAttributesTo( magiccloth1, 3, 1, 5 );
                          magiccloth1.Hue = Utility.RandomBlueHue();
 		...
 		if ( Utility.RandomDouble() < 0.01 )
			  ...
			  BaseClothing magiccloth2 = Loot.RandomClothing( true );
		          BaseRunicTool.ApplyAttributesTo( magiccloth2, 3, 1, 5 );
                          magiccloth2.Hue = Utility.RandomBlueHue();
 		...
 		if ( Utility.RandomDouble() < 0.01 )
			  ...
			  BaseClothing magiccloth3 = Loot.RandomClothing( true );
		          BaseRunicTool.ApplyAttributesTo( magiccloth3, 3, 1, 5 );
                          magiccloth3.Hue = Utility.RandomBlueHue();
                          DropItem( magiccloth3 );
                }
        }

        public SpawningClutterDresser4( Serial serial ) : base( serial )
        {
        }
