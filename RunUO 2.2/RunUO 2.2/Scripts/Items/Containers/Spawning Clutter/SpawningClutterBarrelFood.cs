...
{
    public class SpawningClutterBarrelFood : LockableContainer
    {
        ...
        [Constructable]
        public SpawningClutterBarrelFood() : base( 0xE77 )
        {
		Name = "a barrel";
		Movable = true;
		Weight = 1000.0;
...
/////////////////////////////////////// Misc
        ...
        public SpawningClutterBarrelFood( Serial serial ) : base( serial )
        {
        }
