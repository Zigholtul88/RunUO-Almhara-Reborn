...
{
    public class SpawningClutterDresser3 : LockableContainer
    {
        ...
        [Constructable]
        public SpawningClutterDresser3() : base( 0xA4F )
        {
		Name = "a dresser";
		Movable = true;
		Weight = 1000.0;
...
/////////////////////////////////////// Rare Items
        ...
        public SpawningClutterDresser3( Serial serial ) : base( serial )
        {
        }
