...
{
    public class SpawningClutterDresser6 : LockableContainer
    {
        ...
        [Constructable]
        public SpawningClutterDresser6() : base( 0xA53 )
        {
		Name = "a dresser";
		Movable = true;
		Weight = 1000.0;
...
/////////////////////////////////////// Rare Items
        ...
        public SpawningClutterDresser6( Serial serial ) : base( serial )
        {
        }
