...
namespace Server.Items
{
    ...
    public class RatmenFortressTreasureChest1 : LockableContainer
    {
        ...
        [Constructable]
        public RatmenFortressTreasureChest1() : base( 0xE43 )
        {
...
/////////////////////////////////////// Supplies
 		...
 		if ( Utility.RandomDouble() < 0.10 )
            DropItem( new Arrow( Utility.Random( 9, 13 ) ) );

 		if ( Utility.RandomDouble() < 0.10 )
            DropItem( new Bolt( Utility.Random( 9, 13) ) );

            Item ReagentLoot = Loot.RandomReagent();
            ReagentLoot.Amount = Utility.Random( 9, 13 );
            DropItem( ReagentLoot );

 		if ( Utility.RandomDouble() < 0.10 )
            DropItem( new Bandage( Utility.Random( 9, 13 ) ) );

 		if ( Utility.RandomDouble() < 0.10 )
		DropItem( new Bedroll() );	

 		if ( Utility.RandomDouble() < 0.10 )
            DropItem( new Bottle( Utility.Random( 9, 13 ) ) );	

 		if ( Utility.RandomDouble() < 0.10 )
            DropItem( new Lockpick( Utility.Random( 9, 13 ) ) );
...
/////////////////////////////////////// Rare Items
		...
		DropItem( new DyeTub() );
 		...
 		if ( Utility.RandomDouble() < 0.10 )
			...
			switch ( Utility.Random( 38 ) )
			{
				...
				default: weapon = new Dagger(); break;
			        ...
			        BaseRunicTool.ApplyAttributesTo( weapon, 4, 12, 15 );
 		...
 		if ( Utility.RandomDouble() < 0.10 )
			...
			switch ( Utility.Random( 13 ) )
			{
				...
				default: armor = new StuddedChest(); break;
			        ...
			        BaseRunicTool.ApplyAttributesTo( armor, 4, 12, 15 );
 		...
 		if ( Utility.RandomDouble() < 0.10 )
			...
			switch ( Utility.Random( 5 ) )
			{
				...
				BaseRunicTool.ApplyAttributesTo( hat, 4, 12, 15 );
 		...
 		if ( Utility.RandomDouble() < 0.10 )
            {
			  BaseClothing clothing = Loot.RandomClothing( true );
		          BaseRunicTool.ApplyAttributesTo( clothing, 4, 12, 15 );              
 		...
 		if ( Utility.RandomDouble() < 0.10 )
            {
			  ...
			  if ( Core.AOS )
		          BaseRunicTool.ApplyAttributesTo( shield, 4, 12, 15 );              
 		...
 		if ( Utility.RandomDouble() < 0.10 )
            {
			  ...
			  if ( Core.AOS )
		          BaseRunicTool.ApplyAttributesTo( bracelet, 4, 12, 15 );              
 		...
 		if ( Utility.RandomDouble() < 0.10 )
            {
			  ...
			  if ( Core.AOS )
		          BaseRunicTool.ApplyAttributesTo( earrings, 4, 12, 15 );              
 		...
 		if ( Utility.RandomDouble() < 0.10 )
            {
			  ...
			  if ( Core.AOS )
		          BaseRunicTool.ApplyAttributesTo( necklace, 4, 12, 15 );              
 		...
 		if ( Utility.RandomDouble() < 0.10 )
            {
			  ...
			  if ( Core.AOS )
		          BaseRunicTool.ApplyAttributesTo( ring, 4, 12, 15 );              
        ...
        public RatmenFortressTreasureChest1( Serial serial ) : base( serial )
        {
        }
