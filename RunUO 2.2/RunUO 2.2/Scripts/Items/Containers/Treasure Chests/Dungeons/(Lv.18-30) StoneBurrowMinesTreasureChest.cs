...
namespace Server.Items
{
	...
	public class StoneBurrowMinesTreasureChest1 : LockableContainer
	{
                ...
                [Constructable]
                public StoneBurrowMinesTreasureChest1() : base( 0xE43 )
                {
...
/////////////////////////////////////// Supplies
			...
			switch ( Utility.Random( 5 ) )
			{
 		      ...
 		      if ( Utility.RandomDouble() < 0.15 )
                         DropItem( new BlackGear( Utility.Random( 5, 10 ) ) );

 		      if ( Utility.RandomDouble() < 0.15 )
                         DropItem( new BronzeGear( Utility.Random( 5, 10 ) ) );

 		      if ( Utility.RandomDouble() < 0.15 )
                         DropItem( new CrimsonGear( Utility.Random( 5, 10 ) ) );
...
/////////////////////////////////////// LV 18-27
                ...
                public StoneBurrowMinesTreasureChest1( Serial serial ) : base( serial )
                {
                }
        ...
        [Flipable( 0xE43, 0xE42 )]
	public class StoneBurrowMinesTreasureChest2 : LockableContainer
	{
                public override bool Decays{ get{ return true; } } 
                ...
                [Constructable]
                public StoneBurrowMinesTreasureChest2() : base( 0xE43 )
                {
...
/////////////////////////////////////// LV 18-27
                ...
                public StoneBurrowMinesTreasureChest2( Serial serial ) : base( serial )
                {
                }
