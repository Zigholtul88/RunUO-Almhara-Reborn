...
namespace Server.Items
{
	...
	public class OboruJungleTreasureChest1 : LockableContainer
	{
                ...
                [Constructable]
                public OboruJungleTreasureChest1() : base( 0xE43 )
                {
...
/////////////////////////////////////// Supplies
			...
			switch ( Utility.Random( 19 ) )
			{
				...
				case 18: DropItem( new Wool(30) ); break;
                      ...
                      ReagentLoot.Amount = Utility.RandomMinMax( 1, 20 );
...
/////////////////////////////////////// Rare Items
 		      ...
 		      if ( Utility.RandomDouble() < 0.01 )
                ...
                public OboruJungleTreasureChest1( Serial serial ) : base( serial )
                {
                }
