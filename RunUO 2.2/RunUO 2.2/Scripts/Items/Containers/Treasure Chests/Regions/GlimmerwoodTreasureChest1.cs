...
namespace Server.Items
{
	...
	public class GlimmerwoodTreasureChest1 : LockableContainer
	{
                ...
                [Constructable]
                public GlimmerwoodTreasureChest1() : base( 0xE43 )
                {
...
/////////////////////////////////////// Supplies
			...
			switch ( Utility.Random( 19 ) )
			{
				...
				case 18: DropItem( new Wool(35) ); break;
                      ...
                      ReagentLoot.Amount = Utility.RandomMinMax( 1, 25 );
...
/////////////////////////////////////// Rare Items
 		      ...
 		      if ( Utility.RandomDouble() < 0.01 )
                ...
                public GlimmerwoodTreasureChest1( Serial serial ) : base( serial )
                {
                }
