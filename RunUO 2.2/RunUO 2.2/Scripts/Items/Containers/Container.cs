...
namespace Server.Items
{
	...
	public class GargishChest : LockableContainer
	{
		...
		[Constructable]
		public GargishChest() : base( 0x4026 )
		{
                        Weight = 1.0;
		}

		public GargishChest( Serial serial ) : base( serial )
		{
		}
	...
	public class AcademicBookCase : BaseContainer
	{
		...
		[Constructable]
		public AcademicBookCase() : base( 0xA99 )
		{
                        Weight = 11.0;
		}

		public AcademicBookCase( Serial serial ) : base( serial )
		{
		}
