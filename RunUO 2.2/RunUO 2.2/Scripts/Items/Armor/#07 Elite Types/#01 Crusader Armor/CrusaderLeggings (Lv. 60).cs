...
namespace Server.Items
{
	...
	public class CrusaderLeggings : BaseArmor, IDyable
	{
		...
		[Constructable]
		public CrusaderLeggings() : base( 0x2B07 )
		{
                        Name = "Crusader Leggings - (Lv. 60)";
			Weight = 7.0;
		...
		public CrusaderLeggings( Serial serial ) : base( serial )
		{
		}
