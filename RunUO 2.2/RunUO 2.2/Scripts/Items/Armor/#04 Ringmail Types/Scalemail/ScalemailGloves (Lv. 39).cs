...
{
	public class ScalemailGloves : BaseArmor, IDyable
	{
		...
		[Constructable]
		public ScalemailGloves() : base( 15313 )
		{
                        Name = "Scalemail Gloves - (Lv. 39)";
			Weight = 2.0;
			Layer = Layer.Gloves;
		...
		public ScalemailGloves( Serial serial ) : base( serial )
		{
		}
