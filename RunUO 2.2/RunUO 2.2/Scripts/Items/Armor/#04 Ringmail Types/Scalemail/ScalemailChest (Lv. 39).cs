...
{
	[FlipableAttribute( 15311, 15312 )]
	public class ScalemailChest : BaseArmor, IDyable
	{
		...
		[Constructable]
		public ScalemailChest() : base( 15311 )
		{
                        Name = "Scalemail Chest - (Lv. 39)";
			Weight = 15.0;
		...
		public ScalemailChest( Serial serial ) : base( serial )
		{
		}
