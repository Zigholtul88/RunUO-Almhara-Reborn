...
{
	public class CrackedDefendChanceGem : BaseDefendChanceSocketGem
	{
		private int m_RequiredLevel = 1;
		private int m_DefendChance = 5;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public override int DefendChance
		{ 
			get{ return m_DefendChance; }
			set {m_DefendChance = value; InvalidateProperties();}
		}

		[Constructable]
		public CrackedDefendChanceGem() : base( 0x3198 )
		{
			Name = "Cracked Defend Chance Gem";
			Weight = 1.0;
			Hue = 1023;
		}

		public CrackedDefendChanceGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Cracked Defend Chance Gem";
		...
		{
			private CrackedDefendChanceGem m_deed;

			public InternalTarget( CrackedDefendChanceGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
