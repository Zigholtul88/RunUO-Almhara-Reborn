...
{
	public class CrackedAttackChanceGem : BaseAtkChanceSocketGem
	{
		private int m_RequiredLevel = 1;
		private int m_AttackChance = 5;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public override int AttackChance
		{ 
			get{ return m_AttackChance; }
			set {m_AttackChance = value; InvalidateProperties();}
		}

		[Constructable]
		public CrackedAttackChanceGem() : base( 0x3198 )
		{
			Name = "Cracked Attack Chance Gem";
			Weight = 1.0;
			Hue = 1023;
		}

		public CrackedAttackChanceGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Cracked Attack Chance Gem";
		...
		{
			private CrackedAttackChanceGem m_deed;

			public InternalTarget( CrackedAttackChanceGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
