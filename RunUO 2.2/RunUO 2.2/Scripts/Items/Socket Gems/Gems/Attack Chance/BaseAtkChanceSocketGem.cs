...
{
	public abstract class BaseAtkChanceSocketGem : Item
	{
		[Constructable]
		public BaseAtkChanceSocketGem(int itemID) : base(itemID)
		{
		}

		public BaseAtkChanceSocketGem( Serial serial ) : base( serial )
		{
		}
