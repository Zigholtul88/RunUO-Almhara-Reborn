...
{
	public class CrackedHitLeechManaGem : BaseHitLeechManaSocketGem
	{
		private int m_RequiredLevel = 1;
		private int m_HitLeechMana = 5;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public override int HitLeechMana
		{ 
			get{ return m_HitLeechMana; }
			set {m_HitLeechMana = value; InvalidateProperties();}
		}

		[Constructable]
		public CrackedHitLeechManaGem() : base( 0x3198 )
		{
			Name = "Cracked Hit Leech Mana Gem";
			Weight = 1.0;
			Hue = 291;
		}

		public CrackedHitLeechManaGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Cracked Hit Leech Mana Gem";
		...
		{
			private CrackedHitLeechManaGem m_deed;

			public InternalTarget( CrackedHitLeechManaGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				if ( targeted is BaseWeapon )
				{
					...
					if ( w !=null )
					{
						...
						{
							w.WeaponAttributes.HitLeechMana=0;
