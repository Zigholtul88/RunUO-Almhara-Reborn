...
{
	public class CrackedHitFireballGem : BaseHitFireballSocketGem
	{
		private int m_RequiredLevel = 1;
		private int m_HitFireball = 5;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public override int HitFireball
		{ 
			get{ return m_HitFireball; }
			set {m_HitFireball = value; InvalidateProperties();}
		}

		[Constructable]
		public CrackedHitFireballGem() : base( 0x3198 )
		{
			Name = "Cracked Hit Fireball Gem";
			Weight = 1.0;
			Hue = 138;
		}

		public CrackedHitFireballGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Cracked Hit Fireball Gem";
		...
		{
			private CrackedHitFireballGem m_deed;

			public InternalTarget( CrackedHitFireballGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				if ( targeted is BaseWeapon )
				{
					...
					if ( w !=null )
					{
						...
						{
							w.WeaponAttributes.HitFireball=5;
