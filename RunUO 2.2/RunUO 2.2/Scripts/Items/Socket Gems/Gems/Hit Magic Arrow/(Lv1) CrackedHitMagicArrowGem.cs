...
{
	public class CrackedHitMagicArrowGem : BaseHitMagicArrowSocketGem
	{
		private int m_RequiredLevel = 1;
		private int m_HitMagicArrow = 5;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public override int HitMagicArrow
		{ 
			get{ return m_HitMagicArrow; }
			set {m_HitMagicArrow = value; InvalidateProperties();}
		}

		[Constructable]
		public CrackedHitMagicArrowGem() : base( 0x3198 )
		{
			Name = "Cracked Hit Magic Arrow Gem";
			Weight = 1.0;
			Hue = 151;
		}

		public CrackedHitMagicArrowGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Cracked Hit Magic Arrow Gem";
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			m_HitMagicArrow = reader.ReadInt();
		}
		...
		{
			private CrackedHitMagicArrowGem m_deed;

			public InternalTarget( CrackedHitMagicArrowGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
