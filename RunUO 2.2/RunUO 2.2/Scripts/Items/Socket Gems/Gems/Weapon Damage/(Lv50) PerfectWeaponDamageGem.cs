...
{
	public class PerfectWeaponDamageGem : BaseWpnDmgSocketGem
	{
		private int m_RequiredLevel = 50;
		private int m_WeaponDamage = 100;
		...
		[Constructable]
		public PerfectWeaponDamageGem() : base( 0x3198 )
		{
		...
		public PerfectWeaponDamageGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Perfect Weapon Damage Gem";
		...
		{
			private PerfectWeaponDamageGem m_deed;

			public InternalTarget( PerfectWeaponDamageGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
