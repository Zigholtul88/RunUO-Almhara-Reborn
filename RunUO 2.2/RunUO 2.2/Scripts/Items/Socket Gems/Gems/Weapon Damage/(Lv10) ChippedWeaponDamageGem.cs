...
{
	public class ChippedWeaponDamageGem : BaseWpnDmgSocketGem
	{
		private int m_RequiredLevel = 10;
		private int m_WeaponDamage = 15;
		...
		[Constructable]
		public ChippedWeaponDamageGem() : base( 0x3198 )
		{
			Name = "Chipped Weapon Damage Gem";
			Weight = 1.0;
			Hue = 971;
		}

		public ChippedWeaponDamageGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Chipped Weapon Damage Gem";
		...
		{
			private ChippedWeaponDamageGem m_deed;

			public InternalTarget( ChippedWeaponDamageGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
