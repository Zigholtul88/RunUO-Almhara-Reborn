...
{
	public class FlawlessWeaponDamageGem : BaseWpnDmgSocketGem
	{
		private int m_RequiredLevel = 40;
		private int m_WeaponDamage = 50;
		...
		[Constructable]
		public FlawlessWeaponDamageGem() : base( 0x3198 )
		{
			Name = "Flawless Weapon Damage Gem";
			Weight = 1.0;
			Hue = 971;
		}

		public FlawlessWeaponDamageGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Flawless Weapon Damage Gem";
		...
		{
			private FlawlessWeaponDamageGem m_deed;

			public InternalTarget( FlawlessWeaponDamageGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
