...
{
	public class RegularWeaponDamageGem : BaseWpnDmgSocketGem
	{
		private int m_RequiredLevel = 30;
		private int m_WeaponDamage = 35;
		...
		[Constructable]
		public RegularWeaponDamageGem() : base( 0x3198 )
		{
			Name = "Regular Weapon Damage Gem";
			Weight = 1.0;
			Hue = 971;
		}

		public RegularWeaponDamageGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Regular Weapon Damage Gem";
		...
		{
			private RegularWeaponDamageGem m_deed;

			public InternalTarget( RegularWeaponDamageGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
