...
{
	public class FlawedWeaponDamageGem : BaseWpnDmgSocketGem
	{
		private int m_RequiredLevel = 20;
		private int m_WeaponDamage = 25;
		...
		[Constructable]
		public FlawedWeaponDamageGem() : base( 0x3198 )
		{
			Name = "Flawed Weapon Damage Gem";
			Weight = 1.0;
			Hue = 971;
		}

		public FlawedWeaponDamageGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Flawed Weapon Damage Gem";
		...
		{
			private FlawedWeaponDamageGem m_deed;

			public InternalTarget( FlawedWeaponDamageGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
