...
{
	public class CrackedWeaponSpeedGem : BaseWpnSpeedSocketGem
	{
		private int m_RequiredLevel = 1;
		private int m_WeaponSpeed = 5;
		...
		{ 
			...
			set {m_WeaponSpeed = value; InvalidateProperties();}
		}

		[Constructable]
		public CrackedWeaponSpeedGem() : base( 0x3198 )
		{
			Name = "Cracked Weapon Speed Gem";
			Weight = 1.0;
			Hue = 1009;
		}

		public CrackedWeaponSpeedGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Cracked Weapon Speed Gem";
		...
		{
			private CrackedWeaponSpeedGem m_deed;

			public InternalTarget( CrackedWeaponSpeedGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
