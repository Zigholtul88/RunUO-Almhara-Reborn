...
{
	public class CrackedHitHarmGem : BaseHitHarmSocketGem
	{
		private int m_RequiredLevel = 1;
		private int m_HitHarm = 5;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public override int HitHarm
		{ 
			get{ return m_HitHarm; }
			set {m_HitHarm = value; InvalidateProperties();}
		}

		[Constructable]
		public CrackedHitHarmGem() : base( 0x3198 )
		{
			Name = "Cracked Hit Harm Gem";
			Weight = 1.0;
			Hue = 1266;
		}

		public CrackedHitHarmGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Cracked Hit Harm Gem";
		...
		{
			private CrackedHitHarmGem m_deed;

			public InternalTarget( CrackedHitHarmGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
