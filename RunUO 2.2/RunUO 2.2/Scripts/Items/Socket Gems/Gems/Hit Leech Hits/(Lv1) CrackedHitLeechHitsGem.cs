...
{
	public class CrackedHitLeechHitsGem : BaseHitLeechHitsSocketGem
	{
		private int m_RequiredLevel = 1;
		private int m_HitLeechHits = 5;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public override int HitLeechHits
		{ 
			get{ return m_HitLeechHits; }
			set {m_HitLeechHits = value; InvalidateProperties();}
		}

		[Constructable]
		public CrackedHitLeechHitsGem() : base( 0x3198 )
		{
			Name = "Cracked Hit Leech Hits Gem";
			Weight = 1.0;
			Hue = 35;
		}

		public CrackedHitLeechHitsGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Cracked Hit Leech Hits Gem";
		...
		{
			private CrackedHitLeechHitsGem m_deed;

			public InternalTarget( CrackedHitLeechHitsGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				if ( targeted is BaseWeapon )
				{
					...
					if ( w !=null )
					{
						...
						{
							w.WeaponAttributes.HitLeechHits=0;
