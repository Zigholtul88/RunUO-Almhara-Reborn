...
{
	public class CrackedIntBonusGem : BaseIntBonusSocketGem
	{
		private int m_RequiredLevel = 1;
		private int m_IntBonusJewelry = 5;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public override int IntBonusJewelry
		{ 
			get{ return m_IntBonusJewelry; }
			set {m_IntBonusJewelry = value; InvalidateProperties();}
		}

		[Constructable]
		public CrackedIntBonusGem() : base( 0x3198 )
		{
			Name = "Cracked Int Bonus Gem";
			Weight = 1.0;
			Hue = 1927;
		}

		public CrackedIntBonusGem( Serial serial ) : base( serial )
		{
		}

		private string m_name ="Cracked Int Bonus Gem";
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.Write( m_IntBonusJewelry );
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			m_IntBonusJewelry = reader.ReadInt();
		}
		...
		{
			private CrackedIntBonusGem m_deed;

			public InternalTarget( CrackedIntBonusGem deed ) : base( 3, false, TargetFlags.None )
			{
				m_deed = deed;
			}
