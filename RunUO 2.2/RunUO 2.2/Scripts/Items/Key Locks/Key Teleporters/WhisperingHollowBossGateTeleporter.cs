...
{
	public class WhisperingHollowBossGateTeleporter : Teleporter
	{
		public override int LabelNumber{ get{ return 1049382; } } // a magical teleporter

		[Constructable]
		public WhisperingHollowBossGateTeleporter()
		{
		}
 
		public override bool OnMoveOver( Mobile m )
		{
                        Item item = m.Backpack.FindItemByType(typeof( WhisperingHollowBossKey ) );
	                if ( item != null )
	                {
	                if ( item != this )
	                {
		...
		public WhisperingHollowBossGateTeleporter( Serial serial ) : base( serial )
		{
		}
