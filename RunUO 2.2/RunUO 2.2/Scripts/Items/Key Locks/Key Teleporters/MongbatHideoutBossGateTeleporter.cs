...
{
	public class MongbatHideoutBossGateTeleporter : Teleporter
	{
		public override int LabelNumber{ get{ return 1049382; } } // a magical teleporter

		[Constructable]
		public MongbatHideoutBossGateTeleporter()
		{
		}
		...
		public MongbatHideoutBossGateTeleporter( Serial serial ) : base( serial )
		{
		}
