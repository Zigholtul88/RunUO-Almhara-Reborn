...
{
	public class MurkmereDwellingBossGateTeleporter : Teleporter
	{
		public override int LabelNumber{ get{ return 1049382; } } // a magical teleporter

		[Constructable]
		public MurkmereDwellingBossGateTeleporter()
		{
		}
 
		public override bool OnMoveOver( Mobile m )
		{
                        Item item = m.Backpack.FindItemByType(typeof( MurkmereDwellingBossKey ) );
	                if ( item != null )
	                {
	                if ( item != this )
	                {
		...
		public MurkmereDwellingBossGateTeleporter( Serial serial ) : base( serial )
		{
		}
