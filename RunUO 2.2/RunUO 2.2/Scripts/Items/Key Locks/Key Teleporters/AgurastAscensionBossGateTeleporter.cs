...
{
	public class AgurastAscensionBossGateTeleporter : Teleporter
	{
		public override int LabelNumber{ get{ return 1049382; } } // a magical teleporter

		[Constructable]
		public AgurastAscensionBossGateTeleporter()
		{
		}
 
		public override bool OnMoveOver( Mobile m )
		{
                        Item item = m.Backpack.FindItemByType(typeof( AgurastAscensionBossKey ) );
	                if ( item != null )
	                {
	                if ( item != this )
	                {
		...
		public AgurastAscensionBossGateTeleporter( Serial serial ) : base( serial )
		{
		}
