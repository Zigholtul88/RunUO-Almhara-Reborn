...
{
	public class FortCalcifinaMetalDoor : MetalDoor, ILockpickable
	{
		...
		[Constructable]
		public FortCalcifinaMetalDoor( DoorFacing facing ) : base( facing )
		{
			m_LockLevel = 50;
			m_MaxLockLevel = 55; 
			m_RequiredSkill = 50;
		...
		public override void Use( Mobile from )
		{
			...
			{
				Locked = true;
				from.SendMessage( "The door requires either the key of Fort Calcifina or a skill of 50 in order to unlock." );
				return;
			}
		...
		public FortCalcifinaMetalDoor( Serial serial ) : base( serial )
		{
