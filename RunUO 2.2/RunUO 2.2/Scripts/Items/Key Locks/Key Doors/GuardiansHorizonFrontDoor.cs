...
{
	public class GuardiansHorizonFrontDoor : StrongWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public GuardiansHorizonFrontDoor( DoorFacing facing ) : base( facing )
		{
			m_LockLevel = 100;
			m_MaxLockLevel = 100; 
			m_RequiredSkill = 100;
		...
		public override void Use( Mobile from )
		{
			...
			{
				Locked = true;
				from.SendMessage( "The door requires either the key of Guardian's Horizon or a skill of 100 in order to unlock." );
				return;
			}
		...
		public GuardiansHorizonFrontDoor( Serial serial ) : base( serial )
		{
