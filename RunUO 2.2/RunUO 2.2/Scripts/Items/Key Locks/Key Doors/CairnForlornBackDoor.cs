...
{
	public class CairnForlornBackDoor : MetalDoor, ILockpickable
	{
		...
		[Constructable]
		public CairnForlornBackDoor( DoorFacing facing ) : base( facing )
		{
			m_LockLevel = 100;
			m_MaxLockLevel = 100; 
			m_RequiredSkill = 100;
		...
		public override void Use( Mobile from )
		{
			...
			{
				Locked = true;
				from.SendMessage( "The door requires either the key of cairn forlorn or a skill of 100 in order to unlock." );
				return;
			}
		...
		public CairnForlornBackDoor( Serial serial ) : base( serial )
		{
