...
humanoid.Super = new SlayerEntry( SlayerName.Repond, 
                            ...
                            */ typeof( OrcishLord ), 
                               ...
                               typeof( Anubisath ),
                               typeof( AutumnwoodMinotaur ),
                               typeof( Behemoth ),
                               typeof( CavernMongbatArcher ),
                               typeof( CavernMongbatBerserker ),
                               typeof( CavernMongbatElder ),
                               typeof( CavernMongbatPlantkeeper ),
                               typeof( CavernMongbatRavager ),
                               typeof( CavernMongbatScout ),
                               typeof( CavernMongbatShaman ),
                               typeof( ChiikkahaTheToothed ),
                               typeof( GoblinAdept ),
                               typeof( GoblinFighter ),
                               typeof( GoblinPillager ),
                               typeof( Owlbear ),
                               typeof( RatmanFighter ),
                               typeof( RatmanRogue ),
                               typeof( Sickler ),
                               typeof( StoneBurrowOrcMiner ),
                               typeof( TantanookRatmanElder ),
                               typeof( Taurion ) );
...
abyss.FoundOn = new Type[]{ typeof( BloodElemental ) };
			...
			arachnid.Super = new SlayerEntry( SlayerName.ArachnidDoom, 
                                              typeof( BlackAntZaythalorForest ),
                                              typeof( CavernScorpion ),
                                              typeof( DreadSpider ), 
                                              typeof( FaerieBeetle ),
                                              ...
                                              typeof( Mephitis ), 
                                              typeof( Miasma ),
                                              typeof( OboruBloatedSpider ),
                                              typeof( OboruJumpingSpider ),
                                              typeof( OborunianDrowSpiderTrainer ),
                                              typeof( PitBloatedWidow ),
                                              typeof( Scorpion ), 
                                              typeof( StarLakeCrab ),
			...
			arachnid.Entries = new SlayerEntry[]
				{
					new SlayerEntry( SlayerName.ScorpionsBane, typeof( Scorpion ), typeof( CavernScorpion ) ),
					new SlayerEntry( SlayerName.SpidersDeath, typeof( DreadSpider ), typeof( FrostSpider ), typeof( GiantBlackWidow ), typeof( GiantSpider ), typeof( Mephitis ), typeof( OboruBloatedSpider ), typeof( OboruJumpingSpider ), typeof( OborunianDrowSpiderTrainer ) ),
			...
			reptilian.FoundOn = new Type[]{ typeof( DreadSpider ), typeof( GiantBlackWidow ), typeof( LadyLissith ), typeof( LadySabrix ), typeof( PitBloatedWidow ), typeof( TerathanAvenger ), typeof( TerathanMatriarch ) };
			reptilian.Super = new SlayerEntry( SlayerName.ReptilianDeath, 
                                              ...
                                              typeof( CavernDrake ),
                                              typeof( JadeSerpent ),
                                              typeof( LizardmanGuardian ),
                                              typeof( LizardmanRanger ),
                                              typeof( LizardmanWizard ),
                                              typeof( RazorbackRaptor ),
                                              typeof( WaterLizard ),
                                              typeof( WaterLizardScout ),
                                              typeof( WyvernYoungling )
                        );

			reptilian.Entries = new SlayerEntry[]
				{
new SlayerEntry( SlayerName.DragonSlaying, typeof( AncientWyrm ), typeof( GreaterDragon ), typeof( Dragon ), typeof( Drake ), typeof( Hiryu ), typeof( LesserHiryu ), typeof( Reptalon ), typeof( SerpentineDragon ), typeof( ShadowWyrm ), typeof( SkeletalDragon ), typeof( SwampDragon ), typeof( WhiteWyrm ), typeof( Wyvern ), typeof( CavernDrake ) ),
new SlayerEntry( SlayerName.LizardmanSlaughter, typeof( Lizardman ), typeof( LizardmanGuardian ), typeof( LizardmanRanger ), typeof( LizardmanWizard ) ), 
new SlayerEntry( SlayerName.Ophidian, typeof( OphidianApprenticeMage ), typeof( OphidianAvenger ), typeof( OphidianEnforcer ), typeof( OphidianJusticar ), typeof( OphidianKnightErrant ), typeof( OphidianMatriarch ), typeof( OphidianShaman ), typeof( OphidianWarrior ), typeof( OphidianZealot ) ),
new SlayerEntry( SlayerName.SnakesBane, typeof( DeepSeaSerpent ), typeof( GiantIceWorm ), typeof( GiantSerpent ), typeof( IceSerpent ), typeof( IceSnake ), typeof( LavaSerpent ), typeof( LavaSnake ), typeof( SeaSerpent ), typeof( Serado ), typeof( SilverSerpent ), typeof( Snake ), typeof( Yamandon ), typeof( JadeSerpent ) )
				};
