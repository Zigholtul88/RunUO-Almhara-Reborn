...
{
	[FlipableAttribute( 15389, 15390 )]
	public class EnergyStaff : BaseStaff
	{
		...
		[Constructable]
		public EnergyStaff() : base( 15389 )
		{
                        Name = "Energy Staff - (Lv. 25)";
			Weight = 3.0;
		...
		public EnergyStaff( Serial serial ) : base( serial )
		{
		}
