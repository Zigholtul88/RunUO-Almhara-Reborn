...
{
	public abstract class BaseLovePotion : BasePotion
	{
		...
		public BaseLovePotion( PotionEffect effect ) : base( 0xF0D, effect )
		{
		}

		public BaseLovePotion( Serial serial ) : base( serial )
		{
		}
		...
		{
			private BaseLovePotion m_Potion;

			public BaseLovePotion Potion
			{
				get{ return m_Potion; }
			}

			public ThrowTarget( BaseLovePotion potion ) : base( 12, true, TargetFlags.None )
			{
				m_Potion = potion;
			}
		...
		public void Explode( Mobile from, bool direct, Point3D loc, Map map )
		{
			...
			Effects.SendLocationEffect(loc, map, 0x376A, 9, 10, 23, 0);
			Effects.SendLocationEffect(loc, map, 0x376A, 1, 10, 23, 1);
			int alchemyBonus = 0;
			...
			{
				if ( o is Mobile && (from == null || (SpellHelper.ValidIndirectTarget( from, (Mobile)o ) && from.CanBeBeneficial( (Mobile)o, false ))))
				{
					toExplode.Add( o );
					++toDamage;
				}
				else if ( o is BaseLovePotion && o != this )
				{
					toExplode.Add( o );
				}
			}
			...
			for ( int i = 0; i < toExplode.Count; ++i )
			{
				...
				else if ( o is BaseLovePotion )
				{
					BaseLovePotion pot = (BaseLovePotion)o;
