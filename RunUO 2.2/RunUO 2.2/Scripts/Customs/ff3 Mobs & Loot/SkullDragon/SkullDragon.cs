...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of Skull Dragon" )]
              public class SkullDragon : Dragon
              {
                                 [Constructable]
                                    public SkullDragon() : base()
                            {
                                               Name = "Skull Dragon";
                                               Hue = 298;
                                               ...
                                               Karma = - 25000;
                                               VirtualArmor = 70;
					       PackGold( 45120, 55130 );
     
                                                 switch ( Utility.Random( 30 ))
			         {
				
				case 0: PackItem( new GestahlObi() ); break;
				case 1: PackItem( new GestahlRobe() ); break;
                        	case 2: PackItem( new GestahlCloak() ); break;
                        	case 3: PackItem( new GestahlHelm() ); break;
