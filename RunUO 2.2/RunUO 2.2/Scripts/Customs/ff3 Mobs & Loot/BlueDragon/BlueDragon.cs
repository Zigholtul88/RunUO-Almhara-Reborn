...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of Blue Dragon" )]
              public class BlueDragon : Dragon
              {
                                 [Constructable]
                                    public BlueDragon() : base()
                            {
                                               Name = "Blue Dragon";
                                               Hue = 8;
                                               Body = 62; // Uncomment these lines and input values
				...
				case 0: PackItem( new RelmBrush() ); break;
				case 1: PackItem( new RelmShoes() ); break;
                        	case 2: PackItem( new RelmShirt() ); break;
                        	case 3: PackItem( new RelmHelm() ); break;
                        	case 4: PackItem( new RelmCloak() ); break;
                        	case 5: PackItem( new RelmPants() ); break; 
