...
namespace Server
{
    public class SkilllimPickGump : Gump
    {
        ...
        private double val = 40;

        public SkilllimPickGump(SkillBall3 ball) : base(0, 0)
        {
            this.Closable = true;
            ...
            this.AddLabel(67, 41, 1153, @"Please select your 2 skills");
                ...
                case 1:
                    {
                        ...
                        {
                            m.SendGump(new SkilllimPickGump(m_SkillBall));
                            m.SendMessage(0, "Please get rid of {0} skills, you have exceeded the 2 skills that are allowed.", info.Switches.Length - switches);
                            break;
    ...
    public class SkillBall3 : Item
    {
        ...
        public override void OnDoubleClick(Mobile m)
        {
            ...
            {
                m.SendMessage("Please choose  your 2 skills to set to 40.");
