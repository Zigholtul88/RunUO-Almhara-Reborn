...
{
        public class OphidianMatriarchCloak : Cloak
        {
                ...
                [Constructable]
                public OphidianMatriarchCloak()
                {
			Name = "Ophidian Matriarch Cloak";
                        LootType = LootType.Blessed;
                }

                public OphidianMatriarchCloak( Serial serial ) : base( serial )
                {
                }
