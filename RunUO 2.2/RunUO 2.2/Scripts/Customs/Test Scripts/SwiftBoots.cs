...
namespace Server.Items
{
	...
	{
		public SwiftBoots( Serial serial ): base(serial)
		{
		}
		...
		// Be sure to edit warning message: "You need to wait 30 minutes until the magic recharges."
		private static readonly TimeSpan UsageInterval = new TimeSpan(0, 0, 30, 0);
		// Effect lasts for 10 minutes by default
		private static readonly TimeSpan EffectDuration = new TimeSpan(0, 0, 10, 0);
		// Hue of the boots
		private const int BootsHue = 1266;
		...
		public override bool OnEquip( Mobile from )
		{
			...
			{
				from.SendMessage(38, "You need to wait 30 minutes until the magic recharges.");
			}
		...
		private class DurationTimer : Timer
		{
			...
			public DurationTimer( Mobile from, SwiftBoots swiftBoots ): base(EffectDuration)
			{
