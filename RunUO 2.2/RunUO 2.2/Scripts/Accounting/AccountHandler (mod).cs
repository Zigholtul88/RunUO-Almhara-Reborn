...
namespace Server.Misc
{
	...
	public class AccountHandler
	{
		...
		private static CityInfo[] StartingCities = new CityInfo[]
			{
				new CityInfo( "New Haven",	"New Haven Bank",	1150168, 2519, 1972, 0, Map.Malas  ),
				new CityInfo( "Yew",		"The Empath Abbey",	1075072, 2519, 1972, 0, Map.Malas  ),
				new CityInfo( "Minoc",		"The Barnacle",		1075073, 2519, 1972, 0, Map.Malas ),
				new CityInfo( "Britain",	"The Wayfarer's Inn",	1075074, 2519, 1972, 0, Map.Malas ),
				new CityInfo( "Moonglow",	"The Scholars Inn",	1075075, 2519, 1972, 0, Map.Malas  ),
				new CityInfo( "Trinsic",	"The Traveler's Inn",	1075076, 2519, 1972, 0, Map.Malas  ),
				new CityInfo( "Jhelom",		"The Mercenary Inn",	1075078, 2519, 1972, 0, Map.Malas  ),
				new CityInfo( "Skara Brae",	"The Falconer's Inn",	1075079, 2519, 1972, 0, Map.Malas  ),
				new CityInfo( "Vesper",		"The Ironwood Inn",	1075080, 2519, 1972, 0, Map.Malas  )
			};

		/* Old Haven/Magincia Locations
			new CityInfo( "Britain", "Sweet Dreams Inn", 2519, 1972, 0, Map.Malas );
			// ..
			// Trinsic
			new CityInfo( "Magincia", "The Great Horns Tavern", 2519, 1972, 0, Map.Malas ),
			// Jhelom
			// ..
			new CityInfo( "Haven", "Buckler's Hideaway", 2519, 1972, 0, Map.Malas )

			if ( Core.AOS )
			{
				//CityInfo haven = new CityInfo( "Haven", "Uzeraan's Mansion", 2519, 1972, 0 );
				CityInfo haven = new CityInfo( "Haven", "Uzeraan's Mansion", 2519, 1972, 0 );
