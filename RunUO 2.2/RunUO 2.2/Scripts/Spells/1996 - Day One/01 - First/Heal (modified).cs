	...
	public class HealSpell : MagerySpell
	{
		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckBSequence( m ) )
			{
				...
				// Algorithm: (20% of magery) + (20-30) + (25% of alchemy) + (25% of eval int) + (25% of imbuing) + (25% of inscribe)
				...
				int amount4 = (int)(Caster.Skills[SkillName.Inscribe].Value * 0.25);
                                ...
                                // 100 Skill * 0.2 = 20 + toHeal + amount1 + amount2 + amount3 + amount4
				toHeal += Utility.Random( 20, 30 ) + amount1 + amount2 + amount3 + amount4;
