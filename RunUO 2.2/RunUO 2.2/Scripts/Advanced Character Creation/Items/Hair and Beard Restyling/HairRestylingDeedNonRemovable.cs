...
{
	public class HairRestylingDeedNonRemovable : Item
	{
		public override int LabelNumber{ get{ return 1041061; } } // a coupon for a free hair restyling

		[Constructable]
		public HairRestylingDeedNonRemovable () : base( 0x14F0 )
		{
			Weight = 1.0;
                        Movable = false;
		}

		public HairRestylingDeedNonRemovable ( Serial serial ) : base( serial )
		{
		}
		...
		private class InternalGump : Gump
		{
			...
			private HairRestylingDeedNonRemovable  m_Deed;

			public InternalGump( Mobile from, HairRestylingDeedNonRemovable  deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
