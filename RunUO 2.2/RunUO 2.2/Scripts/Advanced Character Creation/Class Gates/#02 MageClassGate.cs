...
{
      public class MageClassGate : Item
      {
                [Constructable]
                public MageClassGate() : base(0xF6C)
                {
	                Movable = false;
	                Light = LightType.Circle300;
	                Name = "Mage Class Gate"; 
                }

                public MageClassGate(Serial serial) : base(serial)
                {
                }
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			int version = reader.ReadInt();
                ...
                { 
                        if ( m.Female == false )
                        {
				m.CloseGump( typeof( MageClassGump ) );
				m.SendGump( new MageClassGump( m ) );
	...
	public class MageClassGump : Gump
	{
		public MageClassGump( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(282, 151, 1153, @"Way of the Mage!");
			this.AddButton(226, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddButton(351, 469, 241, 242,  1, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "Proceed through this portal if you seek on joining the ways of the Mage.<br><br><i>Once you've made your selection, you will be drawn to the outside gates of this island and thus will be unable to return.</i><br><br>Are you sure you want to commit?", false, true);
		}
