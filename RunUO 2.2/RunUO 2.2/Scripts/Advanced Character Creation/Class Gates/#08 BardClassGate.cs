...
{
      public class BardClassGate : Item
      {
                [Constructable]
                public BardClassGate() : base(0xF6C)
                {
	                Movable = false;
                ...
                public BardClassGate(Serial serial) : base(serial)
                {
                }
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			int version = reader.ReadInt();
                ...
                { 
                        if ( m.Female == false )
                        {
				m.CloseGump( typeof( BardClassGump ) );
				m.SendGump( new BardClassGump( m ) );
	...
	public class BardClassGump : Gump
	{
		public BardClassGump( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(282, 151, 1153, @"Way of the Bard!");
			this.AddButton(226, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddButton(351, 469, 241, 242,  1, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "Proceed through this portal if you seek on joining the ways of the Bard.<br><br><i>Once you've made your selection, you will be drawn to the outside gates of this island and thus will be unable to return.</i><br><br>Are you sure you want to commit?", false, true);
		}
