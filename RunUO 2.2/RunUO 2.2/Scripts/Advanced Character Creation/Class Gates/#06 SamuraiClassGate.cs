...
{
      public class SamuraiClassGate : Item
      {
                [Constructable]
                public SamuraiClassGate() : base(0xF6C)
                {
	                Movable = false;
	                Light = LightType.Circle300;
	                Name = "Samurai Class Gate"; 
                }

                public SamuraiClassGate(Serial serial) : base(serial)
                {
                }
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			int version = reader.ReadInt();
                ...
                { 
                        if ( m.Female == false )
                        {
				m.CloseGump( typeof( SamuraiClassGump ) );
				m.SendGump( new SamuraiClassGump( m ) );
	...
	public class SamuraiClassGump : Gump
	{
		public SamuraiClassGump( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(282, 151, 1153, @"Way of the Samurai!");
			this.AddButton(226, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddButton(351, 469, 241, 242,  1, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "Proceed through this portal if you seek on joining the ways of the Samurai.<br><br><i>Once you've made your selection, you will be drawn to the outside gates of this island and thus will be unable to return.</i><br><br>Are you sure you want to commit?", false, true);
		}
			...
			switch( info.ButtonID )
			{
				case 0:
				{
			                ...
			                from.AddToBackpack( boots );
                                        ...
                                        from.BankBox.DropItem( new BookOfBushido() );
                                        from.BankBox.DropItem( new Scissors() );
                                        from.BankBox.DropItem( new Bandage( 100 ) );
		                        ...
		                        from.FixedEffect( 0x376A, 10, 16 );
                                        ...
                                        World.Broadcast( 0x35, true, "Another has chosen thy path of the Samurai!" );
					from.CloseGump( typeof( SamuraiClassGump ) );

					break;
				}
				case 1:
				{
					from.SendMessage( "You decide that the way of the Samurai is not in your best interests." );
					from.CloseGump( typeof( SamuraiClassGump ) );
