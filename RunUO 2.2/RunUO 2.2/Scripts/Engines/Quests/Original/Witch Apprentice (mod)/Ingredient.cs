		...
		private static IngredientInfo[] m_Table = new IngredientInfo[]
			{
				...
				// mongbat wing
				new IngredientInfo( 1055022, 5, typeof( Mongbat ), typeof( GreaterMongbat ) , typeof( CavernMongbatArcher ), typeof( CavernMongbatBerserker ), typeof( CavernMongbatPlantkeeper ), typeof( CavernMongbatRavager ), typeof( CavernMongbatScout ), typeof( CavernMongbatShaman ) ), 
				// chicken gizzard
				new IngredientInfo( 1055023, 5, typeof( Chicken ), typeof( Gizzard ) ),
				// rat tail
				new IngredientInfo( 1055024, 5, typeof( Rat ), typeof( GiantRat ), typeof( Sewerrat ) ),
				// frog's leg
				new IngredientInfo( 1055025, 5, typeof( BullFrog ), typeof( GiantToad ), typeof( HillToad ), typeof( LargeFrog ), typeof( PoisonArrowFrog ) ),
				// deer heart
				new IngredientInfo( 1055026, 5, typeof( Hind ), typeof( GreatHart ), typeof( AlytharrForestHart ) ),
				// lizard tongue
				new IngredientInfo( 1055027, 5, typeof( BlackLizard ), typeof( LavaLizard ), typeof( WaterLizard ), typeof( WaterLizardScout ) ),
				// slime ooze
				new IngredientInfo( 1055028, 5, typeof( GaseousSlime ), typeof( Slime ), typeof( GreenSlime ) ),
				// spirit essence
				new IngredientInfo( 1055029, 5, typeof( IceWraith ), typeof( Ghoul ), typeof( Spectre ), typeof( Shade ), typeof( Wraith ), typeof( Bogle ) ),
				// Swamp Water
