...
namespace Server.Engines.Quests.Hag
{
	...
	public class AcceptConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>Somewhat out of character for the vile old witch, she actually seems delighted that you've accepted her offer.</BASEFONT COLOR></I><BR><BR>Ah! That's the spirit! You're not a useless bag of bones after all, are ye?<BR><BR>Well then, best get your hind quarters in gear and be on your way!<BR><BR>Remember, my young Apprentice could be anywhere within Zaythalor Graveyard, so be sure to run the whole course of it, and stay on track!<BR><BR>And for Gashnak's sake, come back here when you've found something! And remember, I don't have all day! And watch out for the imp Zeefzorpul! And don't return empty handed! And pack a warm sweater! And don't trample my lawn on the way out!<BR><BR>What are you still doing here?  Get to it! Shoo!";
			}
		}
	...
	public class HagDuringImpSearchConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>The sickly old hag looks up from her boiling cauldron.</BASEFONT COLOR></I><BR><BR>Have you found that vile little Zeefzorpul yet? What!? You've come back here without finding out where Zeefzorpul is, and what he's done with my Magic Brew Recipe?<BR><BR>I told you what needs to be done, you little whelp! Now away with ye! And don't you return until you've found my list of ingredients!";
			}
		}
	...
	public class ImpDeathConversation : QuestConversation
	{
		...
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>The wretched imp cries out for mercy.</BASEFONT COLOR></I><BR><BR>Forgive me! You master! You great warrior, great hooman, great greatest! Forgive! Forgive! I give up Zeef! He no good any way! He always smack me head and hurt me good! He say I ugly too, even with me pretty teef!<BR><BR> But I knows where he hide! I follow him flapping to his hidey hole. He think he so smart but he so wrong! I make scribble drawing of where he like to hide! But you need the whistle blower to make him come! He no come without it! Make with the whistle at his hidey place, and Zeef must come, he cannot resist!<BR><BR><I><BASEFONT COLOR=#FFFF00>The frightened imp hands you a crumpled map and a strange flute.</BASEFONT COLOR></I><BR><BR>You go to where the picture shows and then you play that whistle! Zeef come, me promise! But you make promise that you smack Zeef head good! Pweese?<BR><BR><I><BASEFONT COLOR=#FFFF00>With this last request, the miserable little imp falls and breathes no more.</BASEFONT COLOR></I>";
			}
		}
		...
		public override object Message
		{
			get
			{
				if ( m_Tricorne)
				{
					if ( m_Drunken )
					{
return "<I><BASEFONT COLOR=#FFFF00>The filthy Captain flashes a pleased grin at you as he looks you up and down.</BASEFONT COLOR></I><BR><BR>Well that's more like it, me little deck swabber! Ye almost look like ye fit in around here, ready te sail the vast Almharian oceans, sinking boats and slaying sea serpents!<BR><BR>But can ye truly handle yerself?  Ye might think ye can test me meddle with a sip or two of yer dandy wine, but a real pirate walks the decks with a belly full of it.  Lookit that, yer not even wobblin'!<BR><BR>Ye've impressed me a bit, ye wee tyke, but it'll take more'n that te join me crew!<BR><BR><I><BASEFONT COLOR=#FFFF00>Captain Blackheart tips his mug in your direction, offering up a jolly laugh, but it seems you still haven't impressed him enough.</BASEFONT COLOR></I>";
					}
					else
					{
