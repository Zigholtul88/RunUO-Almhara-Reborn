...
namespace Server.Engines.Quests.Collector
{
	...
	public class AcceptConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>Elwood slaps his knee and grins at you.</BASEFONT COLOR></I><BR><BR>Yes. Yes. That's the spirit. I knew it. Knew it when I first saw you. You remind me so much of your dear departed father. Or someone. Not sure. Maybe no one. But that's okay. Ah, good times.<BR><BR>Anyway, so as you know, I'm a collector. Got all kinds of interesting things laying around back at my warehouse. You know. You've seen it. Haven't you? Yes? No? Nevermind. Not important.<BR><BR>Right. So, always trying to add new things to my collection. Or sometimes just get more of something. Can't have too many. Right? Yeah? Sure.<BR<BR>Let's see. Where to start. Oh, I know. Pearls. Yes. But not just any pearls. Rainbow pearls. Yes. From the waters of Star Lake over in the Zaythalor region. Seems all that magic being thrown into that region has transformed the area and has had an interesting effect on some of the wildlife down there. Exactly, rainbow pearls. Useless for magic, but an item worth collecting. Trust me on this. Trust me.<BR><BR>Need you to go fish some up for me. Down at the lake. Star Lake. Off ya go. Happy fishing!<BR><BR><I><BASEFONT COLOR=#FFFF00>Elwood turns back to his ale and now seems oblivious to you.</BASEFONT COLOR></I><BR><BR>";
			}
		}
	...
	public class ReturnPearlsConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>Elwood jumps slightly when you call his name.</BASEFONT COLOR></I><BR><BR>What. I'm awake. Oh, It's you. Hey, look at those pearls. Beautiful. Wow. Where'd you get those... oh right. I sent you to get them. From the lake. Star Lake. Great job. Gotta love rainbow pearls. Oooh, Colors.<BR><BR>Okay, let's see. Next. Need a painting. Go and speak to Alberta. Alberta Giacco. Best painter I've ever met. Ask her to do a painting of you. Yes. Of you. A portrait. Never know if you might up and become famous one day. Need to have a painting of you in my collection. From now. Before all the fame. Go. Alberta awaits. She's in Skaddria Naddheim.<BR><BR><I><BASEFONT COLOR=#FFFF00>Elwood starts playing with the pearls you brought him and seems to have forgotten you're there.</BASEFONT COLOR></I><BR><BR>";
			}
		}
	...
	public class AlbertaPaintingConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
return "<I><BASEFONT COLOR=#FFFF00>Alberta looks up from the painting she is working on and faces you.</BASEFONT COLOR></I><BR><BR>Excuse me. I don't mean to be rude, but I'm in the middle of something, and can't... oh wait, I see. You must be the one Elwood sent over.<BR><BR>Very well. If you'll have a stand next to Boryan over there, we'll get started. This will just take a few seconds. I paint quite quickly, you see. I'll start once you are seated.";
			}
		}
	...
	public class ElwoodDuringPainting1Conversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>Elwood yawns and stretches, then focuses his gaze on you.</BASEFONT COLOR></I><BR><BR>Hello. Do I know you? Hold on a second. Yes. Yes, I do. You were going to bring me some rainbow pearls. Wait. No. You already did that. I remember now. Right. So go get that portrait painted. Alberta is in Skaddria Naddheim. Go to her. Alberta Giacco. Come back when she's done.";
			}
		}
	...
	public class GabrielAutographConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>Gabriel sighs loudly as you address him and stops whatever it was that he was doing.</BASEFONT COLOR></I><BR><BR>WHAT?!? Can you not see that I'm working here?  Ugh, sometimes I wish they'd just lock the outer doors to anyone who doesn't belong here. So go ahead and fawn. Get it over with, and then leave. Sooner you're out of here, the sooner I'm back to work.<BR><BR>I see. So you want an autograph. Fine. If it'll get rid of you, I'll give you my autograph. But I'll only sign some sheet music for one of my songs. Until then, please let me get back to work.<BR><BR>You can probably find some of my sheet music at one of the theaters in the land. When I perform there, they often sell it as a souvenir. Speak to the impresario... the theater manager. My last three performances were in Elmhaven, Hammerhill, and here in Skaddria Naddheim.";
			}
		}
	...
	public class ReturnAutographConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>Elwood looks up eagerly as you tell him about the autographed sheet music.</BASEFONT COLOR></I><BR><BR>Quite good work. Not an easy one to deal with, that one. Gabriel Piete. Yes. Well done. Nice autograph.<BR><BR>One last task. I would like a set of toy monster figurines made by the famous toymaker, Tomas O'Neerlan. You'll find him here in Red Dagger Keep. He's often at one of the taverns. Try looking there.<BR><BR>You're doing quite well. Quite well indeed. Knew you would. Just like old times. Yes. Quite good.";
			}
		}
	...
	public class ReturnImagesConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>Tomas grins as you walk toward him.</BASEFONT COLOR></I><BR><BR>I see that you have collected all of the images we need. 'Tis good. I'll begin straight away on the toy figurines. I'll have them delivered to you when ready. Where shall I send them? To Elwood here in town? Yes, I know him. We've done business in the past. Odd fellow.<BR><BR><I><BASEFONT COLOR=#FFFF00>Tomas smiles as you return his enchanted paints back to him.</BASEFONT COLOR></I><BR><BR>.";
			}
		}
