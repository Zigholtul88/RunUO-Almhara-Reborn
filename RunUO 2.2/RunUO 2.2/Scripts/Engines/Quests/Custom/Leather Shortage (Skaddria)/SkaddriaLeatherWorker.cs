...
{ 
	public class SkaddriaLeatherWorker : BaseQuester
	{ 
		public override bool IsActiveVendor{ get{ return true; } }

		[Constructable]
		public SkaddriaLeatherWorker() : base( "(Leather Shortage - Skaddria)" )
		{
		}

		public SkaddriaLeatherWorker( Serial serial ) : base( serial )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBSkaddriaLeatherWorker() );
		}
		...
		public override void OnTalk( PlayerMobile player, bool contextMenu )
		{
			...
			if ( qs is LeatherShortageSkaddriaQuest )
			{
			...
			{
				LeatherShortageSkaddriaQuest newQuest = new LeatherShortageSkaddriaQuest( player );
				...
				else if ( QuestSystem.CanOfferQuest( player, typeof( LeatherShortageSkaddriaQuest ), out inRestartPeriod ) )
				{
					newQuest.SendOffer();
				}
		...
		{			
			...
			return base.OnDragDrop( from, dropped );
                ...
                {
                    private SkaddriaLeatherWorker m_LeatherWorker;

                    public RepairTarget(SkaddriaLeatherWorker leatherworker) : base(12, false, TargetFlags.None)
                    {
	...
	public class SBSkaddriaLeatherWorker : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBSkaddriaLeatherWorker()
		{
		}
