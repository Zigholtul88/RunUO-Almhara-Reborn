...
namespace Server.Engines.Quests.OreShortageElmhaven
{
	public class DeclineConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>You decline the offer and Lynis nods his head in disbelief.</BASEFONT COLOR></I><BR><BR>Well I suppose I'm gonna have to find some other means of getting ingots. Perhaps I might sell off my body to the highest bidder or something.";					
			}
		}
	...
	public class AcceptConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>You accept the offer and Lynis smiles with glee.</BASEFONT COLOR></I><BR><BR>Brilliant mate, now I require at least 100 ingots, and they can range from dull copper, shadow iron, copper or bronze. The type you bring me will determine what reward I can give you.";					
			}
		}
