...
{
	public class IguanaCoveKeyDoor : StrongWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public IguanaCoveKeyDoor( DoorFacing facing ) : base( facing )
		{
			m_LockLevel = 80;
			m_MaxLockLevel = 85; 
			m_RequiredSkill = 80;
		...
		public override void Use( Mobile from )
		{
			...
			{
				Locked = true;
				from.SendMessage( "The door requires either the dungeon key or a skill of 80 in order to unlock." );
				return;
			}
		...
		public IguanaCoveKeyDoor( Serial serial ) : base( serial )
		{
