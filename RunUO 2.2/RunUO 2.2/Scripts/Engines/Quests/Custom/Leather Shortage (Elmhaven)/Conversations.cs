...
namespace Server.Engines.Quests.LeatherShortageElmhaven
{
	...
	public class AcceptConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>You accept the offer and Talarah smiles with glee.</BASEFONT COLOR></I><BR><BR>Brilliant mate, now I require at least 100 leather strips, and they can range from spined, horned, or barbed. The type you bring me will determine what reward I can give you.";					
			}
		}
	...
	public class Reward100Conversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>You hand over exactly 100 Spined Leather and Talarah takes them from you. She then hands to you three gold bars.</BASEFONT COLOR></I><BR><BR>Quite the generous amount mate. Now we can definitely fill out those orders. Thanks for your help and come back tomorrow and I'll have another job ready for you.";					
			}
		}
	...
	public class Reward300Conversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				return "<I><BASEFONT COLOR=#FFFF00>You hand over exactly 100 Barbed Leather and Talarah takes them from you. She then hands to you five gold bars.</BASEFONT COLOR></I><BR><BR>Excellent, that right there is what I'm talking about. Thanks for your help and come back tomorrow and I'll have another job ready for you.";						
			}
		}
