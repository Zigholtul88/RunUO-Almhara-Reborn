...
{ 
   public class ThePrancingPoultryFinishGump : Gump 
   { 
      public static void Initialize() 
      { 
         CommandSystem.Register( "ThePrancingPoultryFinishGump", AccessLevel.GameMaster, new CommandEventHandler( ThePrancingPoultryFinishGump_OnCommand ) ); 
      } 

      private static void ThePrancingPoultryFinishGump_OnCommand( CommandEventArgs e ) 
      { 
         e.Mobile.SendGump( new ThePrancingPoultryFinishGump( e.Mobile ) ); 
      } 

      public ThePrancingPoultryFinishGump( Mobile owner ) : base( 50,50 ) 
      { 
//----------------------------------------------------------------------------------------------------
...
"<BASEFONT COLOR=YELLOW>chickens but sadly this isn't the only <BR>" +
