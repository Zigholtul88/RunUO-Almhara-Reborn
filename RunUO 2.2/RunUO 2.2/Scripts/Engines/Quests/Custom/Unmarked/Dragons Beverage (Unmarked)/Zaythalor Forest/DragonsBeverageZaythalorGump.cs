...
{ 
   public class DragonsBeverageZaythalorGump : Gump 
   { 
      public static void Initialize() 
      { 
         CommandSystem.Register( "DragonsBeverageZaythalorGump", AccessLevel.GameMaster, new CommandEventHandler( DragonsBeverageZaythalorGump_OnCommand ) ); 
      } 

      private static void DragonsBeverageZaythalorGump_OnCommand( CommandEventArgs e ) 
      { 
         e.Mobile.SendGump( new DragonsBeverageZaythalorGump( e.Mobile ) ); 
      } 

      public DragonsBeverageZaythalorGump( Mobile owner ) : base( 50,50 ) 
      { 
//----------------------------------------------------------------------------------------------------
