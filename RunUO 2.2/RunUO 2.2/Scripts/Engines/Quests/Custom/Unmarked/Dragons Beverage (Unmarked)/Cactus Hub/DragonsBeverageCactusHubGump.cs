...
{ 
   public class DragonsBeverageCactusHubGump : Gump 
   { 
      public static void Initialize() 
      { 
         CommandSystem.Register( "DragonsBeverageCactusHubGump", AccessLevel.GameMaster, new CommandEventHandler( DragonsBeverageCactusHubGump_OnCommand ) ); 
      } 

      private static void DragonsBeverageCactusHubGump_OnCommand( CommandEventArgs e ) 
      { 
         e.Mobile.SendGump( new DragonsBeverageCactusHubGump( e.Mobile ) ); 
      } 

      public DragonsBeverageCactusHubGump( Mobile owner ) : base( 50,50 ) 
      { 
//----------------------------------------------------------------------------------------------------
