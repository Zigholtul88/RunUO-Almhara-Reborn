...
{ 
	public class ZaythalorTavernKeeper : BaseVendor 
	{ 
		private List<SBInfo> m_SBInfos = new List<SBInfo>(); 
		protected override List<SBInfo> SBInfos{ get { return m_SBInfos; } } 

		[Constructable]
		public ZaythalorTavernKeeper() : base( "the tavern keeper" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBZaythalorTavernKeeper() ); 
		} 
		...
		public ZaythalorTavernKeeper( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new ZaythalorTavernKeeperEntry( from, this ) );
		}
		...
		public class ZaythalorTavernKeeperEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public ZaythalorTavernKeeperEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
			...
			public override void OnClick()
			{
				...
				{
					if ( ! mobile.HasGump( typeof( DragonsBeverageZaythalorGump ) ) )
					{
						mobile.SendGump( new DragonsBeverageZaythalorGump( mobile ));	
					}
				}
			}
		}
	...
	public class SBZaythalorTavernKeeper: SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBZaythalorTavernKeeper() 
		{ 
		} 
