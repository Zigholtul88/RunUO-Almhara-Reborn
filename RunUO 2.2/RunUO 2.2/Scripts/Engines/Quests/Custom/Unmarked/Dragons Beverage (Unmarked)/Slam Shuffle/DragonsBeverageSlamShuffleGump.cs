...
{ 
   public class DragonsBeverageSlamShuffleGump : Gump 
   { 
      public static void Initialize() 
      { 
         CommandSystem.Register( "DragonsBeverageSlamShuffleGump", AccessLevel.GameMaster, new CommandEventHandler( DragonsBeverageSlamShuffleGump_OnCommand ) ); 
      } 

      private static void DragonsBeverageSlamShuffleGump_OnCommand( CommandEventArgs e ) 
      { 
         e.Mobile.SendGump( new DragonsBeverageSlamShuffleGump( e.Mobile ) ); 
      } 

      public DragonsBeverageSlamShuffleGump( Mobile owner ) : base( 50,50 ) 
      { 
//----------------------------------------------------------------------------------------------------
