...
{ 
	public class SkaddriaTavernKeeper : BaseVendor 
	{ 
		private List<SBInfo> m_SBInfos = new List<SBInfo>(); 
		protected override List<SBInfo> SBInfos{ get { return m_SBInfos; } } 

		[Constructable]
		public SkaddriaTavernKeeper() : base( "the tavern keeper" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBSkaddriaTavernKeeper() ); 
		}

		public override void InitOutfit()
		{
			Name = "Elliott Torchwood";
                 	Body = 400;
                        Female = false;
                        Race = Race.Human;
                        Hue = 33800;
			...
			AddItem( new FancyShirt(783) );
			AddItem( new FancyPants(883) );
			AddItem( new ThighBoots(958) );
                }

		public SkaddriaTavernKeeper( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new SkaddriaTavernKeeperEntry( from, this ) );
		}
		...
		public class SkaddriaTavernKeeperEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public SkaddriaTavernKeeperEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
			...
			public override void OnClick()
			{
				...
				{
					if ( ! mobile.HasGump( typeof( DragonsBeverageSkaddriaGump ) ) )
					{
						mobile.SendGump( new DragonsBeverageSkaddriaGump( mobile ));
	...
	public class SBSkaddriaTavernKeeper : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBSkaddriaTavernKeeper()
		{
		}
