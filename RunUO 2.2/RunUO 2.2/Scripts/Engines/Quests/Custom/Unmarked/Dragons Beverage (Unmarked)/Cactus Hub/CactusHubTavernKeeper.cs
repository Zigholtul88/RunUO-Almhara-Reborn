...
{ 
	public class CactusHubTavernKeeper : BaseVendor 
	{ 
		private List<SBInfo> m_SBInfos = new List<SBInfo>(); 
		protected override List<SBInfo> SBInfos{ get { return m_SBInfos; } } 

		[Constructable]
		public CactusHubTavernKeeper() : base( "the tavern keeper" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBCactusHubTavernKeeper() ); 
		} 
		...
		public CactusHubTavernKeeper( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new CactusHubTavernKeeperEntry( from, this ) );
		}
		...
		public class CactusHubTavernKeeperEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public CactusHubTavernKeeperEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
			...
			public override void OnClick()
			{
				...
				{
					if ( ! mobile.HasGump( typeof( DragonsBeverageCactusHubGump ) ) )
					{
						mobile.SendGump( new DragonsBeverageCactusHubGump( mobile ));	
					}
				}
			}
		}
	...
	public class SBCactusHubTavernKeeper: SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBCactusHubTavernKeeper() 
		{ 
		} 
