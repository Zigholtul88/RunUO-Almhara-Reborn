...
{ 
         public class MarbleMadnessGump2 : Gump 
         { 
                public static void Initialize() 
                { 
                     CommandSystem.Register( "MarbleMadnessGump2", AccessLevel.GameMaster, new CommandEventHandler( MarbleMadnessGump2_OnCommand ) ); 
                } 

                private static void MarbleMadnessGump2_OnCommand( CommandEventArgs e ) 
                { 
                     e.Mobile.SendGump( new MarbleMadnessGump2( e.Mobile ) ); 
                } 

                public MarbleMadnessGump2( Mobile owner ) : base( 50,50 ) 
                { 
//----------------------------------------------------------------------------------------------------
			this.AddPage(0);
			...
			this.AddHtml( 157, 181, 345, 279, "Thank you so very much.<BR><BR>Sorry I don't remember which Lizardman stole my marbles, but I am sure you find it for me.<BR><BR>Bring me my big colourful marble and I will reward you as best I can.", false, true);
...
//----------------------------------------------------------------------------------------------------
                ...
                { 
                    //Cancel 
                    from.SendMessage( "Godspeed fellow traveler." );
                    break; 
                } 
            }
        }
