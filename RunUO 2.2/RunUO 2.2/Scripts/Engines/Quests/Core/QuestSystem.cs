		...
		public static readonly Type[] QuestTypes = new Type[]
			{
				...
				typeof( LeatherShortageElmhaven.LeatherShortageElmhavenQuest ),
				typeof( LeatherShortageSkaddria.LeatherShortageSkaddriaQuest ),
				typeof( StolenNecklace.StolenNecklaceQuest ),
				typeof( SweetChildOfMine.SweetChildOfMineQuest ),
				typeof( StaffOfFlyingMonkeys.StaffOfFlyingMonkeysQuest )
			};
