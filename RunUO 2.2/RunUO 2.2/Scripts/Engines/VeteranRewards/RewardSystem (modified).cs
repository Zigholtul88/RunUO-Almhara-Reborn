			...
			m_Lists = new RewardList[]
				{
					new RewardList( RewardInterval, 1, new RewardEntry[]
					{
						...
						new RewardEntry( houseAddOns,    1072216, typeof( ContestMiniHouseDeed ), Expansion.AOS, MiniHouseType.ChurchAtNight ),
					...
					new RewardList( RewardInterval, 3, new RewardEntry[]
					{
						...
						new RewardEntry( houseAddOns,	 1080407, typeof( PottedCactusDeed ), Expansion.AOS )
					...
					new RewardList( RewardInterval, 5, new RewardEntry[]
					{
						...
						new RewardEntry( houseAddOns,    1080384, typeof( BloodyPentagramDeed ), Expansion.AOS )
					} ),					
