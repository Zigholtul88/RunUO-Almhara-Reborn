...
namespace Server.Engines.MLQuests.Gumps
{
	public class QuestLogDetailedGump : BaseQuestGump
	{
		...
		public QuestLogDetailedGump( MLQuestInstance instance ): this( instance, true )
		{
		}

		public QuestLogDetailedGump( MLQuestInstance instance, bool closeGumps ): base( 1046026 ) // Quest Log
		{
			m_Instance = instance;
