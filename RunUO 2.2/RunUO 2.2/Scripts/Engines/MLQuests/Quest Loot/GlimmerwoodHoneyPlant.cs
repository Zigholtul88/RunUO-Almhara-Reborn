...
{ 
	public class GlimmerwoodHoneyPlant : Item
	{ 
		...
		[Constructable]
		public GlimmerwoodHoneyPlant() : base( Utility.RandomList( 14509, 14510 ) ) 
		{
			Name = "glimmerwood honey plant";
		...
		public GlimmerwoodHoneyPlant( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		{ 
			if ( from.InRange( this.GetWorldLocation(), 2 ) ) 
		        { 
			        ...
			        GlimmerwoodHoney crop = new GlimmerwoodHoney( pick ); 
				from.AddToBackpack( crop );
			        from.SendMessage( "You harvest some glimmerwood honey." ); 
				this.Delete();
			}
		        else
		        { 
