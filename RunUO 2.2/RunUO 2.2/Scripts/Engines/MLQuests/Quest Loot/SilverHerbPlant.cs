...
{ 
	public class SilverHerbPlant : Item
	{ 
		...
		[Constructable]
		public SilverHerbPlant() : base( Utility.RandomList( 14576, 14577, 14578 ) ) 
		{
			Name = "silver herb plant";
		...
		public SilverHerbPlant( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		{ 
			if ( from.InRange( this.GetWorldLocation(), 2 ) ) 
		        { 
			        ...
			        SilverHerb crop = new SilverHerb( pick ); 
				from.AddToBackpack( crop );
			        from.SendMessage( "You harvest some silver herbs." ); 
				this.Delete();
			}
		        else
		        { 
