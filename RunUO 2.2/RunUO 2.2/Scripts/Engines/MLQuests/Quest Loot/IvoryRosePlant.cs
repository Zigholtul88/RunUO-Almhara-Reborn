...
{ 
	public class IvoryRosePlant : Item
	{ 
		...
		[Constructable]
		public IvoryRosePlant() : base( Utility.RandomList( 0x1F0D, 0x1F11 ) ) 
		{
			Name = "ivory rose plant";
		...
		public IvoryRosePlant( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		{ 
			if ( from.InRange( this.GetWorldLocation(), 2 ) ) 
		        { 
			        ...
			        IvoryRose crop = new IvoryRose( pick ); 
				from.AddToBackpack( crop );
			        from.SendMessage( "You harvest some ivory rose." ); 
				this.Delete();
			}
		        else
		        { 
