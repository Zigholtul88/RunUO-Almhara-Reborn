...
namespace Server.Engines.BulkOrders
{
	...
	public abstract class SmallBOD : Item
	{
		...
		public int Graphic{ get{ return m_Graphic; } set{ m_Graphic = value; } }
        	...
        	[CommandProperty(AccessLevel.GameMaster)]
        	public int GraphicHue{ get{ return m_GraphicHue; } set{ m_GraphicHue = value; } }
		...
		[Constructable]
		public SmallBOD( int hue, int amountMax, Type type, int number, int graphic, bool requireExeptional, BulkMaterialType material, int graphichue ) : base( Core.AOS ? 0x2258 : 0x14EF )
		{
			Weight = 1.0;
