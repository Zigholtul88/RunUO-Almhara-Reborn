	...
	public class Mining : HarvestSystem
	{
		...
		private Mining()
		{
			...
			if ( Core.ML )
			{
				...
				{
					new BonusHarvestResource( 0, 69.4, null, null ),	//Nothing
					new BonusHarvestResource( 100, 0.5, 1072562, typeof( BlueDiamond ) ),
					new BonusHarvestResource( 100, 0.5, 1072567, typeof( DarkSapphire ) ),
					new BonusHarvestResource( 100, 0.5, 1072570, typeof( EcruCitrine ) ),
					new BonusHarvestResource( 100, 0.5, 1072564, typeof( FireRuby ) ),
					new BonusHarvestResource( 100, 0.5, 1072566, typeof( PerfectEmerald ) ),
					new BonusHarvestResource( 100, 0.5, 1072568, typeof( Turquoise ) )
				};
			}
