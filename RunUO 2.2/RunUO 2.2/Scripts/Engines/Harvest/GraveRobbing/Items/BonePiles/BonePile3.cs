...
{
	public class BonePile3 : LockableContainer
	{
		...
		public BonePile3() : base( 3786 )
		{
			...
			int reward = Utility.RandomMinMax( 2, 3 );;
		        ...
		        DropItem( new Gold( Utility.RandomMinMax( reward * 125, reward * 175 ) ) );
		...
		public BonePile3( Serial serial ) : base( serial )
		{
		}
