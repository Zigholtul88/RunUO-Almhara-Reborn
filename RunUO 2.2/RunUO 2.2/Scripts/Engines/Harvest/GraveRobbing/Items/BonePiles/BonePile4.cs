...
{
	public class BonePile4 : LockableContainer
	{
		...
		public BonePile4() : base( 3786 )
		{
			...
			int reward = Utility.RandomMinMax( 3, 3 );;
		        ...
		        DropItem( new Gold( Utility.RandomMinMax( reward * 150, reward * 200 ) ) );
		...
		public BonePile4( Serial serial ) : base( serial )
		{
		}
