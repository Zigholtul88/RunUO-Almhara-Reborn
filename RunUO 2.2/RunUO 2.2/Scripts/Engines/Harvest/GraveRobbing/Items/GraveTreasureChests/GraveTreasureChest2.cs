...
{
	public class GraveTreasureChest2 : LockableContainer
	{
		...
		[Constructable]
		public GraveTreasureChest2() : base( 3712 )
		{
			...
			switch ( Utility.Random( 2 ) )
			{
		        ...
		        TrapPower = Utility.Random( 20, 50 );
		...
		public GraveTreasureChest2( Serial serial ) : base( serial )
		{
		}
