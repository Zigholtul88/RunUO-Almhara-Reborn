...
{
	public class GraveTreasureChest4 : LockableContainer
	{
		...
		[Constructable]
		public GraveTreasureChest4() : base( 3712 )
		{
			...
			switch ( Utility.Random( 2 ) )
			{
		        ...
		        TrapPower = Utility.Random( 40, 100 );
		...
		public GraveTreasureChest4( Serial serial ) : base( serial )
		{
		}
