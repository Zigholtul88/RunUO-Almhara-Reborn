...
{
	public class GraveTreasureChest6 : LockableContainer
	{
		...
		[Constructable]
		public GraveTreasureChest6() : base( 3712 )
		{
			...
			int reward = Utility.RandomMinMax( 3, 4 );;
			RequiredSkill = 95;
			...
			switch ( Utility.Random( 2 ) )
			{
		        ...
		        TrapPower = Utility.Random( 60, 150 );
			TrapOnLockpick = true;
		...
		public GraveTreasureChest6( Serial serial ) : base( serial )
		{
		}
