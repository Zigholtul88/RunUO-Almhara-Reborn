		...
		private GraveRobbing()
		{
			...
			if ( Core.ML )
			{
				grave.BonusResources = new BonusHarvestResource[] // cos this is mining after all
				{
					...
					new BonusHarvestResource( 100, 0.2, 1072562, typeof( BlueDiamond ) ),
					new BonusHarvestResource( 100, 0.2, 1072567, typeof( DarkSapphire ) ),
					new BonusHarvestResource( 100, 0.2, 1072570, typeof( EcruCitrine ) ),
					new BonusHarvestResource( 100, 0.2, 1072564, typeof( FireRuby ) ),
					new BonusHarvestResource( 100, 0.2, 1072566, typeof( PerfectEmerald ) ),
					new BonusHarvestResource( 100, 0.2, 1072568, typeof( Turquoise ) )
				};
			}
