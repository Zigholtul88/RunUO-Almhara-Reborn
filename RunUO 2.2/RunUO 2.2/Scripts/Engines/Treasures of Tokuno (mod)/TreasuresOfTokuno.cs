	...
	public class TreasuresOfTokuno
	{
		...
		private static Type[][] m_LesserArtifacts = new Type[][]
		{
			...
			new Type[] {
				...
				typeof( MetalPigmentsOfTokuno ), typeof( ChestOfHeirlooms )
			},
			// ToT Three Rewards
			new Type[] {
		...
		private static bool CheckLocation( Mobile m )
		{
			...
			if( r.IsPartOf( "Dragon Sanctuary" ) || r.IsPartOf( "Rockbitter Vault" ) || r.IsPartOf( "Sanguine Sanctuary" ) || r.IsPartOf( "Fortress Calcifina" ) || r.IsPartOf( "Passage of Lost Souls" ) || r.IsPartOf( "Tarnithok Fortress" ) || r.IsPartOf( "Guardian's Power Plant" ) || r.IsPartOf( "Amul Seketsi Royal Tomb" ) || r.IsPartOf( "Azurite Caverns" ) || r.IsPartOf( "Bharlim Passage" ) || r.IsPartOf( "Black Widow Pit" ) || r.IsPartOf( "Bleak Wind Tunnels" ) || r.IsPartOf( "Dragons Den" ) || r.IsPartOf( "Everstar Estuary" ) || r.IsPartOf( "Fungully Grotto" ) || r.IsPartOf( "Iguana Cove" ) || r.IsPartOf( "Kal-Berbessia" ) || r.IsPartOf( "Mongbat Hideout" ) || r.IsPartOf( "Murkmere Dwelling" ) || r.IsPartOf( "Nimaku Lava Basin" ) || r.IsPartOf( "Oboru Burial Grounds" ) || r.IsPartOf( "Seaspray Solitude" ) || r.IsPartOf( "Stone Burrow Mines" ) || r.IsPartOf( "Whispering Hollow" ) )
				return true;

			return (m.Map == Map.Ilshenar);
