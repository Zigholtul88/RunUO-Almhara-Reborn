...
{
      public class BossGateCalcifinaExit : Item
      {
            [Constructable]
            public BossGateCalcifinaExit() : base(0xF6C)
            {
                  Name = "Exit Gate";
	            Movable = false;
      ...
      public BossGateCalcifinaExit(Serial serial) : base(serial)
      {
      }
      ...
      { 
		    ...
		    m.PlaySound( 526 );
                ...
                m.Location = new Point3D(2381, 1316, -20);
