...
{
	public class ElmhavenShopEscort : BaseEscortable
	{
		...
		public override string[] GetPossibleDestinations()
		{
			if ( Core.ML )
				...
				return m_SkaddriaTownShopRegion;
		}

		[Constructable]
		public ElmhavenShopEscort()
		{
		...
		public ElmhavenShopEscort( Serial serial ) : base( serial )
		{
		}
