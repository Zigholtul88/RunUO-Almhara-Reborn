...
{
	public class ElmhavenAdventurer : BaseEscortable
	{
		private static string[] m_DungeonEntranceRegion = new string[]
		{ 
                        "Black Widow Pit Entrance",
                        "Elmhaven Mineshaft Entrance",
                        "Fortress Calcifina Entrance",
                        "Fungully Grotto Entrance",
                        "Iguana Cove Entrance",
                        "Murkmere Dwelling Entrance",
                        "Nimaku Lava Basin Entrance",
                        "Oboru Burial Grounds Entrance",
                        "Stone Burrow Mines Entrance",
		...
		public ElmhavenAdventurer( Serial serial ) : base( serial )
		{
		}
