                ...
                public override void OnCarve( Mobile from, Corpse corpse, Item with )
		{
			if ( corpse.Carved == false )
			{
			      base.OnCarve( from, corpse, with );
                              ...
                              corpse.AddCarvedItem( new SpidersSilk( Utility.RandomMinMax( 7, 15 ) ), from );
                              corpse.AddCarvedItem( new SpiderEgg( Utility.RandomMinMax( 9, 16 ) ), from );
