...
{
	[CorpseName( "the corpse of Agri-tath" )]
	public class Agritath : BaseCreature
	{
		[Constructable]
		public Agritath () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Agri-tath";
			Title = "the Collector of Souls";
			Body = 38;
			BaseSoundID = 357;
		...
		public Agritath( Serial serial ) : base( serial )
		{
		}
