...
{
	[CorpseName( "the corpse of Calcifur" )]
	public class Calcifur : BaseCreature
	{
		[Constructable]
		public Calcifur () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Calcifur";
			Title = "the Slayer";
			Body = 40;
		...
		public Calcifur( Serial serial ) : base( serial )
		{
		}
