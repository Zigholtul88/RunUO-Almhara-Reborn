...
{
	[CorpseName( "a shatter glass elemental corpse" )]
	public class ShatterGlassElemental : BaseCreature
	{
		...
		[Constructable]
		public ShatterGlassElemental() : base( AIType.AI_Mage, FightMode.Closest, 5, 1, 0.2, 0.4 )
		{
			Name = "a shatter glass elemental";
			Body = 300;
                        Hue = 1926;
			BaseSoundID = 278;
                ...
                public override void OnCarve( Mobile from, Corpse corpse, Item with )
		{
			if (corpse.Carved == false)
			{
			      base.OnCarve( from, corpse, with );
                        ...
                        corpse.AddCarvedItem(new DiamondDust( Utility.RandomMinMax( 11, 16 )), from);
		...
		public ShatterGlassElemental( Serial serial ) : base( serial )
		{
		}
