...
{
	[CorpseName( "a whale shark corpse" )]
	public class WhaleShark : BaseCreature
	{
		[Constructable]
		public WhaleShark() : base( AIType.AI_Animal, FightMode.Closest, 10, 1, 0.175, 0.350 )
		{
			Name = "a whale shark";
			Body = 227;
		...
		public WhaleShark( Serial serial ) : base( serial )
		{
		}
