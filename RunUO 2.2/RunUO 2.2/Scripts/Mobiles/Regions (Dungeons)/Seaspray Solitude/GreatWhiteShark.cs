...
{
	[CorpseName( "a great white shark corpse" )]
	public class GreatWhiteShark : BaseCreature
	{
		[Constructable]
		public GreatWhiteShark() : base( AIType.AI_Animal, FightMode.Closest, 10, 1, 0.175, 0.350 )
		{
		...
		public GreatWhiteShark( Serial serial ) : base( serial )
		{
		}
