...
{
	[CorpseName( "a bloody terror corpse" )]
	public class BloodyTerror : BaseCreature
	{
		public override double BoostedSpeed{ get{ return 0.1; } }
		public override bool ReduceSpeedWithDamage{ get{ return false; } }

		[Constructable]
		public BloodyTerror() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a bloody terror";
			Body = 853;
			Hue = 0x648;
		...
		public BloodyTerror( Serial serial ) : base( serial )
		{
		}
