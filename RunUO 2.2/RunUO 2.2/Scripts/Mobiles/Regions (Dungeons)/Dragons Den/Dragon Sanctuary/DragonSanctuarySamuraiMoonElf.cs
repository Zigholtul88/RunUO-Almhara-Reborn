...
{ 
	public class DragonSanctuarySamuraiMoonElf : BaseGuardian
	{ 
		...
		public DragonSanctuarySamuraiMoonElf( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			int version = reader.ReadInt();
                ...
                {
                        private DragonSanctuarySamuraiMoonElf m_Owner;

                public MoveTimer(DragonSanctuarySamuraiMoonElf owner): base(TimeSpan.FromHours(1), TimeSpan.FromHours(1))
                {
                        m_Owner = owner;
