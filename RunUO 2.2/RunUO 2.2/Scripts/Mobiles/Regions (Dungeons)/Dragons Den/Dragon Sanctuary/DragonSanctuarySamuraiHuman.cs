...
{ 
	public class DragonSanctuarySamuraiHuman : BaseGuardian
	{ 
		...
		public DragonSanctuarySamuraiHuman( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			int version = reader.ReadInt();
                ...
                {
                        private DragonSanctuarySamuraiHuman m_Owner;

                public MoveTimer(DragonSanctuarySamuraiHuman owner): base(TimeSpan.FromHours(1), TimeSpan.FromHours(1))
                {
                        m_Owner = owner;
