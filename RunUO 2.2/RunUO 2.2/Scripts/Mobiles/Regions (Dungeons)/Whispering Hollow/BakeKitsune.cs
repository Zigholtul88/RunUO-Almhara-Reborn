                ...
                public override void OnCarve( Mobile from, Corpse corpse, Item with )
		{
			if ( corpse.Carved == false )
			{
			      base.OnCarve( from, corpse, with );
                              ...
                              corpse.AddCarvedItem(new Gold( Utility.RandomMinMax( 645, 1165 ) ), from );
                              corpse.AddCarvedItem(new BarbedHides(10), from );
                              corpse.AddCarvedItem(new KitsuneClaw(), from );

                              from.SendMessage( "You carve up gold, some barbed hides and a kitsune claw." );
                              corpse.Carved = true; 
			}
                }
