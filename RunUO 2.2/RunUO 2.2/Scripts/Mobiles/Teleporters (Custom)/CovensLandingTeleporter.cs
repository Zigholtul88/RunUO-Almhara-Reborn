...
{ 
	public class CovensLandingTeleporter : BaseVendor 
	{ 
		...
		[Constructable]
		public CovensLandingTeleporter() : base( "the teleporter" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBCovensLandingTeleporter() ); 
		}
		...
		public CovensLandingTeleporter( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new CovensLandingTeleporterEntry( from, this ) );
		}
		...
		public class CovensLandingTeleporterEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public CovensLandingTeleporterEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
	...
	public class SBCovensLandingTeleporter : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBCovensLandingTeleporter()
		{
		}
