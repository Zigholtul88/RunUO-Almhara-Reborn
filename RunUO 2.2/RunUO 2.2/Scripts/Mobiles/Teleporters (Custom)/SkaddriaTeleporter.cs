...
{ 
	public class SkaddriaTeleporter : BaseVendor 
	{ 
		...
		[Constructable]
		public SkaddriaTeleporter() : base( "the teleporter" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBSkaddriaTeleporter() ); 
		}
		...
		public SkaddriaTeleporter( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBSkaddriaTeleporter : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBSkaddriaTeleporter()
		{
		}
