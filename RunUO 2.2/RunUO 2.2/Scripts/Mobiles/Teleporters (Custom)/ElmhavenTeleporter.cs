...
{ 
	public class ElmhavenTeleporter : BaseVendor 
	{ 
		...
		[Constructable]
		public ElmhavenTeleporter() : base( "the teleporter" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBElmhavenTeleporter() ); 
		}
		...
		public ElmhavenTeleporter( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new ElmhavenTeleporterEntry( from, this ) );
		}
		...
		public class ElmhavenTeleporterEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public ElmhavenTeleporterEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
	...
	public class SBElmhavenTeleporter : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBElmhavenTeleporter()
		{
		}
