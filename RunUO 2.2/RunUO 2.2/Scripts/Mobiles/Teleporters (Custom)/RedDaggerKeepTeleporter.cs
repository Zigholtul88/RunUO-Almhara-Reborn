...
{ 
	public class RedDaggerKeepTeleporter : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerKeepTeleporter() : base( "the teleporter" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepTeleporter() ); 
		}
		...
		public RedDaggerKeepTeleporter( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new RedDaggerKeepTeleporterEntry( from, this ) );
		}
		...
		public class RedDaggerKeepTeleporterEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public RedDaggerKeepTeleporterEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
	...
	public class SBRedDaggerKeepTeleporter : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBRedDaggerKeepTeleporter()
		{
		}
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( "Rune to Hammerhill", typeof( RuneToHammerhill ), 100, 500, 0x1F14, 0 ) );
