...
{ 
	public class RangerGuardOfSkaddria2 : BaseGuardian
	{ 
		...
		public RangerGuardOfSkaddria2( Serial serial ) : base( serial ) 
		{ 
		...
		{
			private RangerGuardOfSkaddria2 m_Owner;

			public AutokillTimer( RangerGuardOfSkaddria2 owner ) : base( TimeSpan.FromMinutes(10.0) )
			{
				m_Owner = owner;
