...
{
	public class HammerhillInvestmentBanker : BaseVendor
	{
		...
		[Constructable]
		public HammerhillInvestmentBanker() : base( "the investment banker" )
		{
		}
		...
		public override void InitOutfit()
		{
			...
			AddItem( new FancyShirt(163) );
			AddItem( new Skirt(371) );
			AddItem( new Sandals(679) );
            }
		...
		public HammerhillInvestmentBanker( Serial serial ) : base( serial )
		{
		}
