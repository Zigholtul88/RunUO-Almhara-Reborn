...
{
	public class HammerhillAnimalTrainer : BaseVendor
	{
		...
		[Constructable]
		public HammerhillAnimalTrainer() : base( "the animal trainer" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBHammerhillAnimalTrainer() );
		}
		...
		{
			private HammerhillAnimalTrainer m_Trainer;
			private Mobile m_From;

			public StableEntry( HammerhillAnimalTrainer trainer, Mobile from ) : base( 6126, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class ClaimListGump : Gump
		{
			...
			public ClaimListGump( HammerhillAnimalTrainer trainer, Mobile from, List<BaseCreature> list ) : base( 50, 50 )
			{
				m_Trainer = trainer;
				m_From = from;
				m_List = list;
		...
		private class ClaimAllEntry : ContextMenuEntry
		{
			...
			public ClaimAllEntry( HammerhillAnimalTrainer trainer, Mobile from ) : base( 6127, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class StableTarget : Target
		{
			...
			public StableTarget( HammerhillAnimalTrainer trainer ) : base( 12, false, TargetFlags.None )
			{
				m_Trainer = trainer;
			}
		...
		public HammerhillAnimalTrainer( Serial serial ) : base( serial )
		{
		}
	...
	public class SBHammerhillAnimalTrainer : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBHammerhillAnimalTrainer()
		{
		}
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new AnimalBuyInfo( 1, typeof( GaseousSlime ), 200, 10, 51, 2126 ) );
				Add( new AnimalBuyInfo( 1, typeof( GreySquirrel ), 40, 10, 0x116, 934 ) );
				Add( new AnimalBuyInfo( 1, typeof( LargeFrog ), 100, 10, 80, 663 ) );
				Add( new AnimalBuyInfo( 1, typeof( Ogumo ), 120, 10, 28, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( SilverbackGorilla ), 100, 10, 0x1D, 1154 ) );
				Add( new AnimalBuyInfo( 1, typeof( SkitteringHopper ), 160, 10, 302, 0 ) );
