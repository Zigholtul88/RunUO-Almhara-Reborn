...
{ 
	public class HammerhillButcher : BaseVendor 
	{ 
		...
		[Constructable]
		public HammerhillButcher() : base( "the butcher" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBHammerhillButcher() ); 
		}
		...
		public HammerhillButcher( Serial serial ) : base( serial ) 
		{ 
		}
	...
	public class SBHammerhillButcher : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBHammerhillButcher() 
		{ 
		} 
