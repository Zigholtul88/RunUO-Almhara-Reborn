...
{ 
	public class HammerhillJeweler : BaseVendor 
	{ 
		...
		[Constructable]
		public HammerhillJeweler() : base( "the jeweler" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBHammerhillJeweler() ); 
		} 
		...
		public HammerhillJeweler( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBHammerhillJeweler: SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBHammerhillJeweler() 
		{ 
		} 
