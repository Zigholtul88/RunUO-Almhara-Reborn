...
{
	public class HammerhillBlacksmith : BaseVendor
	{
		...
		[Constructable]
		public HammerhillBlacksmith() : base( "the blacksmith" )
		{
                }

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBHammerhillBlacksmith() );
		}
		...
		public override void InitOutfit()
		{
			...
			if ( 0.05 > Utility.RandomDouble() )
                ...
                {
                    private HammerhillBlacksmith m_Blacksmith;

                    public RepairTarget(HammerhillBlacksmith blacksmith): base(12, false, TargetFlags.None)
                    {
		...
		public HammerhillBlacksmith( Serial serial ) : base( serial )
		{
		}
	...
	public class SBHammerhillBlacksmith : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBHammerhillBlacksmith() 
		{ 
		} 
