...
{ 
	public class HammerhillCobbler : BaseVendor 
	{ 
		...
		[Constructable]
		public HammerhillCobbler() : base( "the cobbler" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBHammerhillCobbler() ); 
		}
		...
		public HammerhillCobbler( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBHammerhillCobbler : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBHammerhillCobbler() 
		{ 
		} 
