...
{ 
	public class HammerhillCarpenter : BaseVendor 
	{ 
		...
		[Constructable]
		public HammerhillCarpenter() : base( "the carpenter" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBHammerhillCarpenter() ); 
		}
		...
		public HammerhillCarpenter( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBHammerhillCarpenter : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBHammerhillCarpenter() 
		{ 
		} 
