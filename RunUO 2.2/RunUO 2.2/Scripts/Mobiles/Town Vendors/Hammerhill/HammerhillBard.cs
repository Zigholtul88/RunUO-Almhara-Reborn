...
{ 
	public class HammerhillBard : BaseVendor 
	{ 
		...
		[Constructable]
		public HammerhillBard() : base( "the bard" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBHammerhillBard() ); 
		}
		...
		public HammerhillBard( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBHammerhillBard : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBHammerhillBard() 
		{ 
		} 
