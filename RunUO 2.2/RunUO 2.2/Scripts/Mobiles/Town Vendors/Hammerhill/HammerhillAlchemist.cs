...
{ 
	public class HammerhillAlchemist : BaseVendor 
	{ 
		...
		[Constructable]
		public HammerhillAlchemist() : base( "the alchemist" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBHammerhillAlchemist() ); 
		}
		...
		public HammerhillAlchemist( Serial serial ) : base( serial ) 
		{ 
		}
	...
	public class SBHammerhillAlchemist : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBHammerhillAlchemist()
		{
		}
