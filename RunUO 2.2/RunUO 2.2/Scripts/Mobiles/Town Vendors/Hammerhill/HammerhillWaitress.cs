...
{
	public class HammerhillWaitress : BaseVendor
	{
		...
		[Constructable]
		public HammerhillWaitress() : base( "the waitress" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBHammerhillWaitress() );
		}
		...
		public HammerhillWaitress( Serial serial ) : base( serial )
		{
		}
	...
	public class SBHammerhillWaitress : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBHammerhillWaitress()
		{
		}
