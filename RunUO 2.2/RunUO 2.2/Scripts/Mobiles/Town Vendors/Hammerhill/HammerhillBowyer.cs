...
{
	public class HammerhillBowyer : BaseVendor
	{
		...
		[Constructable]
		public HammerhillBowyer() : base( "the bowyer" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBHammerhillBowyer() );
		}
		...
		public HammerhillBowyer( Serial serial ) : base( serial )
		{
		}
	...
	public class SBHammerhillBowyer: SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBHammerhillBowyer()
		{
		}
