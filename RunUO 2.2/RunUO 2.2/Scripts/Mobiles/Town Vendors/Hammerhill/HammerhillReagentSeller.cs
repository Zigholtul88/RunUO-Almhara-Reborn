...
{ 
	public class HammerhillReagentSeller : BaseVendor 
	{ 
		...
		[Constructable]
		public HammerhillReagentSeller() : base( "the reagent seller" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBHammerhillReagentSeller() ); 
		}
		...
		public HammerhillReagentSeller( Serial serial ) : base( serial ) 
		{ 
		}
	...
	public class SBHammerhillReagentSeller : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBHammerhillReagentSeller()
		{
		}
