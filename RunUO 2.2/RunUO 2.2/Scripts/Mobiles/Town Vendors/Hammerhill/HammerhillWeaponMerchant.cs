...
{
	public class HammerhillWeaponMerchant : BaseVendor
	{
		...
		[Constructable]
		public HammerhillWeaponMerchant() : base( "the weapon merchant" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBHammerhillWeaponMerchant() );
		}
		...
		public HammerhillWeaponMerchant( Serial serial ) : base( serial )
		{
		}
	...
	public class SBHammerhillWeaponMerchant: SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBHammerhillWeaponMerchant()
		{
		}
