...
{ 
	public class HammerhillBandageDealer : BaseVendor 
	{ 
		...
		[Constructable]
		public HammerhillBandageDealer() : base( "the bandage dealer" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBHammerhillBandageDealer() ); 
		} 
		...
		public HammerhillBandageDealer( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBHammerhillBandageDealer: SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBHammerhillBandageDealer() 
		{ 
		} 
		...
		{ 
			...
			{ 
				Add( new GenericBuyInfo( typeof( Bandage ), 100, 999, 0xE21, 0 ) );
				Add( new GenericBuyInfo( typeof( Bandage ), 100, 999, 0xE21, 0 ) );
			} 
		} 
