...
{
	public class CactusHubWaitress : BaseVendor
	{
		...
		[Constructable]
		public CactusHubWaitress() : base( "the waitress" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBCactusHubWaitress() );
		}
		...
		public CactusHubWaitress( Serial serial ) : base( serial )
		{
		}
	...
	public class SBCactusHubWaitress : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBCactusHubWaitress()
		{
		}
