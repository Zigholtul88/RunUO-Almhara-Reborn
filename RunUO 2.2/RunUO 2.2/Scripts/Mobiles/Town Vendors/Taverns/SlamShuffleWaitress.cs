...
{
	public class SlamShuffleWaitress : BaseVendor
	{
		...
		[Constructable]
		public SlamShuffleWaitress() : base( "the waitress" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBSlamShuffleWaitress() );
		}
		...
		public SlamShuffleWaitress( Serial serial ) : base( serial )
		{
		}
	...
	public class SBSlamShuffleWaitress : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBSlamShuffleWaitress()
		{
		}
