...
{
	public class KameronKoveWeaponsmith : BaseVendor
	{
		...
		[Constructable]
		public KameronKoveWeaponsmith() : base( "the weaponsmith" )
		{
                }

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBKameronKoveWeaponsmith() );
		}
		...
		public KameronKoveWeaponsmith( Serial serial ) : base( serial )
		{
		}
	...
	public class SBKameronKoveWeaponsmith: SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBKameronKoveWeaponsmith()
		{
		}
