...
{
	public class KameronKoveInvestmentBanker : BaseVendor
	{
		...
		[Constructable]
		public KameronKoveInvestmentBanker() : base( "the investment banker" )
		{
		}
		...
		public KameronKoveInvestmentBanker( Serial serial ) : base( serial )
		{
		}
