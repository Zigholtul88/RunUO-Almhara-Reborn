...
{ 
	public class KameronKoveProvisioner : BaseVendor 
	{ 
		...
		[Constructable]
		public KameronKoveProvisioner() : base( "the provisioner" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBKameronKoveProvisioner() ); 
		}
		...
		public KameronKoveProvisioner( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBKameronKoveProvisioner : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBKameronKoveProvisioner() 
		{ 
		} 
