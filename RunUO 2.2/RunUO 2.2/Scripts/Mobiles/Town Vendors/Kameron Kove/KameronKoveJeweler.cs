...
{ 
	public class KameronKoveJeweler : BaseVendor 
	{ 
		...
		[Constructable]
		public KameronKoveJeweler() : base( "the jeweler" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBKameronKoveJeweler() ); 
		} 
		...
		public KameronKoveJeweler( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBKameronKoveJeweler: SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBKameronKoveJeweler() 
		{ 
		} 
