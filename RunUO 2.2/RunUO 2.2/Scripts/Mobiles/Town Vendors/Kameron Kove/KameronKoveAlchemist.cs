...
{ 
	public class KameronKoveAlchemist : BaseVendor 
	{ 
		...
		[Constructable]
		public KameronKoveAlchemist() : base( "the alchemist" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBKameronKoveAlchemist() ); 
		}
		...
		public KameronKoveAlchemist( Serial serial ) : base( serial ) 
		{ 
		}
	...
	public class SBKameronKoveAlchemist : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBKameronKoveAlchemist()
		{
		}
