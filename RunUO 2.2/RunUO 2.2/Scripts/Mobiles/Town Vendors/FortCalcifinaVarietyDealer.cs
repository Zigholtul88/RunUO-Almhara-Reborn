...
{ 
	public class FortCalcifinaVarietyDealer : BaseVendor 
	{ 
		...
		[Constructable]
		public FortCalcifinaVarietyDealer() : base( "the variety dealer" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBFortCalcifinaVarietyDealer() ); 
		}
		...
		public FortCalcifinaVarietyDealer( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBFortCalcifinaVarietyDealer : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBFortCalcifinaVarietyDealer() 
		{ 
		} 
...
////////////////////////////////////////////////////// Special Items
				...
				Add( new GenericBuyInfo( "Cairn Forlorn Key", typeof( CairnForlornKey ), 10000, 999, 0x100F, 2583 ) );
				Add( new GenericBuyInfo( "Fort Calcifina Key", typeof( FortCalcifinaKey ), 2000, 999, 0x1010, 38 ) );
