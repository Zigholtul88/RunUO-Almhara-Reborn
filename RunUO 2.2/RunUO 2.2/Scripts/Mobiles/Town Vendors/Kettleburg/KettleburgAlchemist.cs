...
{ 
	public class KettleburgAlchemist : BaseVendor 
	{ 
		...
		[Constructable]
		public KettleburgAlchemist() : base( "the alchemist" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBKettleburgAlchemist() ); 
		}
		...
		public KettleburgAlchemist( Serial serial ) : base( serial ) 
		{ 
		}
	...
	public class SBKettleburgAlchemist : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBKettleburgAlchemist()
		{
		}
