...
{
	public class KettleburgHairstylist : BaseVendor
	{
		...
		[Constructable]
		public KettleburgHairstylist() : base( "the hair stylist" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBKettleburgHairstylist() );
		}
		...
		public KettleburgHairstylist( Serial serial ) : base( serial )
		{
		}
	...
	public class SBKettleburgHairstylist : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBKettleburgHairstylist() 
		{ 
		} 
