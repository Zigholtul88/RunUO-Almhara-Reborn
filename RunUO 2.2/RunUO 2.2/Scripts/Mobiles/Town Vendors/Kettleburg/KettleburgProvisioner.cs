...
{ 
	public class KettleburgProvisioner : BaseVendor 
	{ 
		...
		[Constructable]
		public KettleburgProvisioner() : base( "the provisioner" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBKettleburgProvisioner() ); 
		}
		...
		public KettleburgProvisioner( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBKettleburgProvisioner : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBKettleburgProvisioner() 
		{ 
		} 
