...
{
	public class KettleburgArmorMerchant : BaseVendor
	{
		...
		[Constructable]
		public KettleburgArmorMerchant() : base( "the armor merchant" )
		{
                }

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBKettleburgArmorMerchant() );
		}
		...
		public KettleburgArmorMerchant( Serial serial ) : base( serial )
		{
		}
	...
	public class SBKettleburgArmorMerchant : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBKettleburgArmorMerchant()
		{
		}
