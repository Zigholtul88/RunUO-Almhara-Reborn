...
{ 
	public class KettleburgCobbler : BaseVendor 
	{ 
		...
		[Constructable]
		public KettleburgCobbler() : base( "the cobbler" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBKettleburgCobbler() ); 
		}
		...
		public KettleburgCobbler( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBKettleburgCobbler : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBKettleburgCobbler() 
		{ 
		} 
