...
{
	public class KettleburgBowyer : BaseVendor
	{
		...
		[Constructable]
		public KettleburgBowyer() : base( "the bowyer" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBKettleburgBowyer() );
		}
		...
		public KettleburgBowyer( Serial serial ) : base( serial )
		{
		}
	...
	public class SBKettleburgBowyer: SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBKettleburgBowyer()
		{
		}
