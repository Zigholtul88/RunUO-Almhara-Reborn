...
{
	public class KettleburgTailor : BaseVendor
	{
		...
		[Constructable]
		public KettleburgTailor() : base( "the tailor" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBKettleburgTailor() );
		}
		...
		public KettleburgTailor( Serial serial ) : base( serial )
		{
		}
	...
	public class SBKettleburgTailor : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBKettleburgTailor()
		{
		}
