...
{ 
	public class KettleburgReagentSeller : BaseVendor 
	{ 
		...
		[Constructable]
		public KettleburgReagentSeller() : base( "the reagent seller" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBKettleburgReagentSeller() ); 
		}
		...
		public KettleburgReagentSeller( Serial serial ) : base( serial ) 
		{ 
		}
	...
	public class SBKettleburgReagentSeller : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBKettleburgReagentSeller()
		{
		}
