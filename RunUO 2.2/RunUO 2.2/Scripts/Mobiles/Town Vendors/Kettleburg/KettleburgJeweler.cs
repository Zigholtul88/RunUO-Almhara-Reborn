...
{ 
	public class KettleburgJeweler : BaseVendor 
	{ 
		...
		[Constructable]
		public KettleburgJeweler() : base( "the jeweler" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBKettleburgJeweler() ); 
		} 
		...
		public KettleburgJeweler( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBKettleburgJeweler: SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBKettleburgJeweler() 
		{ 
		} 
