...
{ 
	public class RedDaggerKeepBrewer : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerKeepBrewer() : base( "the coffee brewer" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepBrewer() ); 
		}
		...
		public RedDaggerKeepBrewer( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBRedDaggerKeepBrewer : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerKeepBrewer() 
		{ 
		} 
		...
		{ 
			...
			{ 	
				Add( new BeverageBuyInfo( typeof( Pitcher ), BeverageType.Water, 25, 500, 0x1F9D, 0 ) );

                                this.Add( new GenericBuyInfo( typeof( Keg ), 50, 200, 0xE7F, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( BrewersTools ), 100, 200, 0x1EBC, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( BreweryLabelMaker ), 500, 200, 0xFBF, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( Malt ), 10, 500, 0x103D, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( Barley ), 20, 500, 0x103F, 0 ) );

                                this.Add( new GenericBuyInfo( typeof( BagOfCocoa ), 10, 500, 0x1045, 1141 ) );
                                this.Add( new GenericBuyInfo( typeof( BagOfCoffee ), 10, 500, 0x1045, 1130 ) );

                                this.Add( new GenericBuyInfo( typeof( BrewersYeast ), 20, 500, 0x103F, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( EmptyAleBottle ), 10, 500, 0x99B, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( EmptyMeadBottle ), 10, 500, 0x99B, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( EmptyJug ), 10, 500, 0x9C8, 0 ) );

                                this.Add( new GenericBuyInfo( typeof( BitterHops ), 5, 500, 0x1AA2, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( SnowHops ), 5, 500, 0x1AA2, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( ElvenHops ), 5, 500, 0x1AA2, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( SweetHops ), 5, 500, 0x1AA2, 0 ) );

                                this.Add( new GenericBuyInfo( typeof( CeramicMug ), 26, 500, 0x995, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( PewterMug ), 32, 500, 0xFFF, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( Goblet ), 17, 500, 0x99A, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( GlassMug ), 21, 500, 0x1F81, 0 ) );
                                this.Add( new GenericBuyInfo( typeof( Pitcher ), 14, 500, 0xFF6, 0 ) );
			} 
		} 
