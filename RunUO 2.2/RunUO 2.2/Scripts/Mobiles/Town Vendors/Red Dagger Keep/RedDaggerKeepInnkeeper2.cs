...
{ 
	public class RedDaggerKeepInnkeeper2 : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerKeepInnkeeper2() : base( "the innkeeper" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepInnkeeper2() ); 
		} 
		...
		public override void InitOutfit()
		{
			...
			AddItem( new PlumeCloak(88) );
			AddItem( new TheaterDress(88) );
			AddItem( new ShortBoots(88) );
                }
                ...
                {
                    private RedDaggerKeepInnkeeper2 m_InnKeeper;

                    public RepairTarget(RedDaggerKeepInnkeeper2 innkeeper): base(12, false, TargetFlags.None)
                    {
		...
		public RedDaggerKeepInnkeeper2( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBRedDaggerKeepInnkeeper2: SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerKeepInnkeeper2() 
		{ 
		} 
