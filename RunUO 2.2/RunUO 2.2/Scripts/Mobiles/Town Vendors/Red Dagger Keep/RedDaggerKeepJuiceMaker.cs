...
{ 
	public class RedDaggerKeepJuiceMaker : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerKeepJuiceMaker() : base( "the juice maker" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepJuiceMaker() ); 
		}
		...
		public RedDaggerKeepJuiceMaker( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBRedDaggerKeepJuiceMaker : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerKeepJuiceMaker() 
		{ 
		} 
