...
{ 
	public class RedDaggerKeepLeatherWorker : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerKeepLeatherWorker() : base( "the leather worker" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepLeatherWorker() ); 
		}
		...
		public RedDaggerKeepLeatherWorker( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBRedDaggerKeepLeatherWorker : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBRedDaggerKeepLeatherWorker()
		{
		}
