...
{ 
	public class RedDaggerKeepFarmer : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerKeepFarmer() : base( "the farmer" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepFarmer() ); 
		}
		...
		public RedDaggerKeepFarmer( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBRedDaggerKeepFarmer : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerKeepFarmer() 
		{ 
		} 
