...
{ 
	public class RedDaggerKeepCook : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerKeepCook() : base( "the cook" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepCook() ); 
		}
		...
		public RedDaggerKeepCook( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBRedDaggerKeepCook : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerKeepCook() 
		{ 
		} 
