...
{ 
	public class RedDaggerTreasureHunter : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerTreasureHunter() : base( "the Treasure Hunter" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerTreasureHunter() ); 
		}
		...
		public RedDaggerTreasureHunter( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBRedDaggerTreasureHunter : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerTreasureHunter() 
		{ 
		} 
		...
		{ 
			...
			{ 	
                                Add( new GenericBuyInfo( typeof( TreasureMap ), 5000, 20, 0x14EC, 0, new object[] { 1, Map.Malas } ) );
                                Add( new GenericBuyInfo( typeof( TreasureMap ), 10000, 20, 0x14EC, 0, new object[] { 2, Map.Malas } ) );
                                Add( new GenericBuyInfo( typeof( TreasureMap ), 20000, 20, 0x14EC, 0, new object[] { 3, Map.Malas } ) );
                                Add( new GenericBuyInfo( typeof( TreasureMap ), 30000, 20, 0x14EC, 0, new object[] { 4, Map.Malas } ) );
                                Add( new GenericBuyInfo( typeof( TreasureMap ), 50000, 20, 0x14EC, 0, new object[] { 5, Map.Malas } ) );

				Add( new GenericBuyInfo( "a treasure hunter's shovel", typeof( TreasureShovel ), 2000, 20, 0xF39, 0x501 ) );
				Add( new GenericBuyInfo( "a treasure hunter's shovel", typeof( TreasureShovel ), 2000, 20, 0xF39, 0x501 ) );
				Add( new GenericBuyInfo( "a treasure hunter's shovel", typeof( TreasureShovel ), 2000, 20, 0xF39, 0x501 ) );
				Add( new GenericBuyInfo( "a treasure hunter's shovel", typeof( TreasureShovel ), 2000, 20, 0xF39, 0x501 ) );
				Add( new GenericBuyInfo( "a treasure hunter's shovel", typeof( TreasureShovel ), 2000, 20, 0xF39, 0x501 ) );
