...
{ 
	public class RedDaggerKeepButcher : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerKeepButcher() : base( "the butcher" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepButcher() ); 
		} 
		...
		public override void InitOutfit()
		{
			...
			AddItem( new Cleaver() );
			AddItem( new FullApron(633) );
			AddItem( new ElvenShirt(743) );
			AddItem( new ElvenPants(743) );
			AddItem( new LightBoots(738) );
                }

		public RedDaggerKeepButcher( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBRedDaggerKeepButcher: SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerKeepButcher() 
		{ 
		} 
