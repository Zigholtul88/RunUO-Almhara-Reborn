...
{ 
	public class RedDaggerKeepLibrarian : BaseVendor 
	{ 
		private List<SBInfo> m_SBInfos = new List<SBInfo>(); 
		protected override List<SBInfo> SBInfos{ get { return m_SBInfos; } } 

		[Constructable]
		public RedDaggerKeepLibrarian() : base( "the librarian" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepLibrarian() ); 
		}
		...
		public RedDaggerKeepLibrarian( Serial serial ) : base( serial ) 
		{ 
		}
	...
	public class SBRedDaggerKeepLibrarian : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBRedDaggerKeepLibrarian()
		{
		}
