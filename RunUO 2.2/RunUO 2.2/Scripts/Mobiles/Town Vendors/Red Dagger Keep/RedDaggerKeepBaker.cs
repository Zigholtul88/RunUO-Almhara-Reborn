...
{ 
	public class RedDaggerKeepBaker : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerKeepBaker() : base( "the baker" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepBaker() ); 
		}
		...
		public RedDaggerKeepBaker( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBRedDaggerKeepBaker : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerKeepBaker() 
		{ 
		} 
		...
		{ 
			...
			{ 	
                                Add( new GenericBuyInfo( "Ingredient and Oil Recipes", typeof( BagOfIngredientAndOilRecipes ), 100, 50, 0xE76, 2364 ) );
				...
				Add( new GenericBuyInfo( typeof( Cake ), 13, 71, 0x9E9, 0 ) );
             		        Add( new GenericBuyInfo( typeof( Cookies ), 3, 56, 0x160b, 0 ) ); 
				Add( new GenericBuyInfo( typeof( FrenchBread ), 5, 48, 0x98C, 0 ) );
				Add( new GenericBuyInfo( typeof( Muffins ), 3, 62, 0x9EA, 0 ) );
				Add( new GenericBuyInfo( typeof( SackFlour ), 3, 36, 0x1039, 0 ) );
				Add( new GenericBuyInfo( typeof( JarHoney ), 3, 48, 0x9ec, 0 ) ); 
				Add (new GenericBuyInfo( typeof( BowlFlour ), 7, 68, 0xA1E, 0 ) );
			} 
		} 
