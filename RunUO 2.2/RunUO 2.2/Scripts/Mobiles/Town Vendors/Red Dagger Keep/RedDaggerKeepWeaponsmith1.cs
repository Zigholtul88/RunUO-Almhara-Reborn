...
{
	public class RedDaggerKeepWeaponsmith1 : BaseVendor
	{
		...
		[Constructable]
		public RedDaggerKeepWeaponsmith1() : base( "the weaponsmith" )
		{
                }

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBRedDaggerKeepWeaponsmith1() );
		}
		...
		public RedDaggerKeepWeaponsmith1( Serial serial ) : base( serial )
		{
		}
	...
	public class SBRedDaggerKeepWeaponsmith1: SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBRedDaggerKeepWeaponsmith1()
		{
		}
