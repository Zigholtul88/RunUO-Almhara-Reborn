...
{
	public class RedDaggerKeepHairstylist : BaseVendor
	{
		...
		[Constructable]
		public RedDaggerKeepHairstylist() : base( "the hair stylist" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBRedDaggerKeepHairstylist() );
		}
		...
		public RedDaggerKeepHairstylist( Serial serial ) : base( serial )
		{
		}
	...
	public class SBRedDaggerKeepHairstylist : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerKeepHairstylist() 
		{ 
		} 
