...
{
	public class RedDaggerKeepInvestmentBanker : BaseVendor
	{
		...
		[Constructable]
		public RedDaggerKeepInvestmentBanker() : base( "the investment banker" )
		{
		}
		...
		public RedDaggerKeepInvestmentBanker( Serial serial ) : base( serial )
		{
		}
