...
{
	public class RedDaggerKeepTailor : BaseVendor
	{
		...
		[Constructable]
		public RedDaggerKeepTailor() : base( "the tailor" ) 
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBRedDaggerKeepTailor() );
		}
		...
		public RedDaggerKeepTailor( Serial serial ) : base( serial )
		{
		}
	...
	public class SBRedDaggerKeepTailor : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBRedDaggerKeepTailor()
		{
		}
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( ValkyrieWings ), 150, 200, 15301, 0 ) );
				Add( new GenericBuyInfo( typeof( FaerieWings ), 150, 200, 15302, 0 ) );
			}
		}
