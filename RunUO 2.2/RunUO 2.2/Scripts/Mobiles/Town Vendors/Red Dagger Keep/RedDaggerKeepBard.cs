...
{ 
	public class RedDaggerKeepBard : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerKeepBard() : base( "the bard" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepBard() ); 
		}
		...
		public RedDaggerKeepBard( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBRedDaggerKeepBard : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerKeepBard() 
		{ 
		} 
