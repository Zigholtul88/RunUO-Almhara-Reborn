...
{ 
	public class RedDaggerKeepTinker : BaseVendor 
	{ 
		...
		[Constructable]
		public RedDaggerKeepTinker() : base( "the tinker" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBRedDaggerKeepTinker() ); 
		}
		...
		public RedDaggerKeepTinker( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBRedDaggerKeepTinker : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerKeepTinker() 
		{ 
		} 
		...
		{ 
			...
			{ 	
				Add( new GenericBuyInfo( typeof( TinkersTools ), 25, 500, 0x1EBC, 0 ) );
