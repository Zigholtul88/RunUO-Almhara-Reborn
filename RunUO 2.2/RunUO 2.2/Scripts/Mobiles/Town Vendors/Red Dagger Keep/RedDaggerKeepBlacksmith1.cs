...
{
	public class RedDaggerKeepBlacksmith1 : BaseVendor
	{
		...
		[Constructable]
		public RedDaggerKeepBlacksmith1() : base( "the blacksmith" )
		{
                }

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBRedDaggerKeepBlacksmith1() );
		}
		...
		public override void InitOutfit()
		{
			...
			PackItem( new BreadLoaf( Utility.RandomMinMax( 1, 5 ) ) );
                ...
                {
                    private RedDaggerKeepBlacksmith1 m_Blacksmith;

                    public RepairTarget(RedDaggerKeepBlacksmith1 blacksmith): base(12, false, TargetFlags.None)
                    {
		...
		public RedDaggerKeepBlacksmith1( Serial serial ) : base( serial )
		{
		}
	...
	public class SBRedDaggerKeepBlacksmith1 : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBRedDaggerKeepBlacksmith1() 
		{ 
		} 
