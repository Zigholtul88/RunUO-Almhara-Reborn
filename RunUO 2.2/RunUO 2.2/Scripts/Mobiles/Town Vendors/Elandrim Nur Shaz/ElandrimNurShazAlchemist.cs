...
{ 
	public class ElandrimNurShazAlchemist : BaseVendor 
	{ 
		...
		[Constructable]
		public ElandrimNurShazAlchemist() : base( "the alchemist" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBElandrimNurShazAlchemist() ); 
		}

		public override void InitOutfit()
		{
			Name = "Shandra Greenbark";
                 	Body = 606;
                        Female = true;
                        Race = Race.Elf;
                        Hue = 1024;
			...
			AddItem( new Bandana(676) );
			AddItem( new ClothNinjaJacket(673) );
			AddItem( new BodySash(683) );
			AddItem( new Hakama(676) );
			AddItem( new Sandals(683) );
		...
		public ElandrimNurShazAlchemist( Serial serial ) : base( serial ) 
		{ 
		}
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new ElandrimNurShazAlchemistEntry( from, this ) );
		}
		...
		public class ElandrimNurShazAlchemistEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public ElandrimNurShazAlchemistEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
			...
			public override void OnClick()
			{
				...
				{
					if ( ! mobile.HasGump( typeof( ElandrimNurShazAlchemistGump ) ) )
					{
						mobile.SendGump( new ElandrimNurShazAlchemistGump( mobile ));
					}
				}
			}
		}
	...
	public class SBElandrimNurShazAlchemist : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBElandrimNurShazAlchemist()
		{
		}
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				Add( new GenericBuyInfo( "Your Trusty Potion Guide", typeof( YourTrustyPotionGuide ), 50, 100, 0xFBD, 0 ) );
 				...
 				Add( new GenericBuyInfo( typeof( CurePotion ), 700, 200, 0xF07, 0 ) );
				Add( new GenericBuyInfo( typeof( HealPotion ), 700, 200, 0xF0C, 0 ) );
				Add( new GenericBuyInfo( "Sky Blue Potion", typeof( ManaPotion ), 800, 300, 0xF03, 1266 ) );

				Add( new GenericBuyInfo( typeof( ExplosionPotion ), 700, 100, 0xF0D, 0 ) );
				Add( new GenericBuyInfo( "Magenta Potion", typeof( LightningPotion ), 700, 100, 0xF0D, 23 ) );
				Add( new GenericBuyInfo( "Ice Blue Potion", typeof( ShatterPotion ), 700, 100, 0xF0D, 1152 ) );
				Add( new GenericBuyInfo( "Toxic Potion", typeof( ToxicPotion ), 1500, 100, 0xF0D, 64 ) );
