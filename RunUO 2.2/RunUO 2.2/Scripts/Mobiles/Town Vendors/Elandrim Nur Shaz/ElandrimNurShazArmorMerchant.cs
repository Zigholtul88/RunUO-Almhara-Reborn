...
{
	public class ElandrimNurShazArmorMerchant : BaseVendor
	{
		...
		[Constructable]
		public ElandrimNurShazArmorMerchant() : base( "the armor merchant" )
		{
                }

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBElandrimNurShazArmorMerchant() );
		}
		...
		public ElandrimNurShazArmorMerchant( Serial serial ) : base( serial )
		{
		}
	...
	public class SBElandrimNurShazArmorMerchant : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBElandrimNurShazArmorMerchant()
		{
		}
