...
{
	public class ElmhavenInvestmentBanker : BaseVendor
	{
		...
		[Constructable]
		public ElmhavenInvestmentBanker() : base( "the investment banker" )
		{
		}
		...
		public ElmhavenInvestmentBanker( Serial serial ) : base( serial )
		{
		}
