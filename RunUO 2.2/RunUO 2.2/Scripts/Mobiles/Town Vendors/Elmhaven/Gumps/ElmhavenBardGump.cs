...
{ public class ElmhavenBardGump : Gump { 
public static void Initialize() { 
CommandSystem.Register( "ElmhavenBardGump", AccessLevel.GameMaster, new CommandEventHandler( ElmhavenBardGump_OnCommand ) ); 
}
private static void ElmhavenBardGump_OnCommand( CommandEventArgs e ) 
{
e.Mobile.SendGump( new ElmhavenBardGump( e.Mobile ) ); } 
public ElmhavenBardGump( Mobile owner ) : base( 50,50 ) 
{
//----------------------------------------------------------------------------------------------------
...
"<BASEFONT COLOR=YELLOW>Well hello there. With these finely <BR>" +
"<BASEFONT COLOR=YELLOW>crafted instruments you can make your<BR>" +
"<BASEFONT COLOR=YELLOW>potential career as a bard a reality.<BR>" +
