...
{ public class ElmhavenHairstylistGump : Gump { 
public static void Initialize() { 
CommandSystem.Register( "ElmhavenHairstylistGump", AccessLevel.GameMaster, new CommandEventHandler( ElmhavenHairstylistGump_OnCommand ) ); 
}
private static void ElmhavenHairstylistGump_OnCommand( CommandEventArgs e ) 
{
e.Mobile.SendGump( new ElmhavenHairstylistGump( e.Mobile ) ); } 
public ElmhavenHairstylistGump( Mobile owner ) : base( 50,50 ) 
{
//----------------------------------------------------------------------------------------------------
...
"<BASEFONT COLOR=YELLOW>Greetings fellow patron. With these <BR>" +
"<BASEFONT COLOR=YELLOW>dyes you can color your hair however<BR>" +
"<BASEFONT COLOR=YELLOW>you want.<BR>" +
