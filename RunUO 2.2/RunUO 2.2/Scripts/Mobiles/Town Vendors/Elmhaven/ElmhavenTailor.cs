...
{ 
	public class ElmhavenTailor : BaseVendor
	{
		...
		[Constructable]
		public ElmhavenTailor() : base( "the tailor" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBElmhavenTailor() );
		}
		...
		public ElmhavenTailor( Serial serial ) : base( serial )
		{
		}
	...
	public class SBElmhavenTailor : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBElmhavenTailor()
		{
		}
