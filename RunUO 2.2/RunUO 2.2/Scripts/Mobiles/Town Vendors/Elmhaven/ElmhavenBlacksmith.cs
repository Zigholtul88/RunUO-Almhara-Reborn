...
{
	public class ElmhavenBlacksmith : BaseVendor
	{
		...
		[Constructable]
		public ElmhavenBlacksmith() : base( "the blacksmith" )
		{
                }

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBElmhavenBlacksmith() );
		}
		...
		public override void InitOutfit()
		{
			...
			AddItem( new HeavyBoots(743) );
			AddItem( new FullApron(893) );
			AddItem( new LongPants(763) );
			...
			AddItem( gloves );
                ...
                {
                    private ElmhavenBlacksmith m_Blacksmith;

                    public RepairTarget(ElmhavenBlacksmith blacksmith): base(12, false, TargetFlags.None)
                    {
		...
		public ElmhavenBlacksmith( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new ElmhavenBlacksmithEntry( from, this ) );
		}
		...
		public class ElmhavenBlacksmithEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public ElmhavenBlacksmithEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
			...
			public override void OnClick()
			{
				...
				{
					if ( ! mobile.HasGump( typeof( ElmhavenBlacksmithGump ) ) )
					{
						mobile.SendGump( new ElmhavenBlacksmithGump( mobile ));
	...
	public class SBElmhavenBlacksmith : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBElmhavenBlacksmith() 
		{ 
		} 
