...
{ 
	public class ElmhavenSupplementDealer : BaseVendor 
	{ 
		...
		[Constructable]
		public ElmhavenSupplementDealer() : base( "the supplement dealer" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBElmhavenSupplementDealer() ); 
		}
		...
		public ElmhavenSupplementDealer( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBElmhavenSupplementDealer : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBElmhavenSupplementDealer() 
		{ 
		} 
		...
		{ 
			...
			{
				Add( new GenericBuyInfo( "Strength Supplement +1", typeof( StrengthSupplement1 ), 50000, 500, 0xF04, 0xE9 ) );
				Add( new GenericBuyInfo( "Agility Supplement +1", typeof( AgilitySupplement1 ), 50000, 500, 0x1006, 0x48F ) );
				Add( new GenericBuyInfo( "Mind Supplement +1", typeof( MindSupplement1 ), 50000, 500, 0xEFC, 0x62 ) );
			}
		}
