...
{ 
	public class ElmhavenScribe : BaseVendor 
	{ 
		...
		[Constructable]
		public ElmhavenScribe() : base( "the scribe" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBElmhavenScribe() ); 
		}
		...
		public override void InitOutfit()
		{
			...
			AddItem( new WizardsHat(683) );
			AddItem( new Cloak(688) );
			AddItem( new Robe(793) );
			AddItem( new LightBoots(778) );
                }
		...
		public ElmhavenScribe( Serial serial ) : base( serial ) 
		{ 
		}
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new ElmhavenScribeEntry( from, this ) );
		}
		...
		public class ElmhavenScribeEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public ElmhavenScribeEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
			...
			public override void OnClick()
			{
				...
				{
					if ( ! mobile.HasGump( typeof( ElmhavenScribeGump ) ) )
					{
						mobile.SendGump( new ElmhavenScribeGump( mobile ));
					}
				}
			}
		}
	...
	public class SBElmhavenScribe : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBElmhavenScribe()
		{
		}
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			...
			{
				Add( new GenericBuyInfo( "Hallowed Spellbook", typeof( HallowedSpellbook ), 500, 100, 0xEFA, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( ScribesPen ), 25, 300, 0xFBF, 0 ) );
