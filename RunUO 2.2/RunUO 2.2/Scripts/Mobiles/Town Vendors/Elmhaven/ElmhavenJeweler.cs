...
{ 
	public class ElmhavenJeweler : BaseVendor 
	{ 
		...
		[Constructable]
		public ElmhavenJeweler() : base( "the jeweler" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBElmhavenJeweler() ); 
		} 
		...
		public ElmhavenJeweler( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBElmhavenJeweler: SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBElmhavenJeweler() 
		{ 
		} 
