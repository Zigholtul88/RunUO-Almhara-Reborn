...
{ 
	public class ElmhavenFarmer : BaseVendor 
	{ 
		...
		[Constructable]
		public ElmhavenFarmer() : base( "the farmer" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBElmhavenFarmer() ); 
		}
		...
		public override void InitOutfit()
		{
			...
			AddItem( new StrawHat(153) );
			AddItem( new ReinassanceShirt(643) );
			AddItem( new ShortPants(603) );
			AddItem( new Boots(978) );
                }

		public ElmhavenFarmer( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new ElmhavenFarmerEntry( from, this ) );
		}
		...
		public class ElmhavenFarmerEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public ElmhavenFarmerEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
			...
			public override void OnClick()
			{
				...
				{
					if ( ! mobile.HasGump( typeof( ElmhavenFarmerGump ) ) )
					{
						mobile.SendGump( new ElmhavenFarmerGump( mobile ));
	...
	public class SBElmhavenFarmer : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBElmhavenFarmer()
		{
		}
