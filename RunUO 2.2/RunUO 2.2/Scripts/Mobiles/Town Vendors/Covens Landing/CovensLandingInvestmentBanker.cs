...
{
	public class CovensLandingInvestmentBanker : BaseVendor
	{
		...
		[Constructable]
		public CovensLandingInvestmentBanker() : base( "the investment banker" )
		{
		}
		...
		public CovensLandingInvestmentBanker( Serial serial ) : base( serial )
		{
		}

		public override int GetIdleSound() { return 0x259; }
		public override int GetAttackSound() { return 0x259; }
