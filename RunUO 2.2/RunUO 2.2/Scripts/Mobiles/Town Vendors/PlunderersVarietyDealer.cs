...
{ 
	public class PlunderersVarietyDealer : BaseVendor 
	{ 
		...
		[Constructable]
		public PlunderersVarietyDealer() : base( "the variety dealer" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBPlunderersVarietyDealer() ); 
		}
		...
		public PlunderersVarietyDealer( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBPlunderersVarietyDealer : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBPlunderersVarietyDealer() 
		{ 
		} 
