...
{
	public class SkaddriaAnimalTrainer : BaseVendor
	{
		...
		[Constructable]
		public SkaddriaAnimalTrainer() : base( "the animal trainer" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBSkaddriaAnimalTrainer() );
		}
		...
		{
			private SkaddriaAnimalTrainer m_Trainer;
			private Mobile m_From;

			public StableEntry( SkaddriaAnimalTrainer trainer, Mobile from ) : base( 6126, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class ClaimListGump : Gump
		{
			...
			public ClaimListGump( SkaddriaAnimalTrainer trainer, Mobile from, List<BaseCreature> list ) : base( 50, 50 )
			{
				m_Trainer = trainer;
				m_From = from;
				m_List = list;
		...
		private class ClaimAllEntry : ContextMenuEntry
		{
			...
			public ClaimAllEntry( SkaddriaAnimalTrainer trainer, Mobile from ) : base( 6127, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class StableTarget : Target
		{
			...
			public StableTarget( SkaddriaAnimalTrainer trainer ) : base( 12, false, TargetFlags.None )
			{
				m_Trainer = trainer;
			}
		...
		public SkaddriaAnimalTrainer( Serial serial ) : base( serial )
		{
		}
	...
	public class SBSkaddriaAnimalTrainer : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBSkaddriaAnimalTrainer()
		{
		}
