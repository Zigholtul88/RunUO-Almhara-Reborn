...
{ 
	public class SkaddriaBeerBrewer : BaseVendor 
	{ 
		...
		[Constructable]
		public SkaddriaBeerBrewer() : base( "the beer brewer" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBSkaddriaBeerBrewer() ); 
		}
		...
		public SkaddriaBeerBrewer( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBSkaddriaBeerBrewer : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBSkaddriaBeerBrewer() 
		{ 
		} 
