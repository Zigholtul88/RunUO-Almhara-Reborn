...
{ 
	public class SkaddriaLibrarian : BaseVendor 
	{ 
		private List<SBInfo> m_SBInfos = new List<SBInfo>(); 
		protected override List<SBInfo> SBInfos{ get { return m_SBInfos; } } 

		[Constructable]
		public SkaddriaLibrarian() : base( "the librarian" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBSkaddriaLibrarian() ); 
		}
		...
		public SkaddriaLibrarian( Serial serial ) : base( serial ) 
		{ 
		}
	...
	public class SBSkaddriaLibrarian : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBSkaddriaLibrarian()
		{
		}
