...
{ 
	public class SkaddriaRancher : BaseVendor 
	{ 
		...
		[Constructable]
		public SkaddriaRancher() : base( "the rancher" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBSkaddriaRancher() ); 
		}
		...
		public SkaddriaRancher( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBSkaddriaRancher : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBSkaddriaRancher() 
		{ 
		} 
