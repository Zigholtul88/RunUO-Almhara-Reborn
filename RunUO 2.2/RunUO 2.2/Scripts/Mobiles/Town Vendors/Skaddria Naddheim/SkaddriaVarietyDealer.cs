...
{ 
	public class SkaddriaVarietyDealer : BaseVendor 
	{ 
		...
		[Constructable]
		public SkaddriaVarietyDealer() : base( "the variety dealer" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBSkaddriaVarietyDealer() ); 
		}
		...
		public SkaddriaVarietyDealer( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBSkaddriaVarietyDealer : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBSkaddriaVarietyDealer() 
		{ 
		} 
