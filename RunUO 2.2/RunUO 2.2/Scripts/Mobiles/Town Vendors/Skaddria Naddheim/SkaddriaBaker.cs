...
{ 
	public class SkaddriaBaker : BaseVendor 
	{ 
		...
		[Constructable]
		public SkaddriaBaker() : base( "the baker" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBSkaddriaBaker() ); 
		}
		...
		public SkaddriaBaker( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBSkaddriaBaker : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBSkaddriaBaker() 
		{ 
		} 
