...
{ 
	public class SkaddriaProvisioner : BaseVendor 
	{ 
		...
		[Constructable]
		public SkaddriaProvisioner() : base( "the provisioner" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBSkaddriaProvisioner() ); 
		}
		...
		public SkaddriaProvisioner( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBSkaddriaProvisioner : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBSkaddriaProvisioner() 
		{ 
		} 
