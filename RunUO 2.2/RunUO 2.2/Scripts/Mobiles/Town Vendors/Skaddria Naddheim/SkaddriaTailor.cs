...
{
	public class SkaddriaTailor : BaseVendor
	{
		...
		[Constructable]
		public SkaddriaTailor() : base( "the tailor" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBSkaddriaTailor() );
		}
		...
		public SkaddriaTailor( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new SkaddriaTailorEntry( from, this ) );
		}
		...
		public class SkaddriaTailorEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public SkaddriaTailorEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
			...
			public override void OnClick()
			{
				...
				{
					if ( ! mobile.HasGump( typeof( SkaddriaTailorGump ) ) )
					{
						mobile.SendGump( new SkaddriaTailorGump( mobile ));
	...
	public class SBSkaddriaTailor : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBSkaddriaTailor()
		{
		}
   ...
   public class SkaddriaTailorGump : Gump 
   { 
      public static void Initialize() 
      { 
         CommandSystem.Register( "SkaddriaTailorGump", AccessLevel.GameMaster, new CommandEventHandler( SkaddriaTailorGump_OnCommand ) ); 
      } 

      private static void SkaddriaTailorGump_OnCommand( CommandEventArgs e ) 
      { 
         e.Mobile.SendGump( new SkaddriaTailorGump( e.Mobile ) ); 
      } 

      public SkaddriaTailorGump( Mobile owner ) : base( 50,50 ) 
      { 
//----------------------------------------------------------------------------------------------------
