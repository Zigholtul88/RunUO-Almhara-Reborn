...
{ 
	public class SkaddriaInnKeeper : BaseVendor 
	{ 
		...
		[Constructable]
		public SkaddriaInnKeeper() : base( "the innkeeper" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBSkaddriaInnKeeper() ); 
		} 
		...
		public override void InitOutfit()
		{
			...
			if ( 0.05 > Utility.RandomDouble() )
                ...
                {
                    private SkaddriaInnKeeper m_InnKeeper;

                    public RepairTarget(SkaddriaInnKeeper innkeeper): base(12, false, TargetFlags.None)
                    {
		...
		public SkaddriaInnKeeper( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new SkaddriaInnKeeperEntry( from, this ) );
		}
		...
		public class SkaddriaInnKeeperEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public SkaddriaInnKeeperEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
			...
			public override void OnClick()
			{
				...
				{
					if ( ! mobile.HasGump( typeof( SkaddriaInnKeeperGump ) ) )
					{
						mobile.SendGump( new SkaddriaInnKeeperGump( mobile ));
					}
				}
			}
		}
	...
	public class SBSkaddriaInnKeeper: SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBSkaddriaInnKeeper() 
		{ 
		} 
...
////////////////////////////////////////////////////// Special Components
		...
		{ 
         ...
         public class SkaddriaInnKeeperGump : Gump 
         { 
                public static void Initialize() 
                { 
                     CommandSystem.Register( "SkaddriaInnKeeperGump", AccessLevel.GameMaster, new CommandEventHandler( SkaddriaInnKeeperGump_OnCommand ) ); 
                } 

                private static void SkaddriaInnKeeperGump_OnCommand( CommandEventArgs e ) 
                { 
                     e.Mobile.SendGump( new SkaddriaInnKeeperGump( e.Mobile ) ); 
                } 

                public SkaddriaInnKeeperGump( Mobile owner ) : base( 50,50 ) 
                { 
//----------------------------------------------------------------------------------------------------
			this.AddPage(0);
