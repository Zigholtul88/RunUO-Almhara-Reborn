...
{ 
	public class SkaddriaCarpenter : BaseVendor 
	{ 
		...
		[Constructable]
		public SkaddriaCarpenter() : base( "the carpenter" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBSkaddriaCarpenter() ); 
		}
		...
		public SkaddriaCarpenter( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new SkaddriaCarpenterEntry( from, this ) );
		}
		...
		public class SkaddriaCarpenterEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public SkaddriaCarpenterEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
	...
	public class SBSkaddriaCarpenter : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBSkaddriaCarpenter() 
		{ 
		} 
   ...
   public class SkaddriaCarpenterGump : Gump 
   { 
      public static void Initialize() 
      { 
         CommandSystem.Register( "SkaddriaCarpenterGump", AccessLevel.GameMaster, new CommandEventHandler( SkaddriaCarpenterGump_OnCommand ) ); 
      } 

      private static void SkaddriaCarpenterGump_OnCommand( CommandEventArgs e ) 
      { 
         e.Mobile.SendGump( new SkaddriaCarpenterGump( e.Mobile ) ); 
      } 

      public SkaddriaCarpenterGump( Mobile owner ) : base( 50,50 ) 
      { 
//----------------------------------------------------------------------------------------------------
