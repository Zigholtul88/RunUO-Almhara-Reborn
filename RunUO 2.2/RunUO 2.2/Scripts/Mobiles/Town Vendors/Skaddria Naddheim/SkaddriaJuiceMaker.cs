...
{ 
	public class SkaddriaJuiceMaker : BaseVendor 
	{ 
		...
		[Constructable]
		public SkaddriaJuiceMaker() : base( "the juice maker" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBSkaddriaJuiceMaker() ); 
		}
		...
		public SkaddriaJuiceMaker( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBSkaddriaJuiceMaker : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBSkaddriaJuiceMaker() 
		{ 
		} 
