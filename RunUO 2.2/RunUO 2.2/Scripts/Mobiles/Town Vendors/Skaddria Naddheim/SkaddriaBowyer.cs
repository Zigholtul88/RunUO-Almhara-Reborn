...
{
	public class SkaddriaBowyer : BaseVendor
	{
		...
		[Constructable]
		public SkaddriaBowyer() : base( "the bowyer" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBSkaddriaBowyer() );
		}
		...
		public SkaddriaBowyer( Serial serial ) : base( serial )
		{
		}
	...
	public class SBSkaddriaBowyer: SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBSkaddriaBowyer()
		{
		}
