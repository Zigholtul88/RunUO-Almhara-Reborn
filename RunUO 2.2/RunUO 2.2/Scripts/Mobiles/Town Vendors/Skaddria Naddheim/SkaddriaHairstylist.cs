...
{
	public class SkaddriaHairstylist : BaseVendor
	{
		...
		[Constructable]
		public SkaddriaHairstylist() : base( "the hair stylist" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBSkaddriaHairstylist() );
		}
		...
		public SkaddriaHairstylist( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
		{
			...
			list.Add( new SkaddriaHairstylistEntry( from, this ) );
		}
		...
		public class SkaddriaHairstylistEntry : ContextMenuEntry
		{
			private Mobile m_Mobile;
			private Mobile m_Giver;
			
			public SkaddriaHairstylistEntry( Mobile from, Mobile giver ) : base( 6146, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
			...
			public override void OnClick()
			{
				...
				{
					if ( ! mobile.HasGump( typeof( SkaddriaHairstylistGump ) ) )
					{
						mobile.SendGump( new SkaddriaHairstylistGump( mobile ));
	...
	public class SBSkaddriaHairstylist : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBSkaddriaHairstylist() 
		{ 
		} 
   ...
   public class SkaddriaHairstylistGump : Gump 
   { 
      public static void Initialize() 
      { 
         CommandSystem.Register( "SkaddriaHairstylistGump", AccessLevel.GameMaster, new CommandEventHandler( SkaddriaHairstylistGump_OnCommand ) ); 
      } 

      private static void SkaddriaHairstylistGump_OnCommand( CommandEventArgs e ) 
      { 
         e.Mobile.SendGump( new SkaddriaHairstylistGump( e.Mobile ) ); 
      } 

      public SkaddriaHairstylistGump( Mobile owner ) : base( 50,50 ) 
      { 
//----------------------------------------------------------------------------------------------------
