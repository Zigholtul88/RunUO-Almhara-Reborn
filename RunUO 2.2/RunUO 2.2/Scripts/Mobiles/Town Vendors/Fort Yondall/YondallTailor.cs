...
{
	public class YondallTailor : BaseVendor
	{
		...
		[Constructable]
		public YondallTailor() : base( "the tailor" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBYondallTailor() );
		}
		...
		public YondallTailor( Serial serial ) : base( serial )
		{
		}
	...
	public class SBYondallTailor : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBYondallTailor()
		{
		}
