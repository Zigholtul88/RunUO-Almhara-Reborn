...
{ 
	public class YondallCobbler : BaseVendor 
	{ 
		...
		[Constructable]
		public YondallCobbler() : base( "the cobbler" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBYondallCobbler() ); 
		}
		...
		public YondallCobbler( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBYondallCobbler : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBYondallCobbler() 
		{ 
		} 
