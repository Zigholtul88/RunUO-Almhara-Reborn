...
{ 
	public class YondallProvisioner : BaseVendor 
	{ 
		...
		[Constructable]
		public YondallProvisioner() : base( "the provisioner" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBYondallProvisioner() ); 
		}
		...
		public YondallProvisioner( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBYondallProvisioner : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBYondallProvisioner() 
		{ 
		} 
