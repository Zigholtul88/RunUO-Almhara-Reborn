...
{
	public class YondallHairstylist : BaseVendor
	{
		...
		[Constructable]
		public YondallHairstylist() : base( "the hair stylist" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBYondallHairstylist() );
		}
		...
		public YondallHairstylist( Serial serial ) : base( serial )
		{
		}
	...
	public class SBYondallHairstylist : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBYondallHairstylist() 
		{ 
		} 
