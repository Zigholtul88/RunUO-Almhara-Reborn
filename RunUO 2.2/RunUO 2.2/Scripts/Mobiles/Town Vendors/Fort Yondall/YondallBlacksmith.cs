...
{
	public class YondallBlacksmith : BaseVendor
	{
		...
		[Constructable]
		public YondallBlacksmith() : base( "the blacksmith" )
		{
                }

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBYondallBlacksmith() );
		}
		...
		public override void InitOutfit()
		{
			...
			if ( 0.05 > Utility.RandomDouble() )
                ...
                {
                    private YondallBlacksmith m_Blacksmith;

                    public RepairTarget(YondallBlacksmith blacksmith): base(12, false, TargetFlags.None)
                    {
		...
		public YondallBlacksmith( Serial serial ) : base( serial )
		{
		}
	...
	public class SBYondallBlacksmith : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBYondallBlacksmith() 
		{ 
		} 
