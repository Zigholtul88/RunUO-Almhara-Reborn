...
{ 
	public class YondallJeweler : BaseVendor 
	{ 
		...
		[Constructable]
		public YondallJeweler() : base( "the jeweler" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBYondallJeweler() ); 
		} 
		...
		public YondallJeweler( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class SBYondallJeweler: SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBYondallJeweler() 
		{ 
		} 
