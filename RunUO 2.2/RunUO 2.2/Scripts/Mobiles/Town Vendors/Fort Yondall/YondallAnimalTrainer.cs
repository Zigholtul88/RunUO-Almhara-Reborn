...
{
	public class YondallAnimalTrainer : BaseVendor
	{
		...
		[Constructable]
		public YondallAnimalTrainer() : base( "the animal trainer" )
		{
		}

		public override void InitSBInfo()
		{
			m_SBInfos.Add( new SBYondallAnimalTrainer() );
		}
		...
		{
			private YondallAnimalTrainer m_Trainer;
			private Mobile m_From;

			public StableEntry( YondallAnimalTrainer trainer, Mobile from ) : base( 6126, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class ClaimListGump : Gump
		{
			...
			public ClaimListGump( YondallAnimalTrainer trainer, Mobile from, List<BaseCreature> list ) : base( 50, 50 )
			{
				m_Trainer = trainer;
				m_From = from;
				m_List = list;
		...
		private class ClaimAllEntry : ContextMenuEntry
		{
			...
			public ClaimAllEntry( YondallAnimalTrainer trainer, Mobile from ) : base( 6127, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class StableTarget : Target
		{
			...
			public StableTarget( YondallAnimalTrainer trainer ) : base( 12, false, TargetFlags.None )
			{
				m_Trainer = trainer;
			}
		...
		public YondallAnimalTrainer( Serial serial ) : base( serial )
		{
		}
	...
	public class SBYondallAnimalTrainer : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBYondallAnimalTrainer()
		{
		}
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new AnimalBuyInfo( 1, typeof( Ridgeback ), 500, 20, 187, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( Gryphon ), 1000, 20, 0x12A, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( HellSteed ), 2000, 20, 793, 0 ) );
				Add( new AnimalBuyInfo( 1, typeof( MonitorLizard ), 3000, 20, 0xCE, 2405 ) );
				Add( new AnimalBuyInfo( 1, typeof( Zebra ), 4000, 20, 0x34D, 0 ) );
			}
		}
