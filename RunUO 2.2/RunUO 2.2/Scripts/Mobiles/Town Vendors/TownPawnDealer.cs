...
{ 
	public class TownPawnDealer : BaseVendor 
	{ 
		...
		[Constructable]
		public TownPawnDealer() : base( "the pawn dealer" ) 
		{ 
		} 

		public override void InitSBInfo() 
		{ 
			m_SBInfos.Add( new SBTownPawnDealer() ); 
		}
		...
		public TownPawnDealer( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override bool OnDragDrop( Mobile from, Item dropped )
		{
			...
			if( mobile != null )
			{
				if( dropped is CairnForlornKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				}
				else if( dropped is FortCalcifinaKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				}
				else if( dropped is SagittaResidenceKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				...
				else if( dropped is MongbatHideoutBossKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				}
				else if( dropped is AgurastAscensionKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				}
				else if( dropped is AgurastAscensionBossKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				}
				else if( dropped is MurkmereDwellingBossKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				...
				else if( dropped is GuardiansDesertBunkerKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				}
				else if( dropped is GuardiansHorizonGateKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				}
				else if( dropped is RoyalTombPyramidKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				...
				else if( dropped is IguanaCoveBossKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				}
				else if( dropped is WhisperingHollowDungeonKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				}
				else if( dropped is WhisperingHollowBossKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
				}
				else if( dropped is PassageOfLostSoulsKey )
				{
					dropped.Delete();
		                        mobile.AddToBackpack( new Gold(1000) );
					return true;
	...
	public class SBTownPawnDealer : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBTownPawnDealer() 
		{ 
		} 
