...
{
	[CorpseName( "a tundra giant corpse" )]
	public class TundraGiant : BaseCreature
	{
		...
		[Constructable]
		public TundraGiant() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a tundra giant";
			Body = 373;
			BaseSoundID = 604;
		...
		public TundraGiant( Serial serial ) : base( serial )
		{
		}
