...
{
	[CorpseName( "a gullnah corpse" )]
	public class Gullnah : BaseCreature
	{
		public override double BoostedSpeed{ get{ return 0.2; } }
		public override bool ReduceSpeedWithDamage{ get{ return false; } }

		[Constructable]
		public Gullnah() : base( AIType.AI_Melee, FightMode.Closest, 8, 1, 0.175, 0.350 )
		{
   			if ( Flying ) // Frenzy
   			{
			...
			Name = "a gullnah";
			Body = Utility.RandomList( 347,348,349,350 );
		...
		{      
 			if ( Utility.RandomDouble() < 0.25 )
			        ...
			        PlaySound( 1570 );
			        this.Combatant = from;
				from.SendMessage( "The gullnah goes into a frenzy" );
                        }
		...
		public Gullnah( Serial serial ) : base( serial )
		{
		}
