...
{
	[CorpseName( "a danger floof corpse" )]
	public class DangerFloof : BaseCreature
	{
		...
		[Constructable]
		public DangerFloof() : base( AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Name = "a danger floof";
			Body = 167;
			BaseSoundID = 0xA3;
		...
		public DangerFloof( Serial serial ) : base( serial )
		{
		}
