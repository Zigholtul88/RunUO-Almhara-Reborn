...
{
	[CorpseName( "a fog phantom corpse" )]
	public class FogPhantom : BaseCreature
	{
		[Constructable]
		public FogPhantom() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.175, 0.350 )
		{
			Name = "a fog phantom";
			Body = 748;
			BaseSoundID = 0x482;
		...
		public FogPhantom( Serial serial ) : base( serial )
		{
		}
