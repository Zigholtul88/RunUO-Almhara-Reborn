...
{
	[CorpseName( "a pumpkin spirit's corpse" )]
	public class MadPumpkinSpirit : BaseCreature
	{
		...
		public override bool HasBreath{ get{ return true; } } // pumpkin throw enabled
		...
		public override int BreathEffectItemID{ get{ return 0x0C6A; } }
		public override int BreathEffectSound{ get{ return 0x5D3; } }
		public override int BreathAngerSound{ get{ return 895; } }
                ...
                public override void OnCarve( Mobile from, Corpse corpse, Item with )
		{
			if ( corpse.Carved == false )
			{
			      base.OnCarve( from, corpse, with );
                              ...
                              corpse.AddCarvedItem( new Nirnroot( Utility.RandomMinMax( 4, 6 ) ), from );
                              corpse.AddCarvedItem( new ShadowPumpkinEssence(), from );

                              from.SendMessage( "You carve up gold, some nirnroot and in addition a shadow pumpkin essence." );
                              corpse.Carved = true; 
			}
                }
		...
		public override int GetAttackSound() { return 1429; } 
		public override int GetIdleSound() { return 383; } 
		public override int GetAngerSound() { return 895; } 
		public override int GetHurtSound() { return 384; } 
		public override int GetDeathSound() { return 897; }
