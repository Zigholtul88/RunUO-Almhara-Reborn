...
{
	public class ZaythalorMoonElf : BaseGuardian
	{
		[Constructable]
		public ZaythalorMoonElf() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ZaythalorMoonElf( Serial serial ) : base( serial )
		{
		}
