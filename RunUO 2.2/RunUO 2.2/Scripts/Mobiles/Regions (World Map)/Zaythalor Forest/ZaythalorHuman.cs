...
{
	public class ZaythalorHuman : BaseGuardian
	{
		[Constructable]
		public ZaythalorHuman() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ZaythalorHuman( Serial serial ) : base( serial )
		{
		}
