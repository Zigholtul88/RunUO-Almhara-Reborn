...
namespace Server.Mobiles
{
	...
	public class FaerieBeetle : BaseCreature
	{
		...
		[Constructable]
		public FaerieBeetle() : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.175, 0.350 )
		{
                ...
                public override void OnCarve( Mobile from, Corpse corpse, Item with )
		{
			if (corpse.Carved == false)
			{
			      base.OnCarve( from, corpse, with );
                              ...
                              corpse.AddCarvedItem(new BeetleEgg( Utility.RandomMinMax( 4, 9 )), from);
		...
		public FaerieBeetle( Serial serial ) : base( serial )
		{
		}
