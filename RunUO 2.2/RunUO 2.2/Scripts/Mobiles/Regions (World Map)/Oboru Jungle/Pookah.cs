...
{
	[CorpseName( "a pookah corpse" )]
	public class Pookah : BaseCreature
	{
		[Constructable]
		public Pookah() : base( AIType.AI_Melee, FightMode.Closest, 6, 1, 0.175, 0.350 )
		{
                        Name = "a pookah";
			Body = 178;
			Hue = 1908;
                ...
                public override void OnCarve( Mobile from, Corpse corpse, Item with )
		{
			if ( corpse.Carved == false )
			{
			      base.OnCarve( from, corpse, with );
                              ...
                              from.SendMessage( "You carve up 5 ribs, some barbed hides, and a pookah eye." ); 
                              corpse.Carved = true;
			}
                }
		...
		public Pookah( Serial serial ) : base(serial)
		{
		}
