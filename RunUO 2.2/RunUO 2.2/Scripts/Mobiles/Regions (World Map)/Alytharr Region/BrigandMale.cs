...
{
	public class BrigandMale : BaseCreature
	{
		...
		[Constructable]
		public BrigandMale() : base( AIType.AI_Melee, FightMode.Closest, 5, 1, 0.2, 0.4 )
		{
		...
		public override void OnGaveMeleeAttack( Mobile defender )
		{
			...
			if( 0.2 > Utility.RandomDouble() )
			{
				...
				{
					timer.DoExpire();
                                        defender.SendMessage( "The brigand continues inflicting bleeding damage!" );
				}
				else
                                        defender.SendMessage( "The brigand goes into a rage, inflicting continuous bleeding damage!" );
		...
		private class ExpireTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				{
					DoExpire();
                                        m_Mobile.SendMessage( "The blood clouting from the brigand's attack subsides." );
				}
			}
		}
		...
		public BrigandMale( Serial serial ) : base( serial )
		{
		}
