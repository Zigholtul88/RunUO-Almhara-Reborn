...
{
	[CorpseName( "a black lizard corpse" )]
	public class BlackLizard : BaseCreature
	{
		...
		public override void OnGotMeleeAttack( Mobile attacker )
		{
			...
			{
                                attacker.SendMessage( "The black lizard fans you with gas, reducing your resistance to physical attacks." );
                ...
                public override void OnCarve( Mobile from, Corpse corpse, Item with )
		{
			if (corpse.Carved == false)
			{
			      base.OnCarve( from, corpse, with );
                              ...
                              corpse.AddCarvedItem(new BlackLizardEyeBall(), from);

                              from.SendMessage( "You carve up some lizard meat, spined hides, serpent scales, and a black lizard eyeball." );
                              corpse.Carved = true; 
			}
                }
