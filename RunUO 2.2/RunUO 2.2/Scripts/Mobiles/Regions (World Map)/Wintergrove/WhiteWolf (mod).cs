...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public WhiteWolf() : base( AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.175, 0.350 )
		{
			Name = "a white wolf";
			...
			SetSkill( SkillName.MagicResist, 21.5, 35.0 );
			SetSkill( SkillName.Tactics, 46.0, 58.9 );
			SetSkill( SkillName.Wrestling, 49.9, 62.1 );
